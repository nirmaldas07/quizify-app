 ...
 * @since 5.2.0
 */
export declare type AddDocumentSnapshotListenerCallback<T> = (event: AddDocumentSnapshotListenerCallbackEvent<T> | null, error: any) => void;
/**
 * @since 5.2.0
 */
export declare type AddDocumentSnapshotListenerCallbackEvent<T> = GetDocumentResult<T>;
/**
 * @since 5.2.0
 */
 ...
 * @since 5.2.0
 */
export declare type AddCollectionSnapshotListenerCallback<T> = (event: AddCollectionSnapshotListenerCallbackEvent<T> | null, error: any) => void;
/**
 * @since 5.2.0
 */
export declare type AddCollectionSnapshotListenerCallbackEvent<T> = GetCollectionResult<T>;
/**
 * @since 6.1.0
 */
 ...
 * @since 6.1.0
 */
export declare type AddCollectionGroupSnapshotListenerCallback<T> = (event: AddCollectionGroupSnapshotListenerCallbackEvent<T> | null, error: any) => void;
/**
 * @since 6.1.0
 */
export declare type AddCollectionGroupSnapshotListenerCallbackEvent<T> = GetCollectionGroupResult<T>;
/**
 * @since 5.2.0
 */
 ...
 * @since 5.2.0
 */
export declare type QueryConstraint = QueryFieldFilterConstraint | QueryNonFilterConstraint;
/**
 * @since 5.2.0
 */
 ...
 * @since 5.2.0
 */
export declare type QueryOperator = '<' | '<=' | '==' | '>=' | '>' | '!=' | 'array-contains' | 'array-contains-any' | 'in' | 'not-in';
/**
 * @since 5.2.0
 */
