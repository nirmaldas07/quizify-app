 ...
 * @since 1.1.0
 */
export declare type LinkOptions = SignInOptions;
/**
 * @since 1.1.0
 */
export declare type LinkWithOAuthOptions = SignInWithOAuthOptions;
/**
 * @since 1.1.0
 */
 ...
 * @since 6.1.0
 */
export declare type LinkWithOpenIdConnectOptions = SignInWithOpenIdConnectOptions;
/**
 * @since 1.1.0
 */
export declare type LinkWithPhoneNumberOptions = SignInWithPhoneNumberOptions;
/**
 * @since 1.1.0
 */
export declare type LinkWithCustomTokenOptions = SignInWithCustomTokenOptions;
/**
 * @since 1.1.0
 */
export declare type LinkResult = SignInResult;
/**
 * @since 0.1.0
 */
 ...
 * @since 0.1.0
 */
export declare type AuthStateChangeListener = (change: AuthStateChange) => void;
/**
 * @since 0.1.0
 */
