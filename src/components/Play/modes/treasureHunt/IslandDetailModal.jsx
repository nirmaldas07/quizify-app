      ...
      >
        ...
        <div className="p-6 pt-2 space-y-3">
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-white to-gray-100 text-gray-800 rounded-2xl font-black text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-400 to-amber-500 opacity-0 group-hover:opacity-100 transition-opacity shimmer" />
            <span className="relative flex items-center justify-center gap-3">
              <span className="text-2xl bounce-animation">🏴‍☠️</span>
              <span>{hasPlayed ? 'Play Again' : 'Start Adventure'}</span>
              <span className="text-2xl bounce-animation" style={{ animationDelay: '0.5s' }}>🏴‍☠️</span>
            </span>
          </button>
          
          <button
            onClick={onClose}
            className="w-full py-3 glass-effect text-white rounded-2xl font-bold hover:bg-white/20 transition-colors"
          >
            Back to Map
          </button>
        </div>
