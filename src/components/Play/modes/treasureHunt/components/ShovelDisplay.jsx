...
export default function ShovelDisplay({ shovelsRemaining, showBreak = false }) {
  ...
  return (
    <div className="inline-block">
      ...
      <div className="glass-badge rounded-2xl px-6 py-3 shadow-lg">
        <div className="flex items-center gap-3">
          <span className="text-white font-bold text-sm">Shovels:</span>
                ...
                >
                  ...
                  <div className="absolute -bottom-1 left-1/2 -translate-x-1/2">
                    <span className={`text-xs font-bold ${
                      isActive ? 'text-yellow-300' : 'text-white/30'
                    }`}>
                      {index + 1}
                    </span>
                  </div>
          ...
          {shovelsRemaining === 1 && (
            <span className="text-yellow-400 text-sm font-bold ml-2">
              Last chance!
            </span>
          )}
        </div>
