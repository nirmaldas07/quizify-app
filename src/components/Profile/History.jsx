...
export default function History() {
  ...
  return (
    <Screen title="History" subtitle="Your attempts & practice">
      {/* Tabs */}
      <div className="mb-3 inline-flex p-1 rounded-xl bg-white/10 border border-white/10">
        {[
          ...
          <button key={o.value}
                  ...
                  className={`px-3 py-1.5 text-sm rounded-lg ${tab===o.value?"bg-white text-black":"text-white/80 hover:text-white"}`}>
            {o.label}
          </button>
        ))}
      </div>
