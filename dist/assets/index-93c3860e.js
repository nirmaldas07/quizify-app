 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,_){var F=P.length;P.push(_);e:for(;0<F;){var L=F-1>>>1,D=P[L];if(0<a(D,_))P[L]=_,P[F]=D,F=L;else break e}}function n(P){return P.length===0?null:P[0]}function s(P){if(P.length===0)return null;var _=P[0],F=P.pop();if(F!==_){P[0]=F;e:for(var L=0,D=P.length,A=D>>>1;L<A;){var X=2*(L+1)-1,ne=P[X],re=X+1,Q=P[re];if(0>a(ne,F))re<D&&0>a(Q,ne)?(P[L]=Q,P[re]=F,L=re):(P[L]=ne,P[X]=F,L=X);else if(re<D&&0>a(Q,F))P[L]=Q,P[re]=F,L=re;else break e}}return _}function a(P,_){var F=P.sortIndex-_.sortIndex;return F!==0?F:P.id-_.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();e.unstable_now=function(){return o.now()-l}}var c=[],u=[],f=1,p=null,m=3,w=!1,x=!1,k=!1,C=typeof setTimeout=="function"?setTimeout:null,v=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(P){for(var _=n(u);_!==null;){if(_.callback===null)s(u);else if(_.startTime<=P)s(u),_.sortIndex=_.expirationTime,t(c,_);else break;_=n(u)}}function E(P){if(k=!1,b(P),!x)if(n(c)!==null)x=!0,Y(j);else{var _=n(u);_!==null&&$(E,_.startTime-P)}}function j(P,_){x=!1,k&&(k=!1,v(g),g=-1),w=!0;var F=m;try{for(b(_),p=n(c);p!==null&&(!(p.expirationTime>_)||P&&!R());){var L=p.callback;if(typeof L=="function"){p.callback=null,m=p.priorityLevel;var D=L(p.expirationTime<=_);_=e.unstable_now(),typeof D=="function"?p.callback=D:p===n(c)&&s(c),b(_)}else s(c);p=n(c)}if(p!==null)var A=!0;else{var X=n(u);X!==null&&$(E,X.startTime-_),A=!1}return A}finally{p=null,m=F,w=!1}}var T=!1,S=null,g=-1,y=5,N=-1;function R(){return!(e.unstable_now()-N<y)}function I(){if(S!==null){var P=e.unstable_now();N=P;var _=!0;try{_=S(!0,P)}finally{_?q():(T=!1,S=null)}}else T=!1}var q;if(typeof h=="function")q=function(){h(I)};else if(typeof MessageChannel<"u"){var Z=new MessageChannel,H=Z.port2;Z.port1.onmessage=I,q=function(){H.postMessage(null)}}else q=function(){C(I,0)};function Y(P){S=P,T||(T=!0,q())}function $(P,_){g=C(function(){P(e.unstable_now())},_)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){x||w||(x=!0,Y(j))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):y=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(P){switch(m){case 1:case 2:case 3:var _=3;break;default:_=m}var F=m;m=_;try{return P()}finally{m=F}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,_){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var F=m;m=P;try{return _()}finally{m=F}},e.unstable_scheduleCallback=function(P,_,F){var L=e.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?L+F:L):F=L,P){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=F+D,P={id:f++,callback:_,priorityLevel:P,startTime:F,expirationTime:D,sortIndex:-1},F>L?(P.sortIndex=F,t(u,P),n(c)===null&&P===n(u)&&(k?(v(g),g=-1):k=!0,$(E,F-L))):(P.sortIndex=D,t(c,P),x||w||(x=!0,Y(j))),P},e.unstable_shouldYield=R,e.unstable_wrapCallback=function(P){var _=m;return function(){var F=m;m=_;try{return P.apply(this,arguments)}finally{m=F}}}})(du);cu.exports=du;var o0=cu.exports;/**
 * @license React
...
`,'"',u.BYTE_ORDER_MARK],u.WORKERS_SUPPORTED=!i&&!!s.Worker,u.NODE_STREAM_INPUT=1,u.LocalChunkSize=10485760,u.RemoteChunkSize=5242880,u.DefaultDelimiter=",",u.Parser=v,u.ParserHandle=k,u.NetworkStreamer=p,u.FileStreamer=m,u.StringStreamer=w,u.ReadableStreamStreamer=x,s.jQuery&&((a=s.jQuery).fn.parse=function(g){var y=g.config||{},N=[];return this.each(function(q){if(!(a(this).prop("tagName").toUpperCase()==="INPUT"&&a(this).attr("type").toLowerCase()==="file"&&s.FileReader)||!this.files||this.files.length===0)return!0;for(var Z=0;Z<this.files.length;Z++)N.push({file:this.files[Z],inputElem:this,instanceConfig:a.extend({},y)})}),R(),this;function R(){if(N.length===0)S(g.complete)&&g.complete();else{var q,Z,H,Y,$=N[0];if(S(g.before)){var P=g.before($.file,$.inputElem);if(typeof P=="object"){if(P.action==="abort")return q="AbortError",Z=$.file,H=$.inputElem,Y=P.reason,void(S(g.error)&&g.error({name:q},Z,H,Y));if(P.action==="skip")return void I();typeof P.config=="object"&&($.instanceConfig=a.extend($.instanceConfig,P.config))}else if(P==="skip")return void I()}var _=$.instanceConfig.complete;$.instanceConfig.complete=function(F){S(_)&&_(F,$.file,$.inputElem),I()},u.parse($.file,$.instanceConfig)}}function I(){N.splice(0,1),R()}}),o&&(s.onmessage=function(g){g=g.data,u.WORKER_ID===void 0&&g&&(u.WORKER_ID=g.workerId),typeof g.input=="string"?s.postMessage({workerId:u.WORKER_ID,results:u.parse(g.input,g.config),finished:!0}):(s.File&&g.input instanceof File||g.input instanceof Object)&&(g=u.parse(g.input,g.config))&&s.postMessage({workerId:u.WORKER_ID,results:g,finished:!0})}),(p.prototype=Object.create(f.prototype)).constructor=p,(m.prototype=Object.create(f.prototype)).constructor=m,(w.prototype=Object.create(w.prototype)).constructor=w,(x.prototype=Object.create(f.prototype)).constructor=x,u})})(Cm);var Gx=Cm.exports;const hr=Xd(Gx);function Ci({startRect:e,targetRef:t,count:n=12,onDone:s}){return d.useEffect(()=>{const a=t==null?void 0:t.current;if(!e||!a){s==null||s();return}const i=a.getBoundingClientRect(),o=document.createElement("div");o.style.position="fixed",o.style.inset="0",o.style.pointerEvents="none",o.style.zIndex="9999",document.body.appendChild(o);const l=i.left+i.width/2,c=i.top+i.height/2,u=e.left+e.width/2,f=e.top+e.height/2,p=200;let m=0;function w(x){const k=document.createElement("div");k.textContent="🪙",Object.assign(k.style,{position:"fixed",left:"0px",top:"0px",zIndex:"10000",pointerEvents:"none",fontSize:"22px",opacity:"1",willChange:"transform, opacity",transform:"translate(0px, 0px)"});const C=u,v=f,h=l,b=c;k.style.transform=`translate(${C}px, ${v}px) scale(1)`,o.appendChild(k),k.getBoundingClientRect(),k.style.transition=`transform ${p}ms cubic-bezier(.2,.8,.2,1), opacity ${p}ms linear`,requestAnimationFrame(()=>{k.style.transform=`translate(${h}px, ${b}px) scale(.6)`,k.style.opacity="0.1"}),setTimeout(()=>{k.remove(),m+=1,m===n&&(o.remove(),s==null||s())},p+50)}for(let x=0;x<n;x++)setTimeout(()=>w(),x*60);return()=>{try{o.remove()}catch{}}},[e,t,n,s]),null}const ft={XP_PER_CORRECT:10,XP_PER_LEVEL:100,MAX_LEVEL:100,COINS_PER_CORRECT:5,MAX_ENERGY:5,ENERGY_REGEN_TIME:36e5,ENERGY_COST:{quiz:1,practice:0,daily:0},COMBO_MULTIPLIERS:{2:{multiplier:1.2,text:"Nice!"},3:{multiplier:1.5,text:"Great!"},5:{multiplier:2,text:"On Fire!"},10:{multiplier:3,text:"Legendary!"}},AVATARS:[{id:"wizard",emoji:"🧙",name:"Knowledge Wizard",unlocked:!0,bgColor:"from-purple-500 to-indigo-500"},{id:"knight",emoji:"⚔️",name:"Quiz Knight",unlocked:!0,bgColor:"from-blue-500 to-cyan-500"},{id:"explorer",emoji:"🗺️",name:"Fact Explorer",unlockLevel:5,unlocked:!1,bgColor:"from-green-500 to-emerald-500"},{id:"scientist",emoji:"🔬",name:"Science Master",unlockLevel:10,unlocked:!1,bgColor:"from-orange-500 to-red-500"},{id:"artist",emoji:"🎨",name:"Creative Mind",unlockLevel:15,unlocked:!1,bgColor:"from-pink-500 to-rose-500"}],STORAGE_KEYS:{PLAYER:"qp_player",GAME_STATE:"qp_game_state",ENERGY:"qp_energy",CURRENT_COMBO:"qp_combo"}},Rd=e=>Math.floor(e/ft.XP_PER_LEVEL)+1,Vx=e=>{const t=e%ft.XP_PER_LEVEL;return{current:t,required:ft.XP_PER_LEVEL,percentage:t/ft.XP_PER_LEVEL*100}};function Xx({player:e,size:t="normal",showLevel:n=!0,showName:s=!0}){const a=ft.AVATARS.find(o=>o.id===e.avatar)||ft.AVATARS[0],i={small:"w-10 h-10 text-xl",normal:"w-14 h-14 text-2xl",large:"w-20 h-20 text-4xl"};return r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsxs("div",{className:"relative",children:[r.jsx("div",{className:`${i[t]} rounded-full bg-gradient-to-br ${a.bgColor} flex items-center justify-center shadow-lg`,children:r.jsx("span",{children:a.emoji})}),n&&r.jsx("div",{className:"absolute -bottom-1 -right-1 bg-yellow-500 text-black text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center border-2 border-base-bg",children:e.level})]}),s&&r.jsxs("div",{children:[r.jsx("div",{className:"font-bold text-sm",children:e.name}),r.jsx("div",{className:"text-xs text-base-muted",children:a.name})]})]})}function Kx({current:e,required:t,level:n,animate:s=!0}){const[a,i]=d.useState(0),o=e/t*100;return d.useEffect(()=>{if(s){const l=setTimeout(()=>{i(o)},100);return()=>clearTimeout(l)}else i(o)},[o,s]),r.jsxs("div",{className:"w-full",children:[r.jsxs("div",{className:"flex justify-between items-center mb-1",children:[r.jsxs("span",{className:"text-xs font-medium",children:["Level ",n]}),r.jsxs("span",{className:"text-xs text-base-muted",children:[e,"/",t," XP"]})]}),r.jsx("div",{className:"h-2 bg-black/20 rounded-full overflow-hidden",children:r.jsx("div",{className:"h-full bg-gradient-to-r from-blue-500 to-purple-500 rounded-full transition-all duration-700 ease-out relative",style:{width:`${a}%`},children:r.jsx("div",{className:"absolute inset-0 bg-white/20 animate-pulse"})})})]})}const Em=[{name:"GK",slug:"general-knowledge",questions:50,icon:"🧠",color:"#FF6B6B",gradient:"from-red-500 to-pink-500"},{name:"Science",slug:"science",questions:45,icon:"🧪",color:"#4ECDC4",gradient:"from-cyan-500 to-teal-500"},{name:"Fun Facts",slug:"fun-facts",questions:30,icon:"🎉",color:"#FFD93D",gradient:"from-yellow-400 to-orange-500"},{name:"History",slug:"history",questions:42,icon:"🏺",color:"#A8E6CF",gradient:"from-green-400 to-emerald-500"},{name:"AI & Tech",slug:"artificial-intelligence",questions:28,icon:"🤖",color:"#C7B8FF",gradient:"from-purple-400 to-indigo-500"},{name:"More",slug:"more",questions:0,icon:"✨",color:"#FF8CC3",gradient:"from-pink-400 to-rose-500"}],Pm=[{name:"Geography",slug:"geography",questions:38,icon:"🗺️",color:"#FACC15",gradient:"from-yellow-400 to-amber-500"},{name:"Computer",slug:"computer",questions:34,icon:"💻",color:"#3B82F6",gradient:"from-blue-400 to-blue-600"},{name:"Aptitude",slug:"aptitude",questions:36,icon:"📐",color:"#EC4899",gradient:"from-pink-500 to-rose-500"},{name:"Iconic Figures",slug:"iconic-figures",questions:26,icon:"🌟",color:"#8B5CF6",gradient:"from-purple-500 to-violet-600"}],Rm=[...Em.filter(e=>e.slug!=="more"),...Pm];function Jx({onClick:e}){return r.jsxs("div",{className:"relative overflow-hidden rounded-3xl p-8 mb-6 cursor-pointer transform transition-all hover:scale-[1.02]",style:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",boxShadow:"0 10px 40px rgba(102, 126, 234, 0.3)",animation:"pulse 3s infinite"},onClick:e,children:[r.jsx("div",{className:"absolute top-[-50px] right-[-50px] w-[200px] h-[200px] rounded-full bg-white/10",style:{animation:"float 4s ease-in-out infinite"}}),r.jsx("div",{className:"absolute bottom-[-30px] left-[-30px] w-[150px] h-[150px] rounded-full bg-white/10",style:{animation:"float 4s ease-in-out infinite reverse"}}),r.jsx("h2",{className:"text-3xl font-bold mb-2",children:"🎰 Spin & Win"}),r.jsx("p",{className:"text-base opacity-90 mb-4",children:"Test your luck, win amazing prizes!"}),r.jsx("div",{className:"inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium",style:{background:"linear-gradient(90deg, rgba(255,255,255,0.3) 0%, rgba(255,255,255,0.1) 50%, rgba(255,255,255,0.3) 100%)",backgroundSize:"200% auto",animation:"shimmer 2s linear infinite"},children:"Play Now →"})]})}function Zx({actions:e}){return r.jsx("div",{className:"grid grid-cols-4 gap-3 mb-8",children:e.map((t,n)=>r.jsxs("button",{onClick:t.action,className:`${t.color} aspect-square rounded-2xl flex flex-col items-center justify-center gap-1 transform transition-all hover:scale-105`,children:[r.jsx("div",{className:"text-2xl",children:t.icon}),r.jsx("div",{className:"text-[10px] font-medium text-white",children:t.label})]},n))})}function eg({categories:e,onCategorySelect:t}){return r.jsxs("div",{className:"mb-6",children:[r.jsx("h3",{className:"text-lg font-bold mb-4",children:"Choose Your Adventure"}),r.jsx("div",{className:"grid grid-cols-3 gap-3",children:e.map(n=>r.jsxs("button",{onClick:()=>t(n),className:`bg-gradient-to-br ${n.gradient} aspect-square rounded-2xl p-4 flex flex-col items-center justify-center gap-2 transform transition-all hover:scale-105 hover:shadow-lg relative`,children:[r.jsx("div",{className:"text-3xl",children:n.icon}),r.jsx("div",{className:"text-xs font-bold text-white text-center",children:n.name}),n.questions>0&&r.jsxs("div",{className:"text-[10px] bg-white/20 px-2 py-0.5 rounded-full",children:[n.questions," Qs"]})]},n.name))})]})}function tg({onClick:e,isPulsing:t}){return r.jsxs("button",{onClick:e,className:`w-full rounded-2xl p-5 flex justify-between items-center transition-all ${t?"bg-green-500/20 border-2 border-green-500 animate-pulse":"bg-white/5 border border-base-border hover:bg-white/10"}`,children:[r.jsxs("div",{className:"flex items-center gap-4",children:[r.jsx("div",{className:"w-12 h-12 bg-gradient-to-br from-green-400 to-teal-500 rounded-xl grid place-items-center text-2xl",children:"📚"}),r.jsxs("div",{className:"text-left",children:[r.jsx("div",{className:"font-medium",children:"Practice Mode"}),r.jsx("div",{className:"text-xs text-base-muted",children:"No timer • No energy cost • Learn at your pace"})]})]}),r.jsx("div",{className:"text-xl",children:"→"})]})}function ng({dailyQ:e,isFlipped:t,picked:n,onAnswer:s,dailyCompleted:a,DAILY_Q_COINS:i,DAILY_Q_XP:o}){return a?r.jsx("div",{className:"rounded-3xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 p-6 mb-6",children:r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsx("span",{className:"text-3xl",children:"✅"}),r.jsxs("div",{children:[r.jsx("h3",{className:"font-bold",children:"Daily Challenge Complete!"}),r.jsx("p",{className:"text-sm text-base-muted",children:"Come back tomorrow for a new challenge"})]})]})}):e?r.jsx("div",{className:"flip-card mb-6",children:r.jsxs("div",{className:`flip-card-inner ${t?"flipped":""}`,children:[r.jsx("div",{className:"flip-card-front",children:r.jsxs("div",{className:"rounded-3xl bg-white/5 border border-base-border p-6",children:[r.jsxs("div",{className:"flex justify-between items-center mb-4",children:[r.jsx("h3",{className:"text-lg font-bold",children:"🎯 Daily Challenge"}),r.jsxs("span",{className:"px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-xs font-medium",children:["+",i," coins +",o," XP"]})]}),r.jsx("p",{className:"text-sm mb-4 text-base-muted",children:e.prompt}),r.jsx("div",{className:"grid grid-cols-2 gap-3",children:e.options.map((l,c)=>{const u=c===e.answerIndex,f=n===c,p=n!==null;return r.jsx("button",{onClick:m=>s(c,m),disabled:n!==null,className:`p-3 rounded-xl border-2 text-sm font-medium transition-all ${p?u?"border-green-500 bg-green-500/20":f?"border-red-500 bg-red-500/20":"border-base-border bg-white/5":"border-base-border bg-white/5 hover:bg-white/10"} ${n!==null?"cursor-not-allowed":"cursor-pointer"}`,children:l},c)})})]})}),r.jsx("div",{className:"flip-card-back absolute inset-0",children:r.jsxs("div",{className:"rounded-3xl bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-500/30 p-6 h-full flex flex-col items-center justify-center",children:[r.jsx("div",{className:"text-6xl mb-4",style:{animation:"float 2s ease-in-out infinite"},children:"🎉"}),r.jsx("h3",{className:"text-2xl font-bold text-green-400 mb-2",children:"Awesome!"}),r.jsxs("p",{className:"text-sm text-base-muted text-center",children:["You've earned ",i," coins & ",o," XP!"]}),r.jsx("p",{className:"text-xs text-base-muted/70 mt-2",children:"Come back tomorrow for more"})]})})]})}):null}function rg({show:e,onClose:t,player:n,changeAvatar:s,GAME_CONSTANTS:a}){return e?r.jsx("div",{className:"fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4",onClick:i=>{i.target===i.currentTarget&&t()},children:r.jsxs("div",{className:"bg-base-card rounded-3xl p-6 w-full max-w-md border border-base-border max-h-[80vh] overflow-y-auto",onClick:i=>i.stopPropagation(),children:[r.jsxs("div",{className:"flex justify-between items-center mb-4",children:[r.jsx("h3",{className:"text-xl font-bold",children:"Choose Your Avatar"}),r.jsx("button",{onClick:t,className:"w-8 h-8 rounded-lg bg-white/5 border border-base-border grid place-items-center hover:bg-white/10 transition",children:"✕"})]}),r.jsx("div",{className:"grid grid-cols-2 gap-4",children:a.AVATARS.map(i=>{const o=!n.unlockedAvatars.includes(i.id),l=n.avatar===i.id;return r.jsxs("button",{onClick:()=>{o||(s(i.id),t())},className:`p-4 rounded-2xl border-2 transition-all ${l?"border-brand-blue bg-brand-blue/20":o?"border-gray-600 bg-gray-800/50 opacity-50":"border-base-border bg-white/5 hover:bg-white/10"}`,disabled:o,children:[r.jsx("div",{className:`text-4xl mb-2 ${o?"grayscale":""}`,children:i.emoji}),r.jsx("div",{className:"text-sm font-medium",children:i.name}),o&&r.jsxs("div",{className:"text-xs text-gray-400 mt-1",children:["Unlock at Level ",i.unlockLevel]}),l&&r.jsx("div",{className:"text-xs text-brand-blue mt-1",children:"Current"})]},i.id)})})]})}):null}function sg({show:e,onClose:t,categories:n,onCategorySelect:s}){return e?r.jsx("div",{className:"fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4",onClick:a=>{a.target===a.currentTarget&&t()},children:r.jsxs("div",{className:"bg-base-card rounded-3xl p-6 w-full max-w-md border border-base-border",onClick:a=>a.stopPropagation(),children:[r.jsxs("div",{className:"flex justify-between items-center mb-4",children:[r.jsx("h3",{className:"text-xl font-bold",children:"More categories"}),r.jsx("button",{onClick:t,className:"w-8 h-8 rounded-lg bg-white/5 border border-base-border grid place-items-center hover:bg-white/10 transition",children:"✕"})]}),r.jsx("div",{className:"grid grid-cols-2 gap-3 mb-4",children:n.map(a=>r.jsxs("button",{onClick:()=>{t(),s(a)},className:`bg-gradient-to-br ${a.gradient} p-4 rounded-2xl flex flex-col items-center gap-2 hover:scale-105 transition-transform relative`,children:[r.jsx("div",{className:"text-3xl",children:a.icon}),r.jsx("div",{className:"text-sm font-bold text-white",children:a.name}),r.jsxs("div",{className:"text-xs text-white/80",children:[a.questions," questions"]})]},a.name))})]})}):null}function ag({show:e,onClose:t,coins:n,onNavigateToPlay:s}){return e?r.jsx("div",{className:"fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4",onClick:a=>{a.target===a.currentTarget&&t()},children:r.jsxs("div",{className:"bg-base-card rounded-3xl p-6 w-full max-w-md border border-base-border relative overflow-hidden",onClick:a=>a.stopPropagation(),children:[r.jsx("div",{className:"absolute inset-0 opacity-10",children:r.jsx("div",{className:"magic-gradient h-full"})}),r.jsxs("div",{className:"relative",children:[r.jsxs("div",{className:"flex items-center justify-between mb-6",children:[r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsx("div",{className:"coin-3d text-5xl",style:{animation:"coinRotate 2s linear infinite, glow 2s ease-in-out infinite"},children:"🪙"}),r.jsxs("div",{children:[r.jsx("h3",{className:"text-2xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent",children:"Your Treasure"}),r.jsxs("p",{className:"text-3xl font-bold text-white mt-1",children:[n," Coins"]})]})]}),r.jsx("button",{onClick:t,className:"w-8 h-8 rounded-lg bg-white/5 border border-base-border grid place-items-center hover:bg-white/10 transition",children:"✕"})]}),r.jsxs("div",{className:"mb-6",children:[r.jsx("h4",{className:"text-sm font-medium text-base-muted mb-3",children:"Ways to Earn"}),r.jsxs("div",{className:"space-y-3",children:[r.jsx("div",{className:"p-4 rounded-xl bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 hover:scale-[1.02] transition-transform",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{children:[r.jsxs("div",{className:"font-medium flex items-center gap-2",children:[r.jsx("span",{className:"text-2xl",children:"✅"}),"Complete Quizzes"]}),r.jsx("div",{className:"text-xs text-base-muted mt-1",children:"+5 coins per correct answer"})]}),r.jsx("div",{className:"text-green-400 font-bold",children:"+5"})]})}),r.jsx("div",{className:"p-4 rounded-xl bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20 hover:scale-[1.02] transition-transform",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{children:[r.jsxs("div",{className:"font-medium flex items-center gap-2",children:[r.jsx("span",{className:"text-2xl",children:"🎯"}),"Daily Challenge"]}),r.jsx("div",{className:"text-xs text-base-muted mt-1",children:"Complete daily for bonus"})]}),r.jsx("div",{className:"text-blue-400 font-bold",children:"+5"})]})}),r.jsx("div",{className:"p-4 rounded-xl bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 hover:scale-[1.02] transition-transform",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{children:[r.jsxs("div",{className:"font-medium flex items-center gap-2",children:[r.jsx("span",{className:"text-2xl",children:"🎰"}),"Spin & Play"]}),r.jsx("div",{className:"text-xs text-base-muted mt-1",children:"Test your luck!"})]}),r.jsx("div",{className:"text-purple-400 font-bold",children:"+50"})]})}),r.jsx("div",{className:"p-4 rounded-xl bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 hover:scale-[1.02] transition-transform",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{children:[r.jsxs("div",{className:"font-medium flex items-center gap-2",children:[r.jsx("span",{className:"text-2xl",children:"🏆"}),"Achievements"]}),r.jsx("div",{className:"text-xs text-base-muted mt-1",children:"Unlock special rewards"})]}),r.jsx("div",{className:"text-orange-400 font-bold",children:"+???"})]})})]})]}),r.jsxs("div",{className:"mb-6",children:[r.jsxs("div",{className:"flex justify-between text-xs text-base-muted mb-2",children:[r.jsx("span",{children:"Next reward"}),r.jsxs("span",{children:[100-n%100," coins to go"]})]}),r.jsx("div",{className:"h-2 bg-white/10 rounded-full overflow-hidden",children:r.jsx("div",{className:"h-full bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full transition-all",style:{width:`${n%100}%`}})})]}),r.jsx("button",{onClick:s,className:"w-full py-3 rounded-xl bg-gradient-to-r from-yellow-400 to-orange-500 text-white font-bold hover:scale-[1.02] transition-transform shadow-lg",style:{boxShadow:"0 10px 30px rgba(251, 191, 36, 0.3)"},children:"Start Earning Now! 🚀"})]})]})}):null}function ig({show:e,onClose:t,selectedCategory:n,difficulty:s,setDifficulty:a,count:i,setCount:o,timer:l,setTimer:c,onStart:u}){return!e||!n?null:r.jsx("div",{className:"fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4",onClick:f=>{f.target===f.currentTarget&&t()},children:r.jsxs("div",{className:"bg-base-card rounded-3xl p-6 w-full max-w-md border border-base-border",onClick:f=>f.stopPropagation(),children:[r.jsxs("div",{className:"flex justify-between items-center mb-4",children:[r.jsx("h3",{className:"text-xl font-bold",children:"Quiz Mode"}),r.jsx("button",{onClick:t,className:"w-8 h-8 rounded-lg bg-white/5 border border-base-border grid place-items-center hover:bg-white/10 transition",children:"✕"})]}),r.jsx("div",{className:"mb-4 p-3 rounded-xl bg-blue-500/10 border border-blue-500/30",children:r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsx("div",{className:"text-2xl",children:n.icon}),r.jsxs("div",{children:[r.jsxs("div",{className:"font-medium",children:["Category: ",n.name]}),r.jsxs("div",{className:"text-xs text-base-muted",children:[n.questions," questions available"]})]})]})}),r.jsxs("div",{className:"mb-4",children:[r.jsx("label",{className:"text-sm text-base-muted mb-2 block",children:"Difficulty"}),r.jsx("div",{className:"grid grid-cols-3 gap-2",children:["easy","medium","hard"].map(f=>r.jsx("button",{onClick:()=>a(f),className:`py-2 rounded-xl border ${s===f?"bg-brand-blue/30 border-brand-blue":"bg-white/5 border-base-border"}`,children:f.charAt(0).toUpperCase()+f.slice(1)},f))})]}),r.jsxs("div",{className:"mb-4",children:[r.jsx("label",{className:"text-sm text-base-muted mb-2 block",children:"Questions"}),r.jsx("div",{className:"grid grid-cols-4 gap-2",children:[5,10,20,30].map(f=>r.jsx("button",{onClick:()=>o(f),className:`py-2 rounded-xl border ${i===f?"bg-brand-blue/30 border-brand-blue":"bg-white/5 border-base-border"}`,children:f},f))})]}),r.jsxs("div",{className:"mb-6",children:[r.jsx("label",{className:"text-sm text-base-muted mb-2 block",children:"Timer (seconds per question)"}),r.jsx("input",{type:"number",value:l,onChange:f=>c(Number(f.target.value)||45),min:10,max:120,className:"w-full px-4 py-2 rounded-xl bg-white/5 border border-base-border"})]}),r.jsxs("div",{className:"flex gap-3",children:[r.jsx("button",{onClick:t,className:"flex-1 py-3 rounded-xl border border-base-border bg-white/5",children:"Cancel"}),r.jsx("button",{onClick:u,className:"flex-1 py-3 rounded-xl bg-gradient-to-r from-brand-blue to-brand-purple text-white font-medium",children:"Start Quiz"})]})]})})}function og({show:e,onClose:t,allCategories:n,category:s,setCategory:a,difficulty:i,setDifficulty:o,count:l,setCount:c,onStart:u}){return e?r.jsx("div",{className:"fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4",onClick:f=>{f.target===f.currentTarget&&t()},children:r.jsxs("div",{className:"bg-base-card rounded-3xl p-6 w-full max-w-md border border-base-border max-h-[90vh] overflow-y-auto",onClick:f=>f.stopPropagation(),children:[r.jsxs("div",{className:"flex justify-between items-center mb-4",children:[r.jsx("h3",{className:"text-xl font-bold",children:"Practice Mode"}),r.jsx("button",{onClick:t,className:"w-8 h-8 rounded-lg bg-white/5 border border-base-border grid place-items-center hover:bg-white/10 transition",children:"✕"})]}),r.jsxs("div",{className:"mb-4",children:[r.jsx("label",{className:"text-sm text-base-muted mb-2 block",children:"Category"}),r.jsx("div",{className:"grid grid-cols-3 gap-2 max-h-[200px] overflow-y-auto",children:n.map(f=>r.jsxs("button",{onClick:()=>a(f.slug),className:`p-3 rounded-xl border flex flex-col items-center gap-1 ${s===f.slug?"bg-brand-blue/30 border-brand-blue":"bg-white/5 border-base-border"}`,children:[r.jsx("div",{className:"text-xl",children:f.icon}),r.jsx("div",{className:"text-[10px] text-center",children:f.name})]},f.slug))})]}),r.jsxs("div",{className:"mb-4",children:[r.jsx("label",{className:"text-sm text-base-muted mb-2 block",children:"Difficulty"}),r.jsx("div",{className:"grid grid-cols-3 gap-2",children:["easy","medium","hard"].map(f=>r.jsx("button",{onClick:()=>o(f),className:`py-2 rounded-xl border ${i===f?"bg-brand-blue/30 border-brand-blue":"bg-white/5 border-base-border"}`,children:f.charAt(0).toUpperCase()+f.slice(1)},f))})]}),r.jsxs("div",{className:"mb-6",children:[r.jsx("label",{className:"text-sm text-base-muted mb-2 block",children:"Questions"}),r.jsx("div",{className:"grid grid-cols-4 gap-2",children:[5,10,20,30].map(f=>r.jsx("button",{onClick:()=>c(f),className:`py-2 rounded-xl border ${l===f?"bg-brand-blue/30 border-brand-blue":"bg-white/5 border-base-border"}`,children:f},f))})]}),r.jsxs("div",{className:"flex gap-3",children:[r.jsx("button",{onClick:t,className:"flex-1 py-3 rounded-xl border border-base-border bg-white/5",children:"Cancel"}),r.jsx("button",{onClick:u,className:"flex-1 py-3 rounded-xl bg-gradient-to-r from-brand-blue to-brand-purple text-white font-medium",children:"Start Practice"})]})]})}):null}function lg({player:e,onContinue:t}){const[n,s]=d.useState(!0),[a,i]=d.useState(!1),[o,l]=d.useState(!1),[c,u]=d.useState(""),[f,p]=d.useState(""),m=()=>{try{const h=new Audio("/sounds/welcome.mp3");h.volume=.6,h.play()}catch{console.log("Welcome sound not available")}},w=()=>{navigator.vibrate&&navigator.vibrate([100,50,100])},k=(()=>{if(e!=null&&e.name)return e.name;let h=localStorage.getItem("userName");return h||(h="Champion",localStorage.setItem("userName",h)),h})();d.useEffect(()=>{document.body.classList.add("hide-bottom-nav"),m(),w();const h=["🦉","🐧","🦝","🦜","🦕","🐙","🦊","🐸","🦁","🐨"];p(h[Math.floor(Math.random()*h.length)]);const b=setInterval(()=>{l(T=>!T)},2e3),E=["🎯 New challenges await!","🏆 Ready to be a champion?","🌟 Your brain adventure starts now!","🎨 Time for fun learning!","🎪 The quiz circus is open!","🚀 Blast off to knowledge!","🎭 Let's play and learn!","🌈 Rainbow of questions ahead!"];u(E[Math.floor(Math.random()*E.length)]);const j=setInterval(()=>{u(E[Math.floor(Math.random()*E.length)])},3e3);return()=>{document.body.classList.remove("hide-bottom-nav"),clearInterval(b),clearInterval(j)}},[t]);const C=()=>{try{const h=new Audio("/sounds/tap.mp3");h.volume=.5,h.play()}catch{console.log("Click sound not available")}navigator.vibrate&&navigator.vibrate(20),i(!0),setTimeout(()=>{document.body.classList.remove("hide-bottom-nav"),s(!1),t()},400)};if(!n)return null;const v=()=>{const h=new Date().getHours();return h<12?"Good morning":h<17?"Good afternoon":"Good evening"};return r.jsxs("div",{className:`fixed inset-0 z-50 flex items-center justify-center transition-all duration-500
    ...
    `,document.getElementById("exit-toast-styles")||(p.id="exit-toast-styles",document.head.appendChild(p)),document.body.appendChild(f),setTimeout(()=>{const m=document.getElementById("exit-toast");m&&(m.style.animation="slideDown 0.3s ease-out",m.style.animationFillMode="forwards",setTimeout(()=>m.remove(),300))},2e3)},l=()=>{if(!n)return null;const u=()=>{var p,m,w,x;try{if((m=(p=window.navigator)==null?void 0:p.app)!=null&&m.exitApp){window.navigator.app.exitApp();return}if((x=(w=window.navigator)==null?void 0:w.app)!=null&&x.backHistory){window.navigator.app.backHistory();return}const k=window.history.length;window.history.go(-k),window.close(),setTimeout(()=>{window.location.href="about:blank"},100)}catch(k){console.log("Exit failed:",k),window.location.href="about:blank"}},f=()=>{s(!1),window.history.pushState({path:"/",preventBack:!0},"","/")};return r.jsxs("div",{style:{position:"fixed",top:0,left:0,right:0,bottom:0,backgroundColor:"rgba(0, 0, 0, 0.5)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:9999,animation:"fadeIn 0.2s ease-out"},onClick:f,children:[r.jsxs("div",{style:{background:"linear-gradient(135deg, #1e3c72 0%, #2a5298 100%)",borderRadius:"16px",padding:"24px",maxWidth:"320px",width:"90%",boxShadow:"0 10px 40px rgba(0, 0, 0, 0.3)",animation:"slideIn 0.3s ease-out"},onClick:p=>p.stopPropagation(),children:[r.jsx("h3",{style:{color:"white",fontSize:"20px",fontWeight:"bold",marginBottom:"12px",textAlign:"center"},children:"Exit App?"}),r.jsx("p",{style:{color:"rgba(255, 255, 255, 0.9)",fontSize:"14px",marginBottom:"24px",textAlign:"center",lineHeight:"1.5"},children:"Are you sure you want to exit the Quiz Game?"}),r.jsxs("div",{style:{display:"flex",gap:"12px"},children:[r.jsx("button",{onClick:f,style:{flex:1,padding:"12px",border:"2px solid rgba(255, 255, 255, 0.3)",borderRadius:"8px",background:"transparent",color:"white",fontSize:"16px",fontWeight:"600",cursor:"pointer",transition:"all 0.2s"},onMouseOver:p=>p.target.style.backgroundColor="rgba(255, 255, 255, 0.1)",onMouseOut:p=>p.target.style.backgroundColor="transparent",children:"Stay"}),r.jsx("button",{onClick:u,style:{flex:1,padding:"12px",border:"none",borderRadius:"8px",background:"linear-gradient(135deg, #ff6b6b 0%, #ff4444 100%)",color:"white",fontSize:"16px",fontWeight:"600",cursor:"pointer",transition:"transform 0.2s",boxShadow:"0 4px 15px rgba(255, 68, 68, 0.3)"},onMouseOver:p=>p.target.style.transform="scale(1.05)",onMouseOut:p=>p.target.style.transform="scale(1)",children:"Exit"})]})]}),r.jsx("style",{children:`
        ...
        `})]})};return{goBack:d.useCallback(()=>{if(t.pathname==="/"){s(!0);return}e(-1)},[t.pathname,e]),ExitDialog:l}}const Td=(e=new Date)=>e.toLocaleDateString("en-CA"),_d=(e,t=null)=>{try{const n=localStorage.getItem(e);return n?JSON.parse(n):t}catch{return t}},dg=(e,t)=>localStorage.setItem(e,JSON.stringify(t));function Ld(){const{ExitDialog:e}=cg(),[t,n]=d.useState(!0),s=He(),{player:a,addXP:i,addCoins:o,levelProgress:l,useEnergy:c,changeAvatar:u}=jn(),[f]=zt("/sounds/correct.mp3",{volume:.6}),[p]=zt("/sounds/wrong.mp3",{volume:.6}),[m]=zt("/sounds/coin.mp3",{volume:.75}),[w]=zt("/sounds/levelup.mp3",{volume:.8}),x=d.useRef(a.level),k=d.useRef(null);d.useEffect(()=>{const me=()=>{};return window.addEventListener("focus",me),()=>window.removeEventListener("focus",me)},[]),d.useEffect(()=>{a.level>x.current&&(w==null||w(),x.current=a.level)},[a.level,w]);const[C,v]=d.useState(!1),[h,b]=d.useState(null),[E,j]=d.useState(!1),[T,S]=d.useState("medium"),[g,y]=d.useState(10),[N,R]=d.useState(45),[I,q]=d.useState(!1),[Z,H]=d.useState(!1),[Y,$]=d.useState(null),[P,_]=d.useState(null),[F,L]=d.useState(!1),[D,A]=d.useState(!1),[X,ne]=d.useState(null),re=10,Q=5,[M,K]=d.useState(!1),[z,B]=d.useState(!1),[ee,ae]=d.useState("general-knowledge"),[ce,U]=d.useState("medium"),[G,W]=d.useState(10),[O,te]=d.useState(()=>_d("dq_daily_log",{})[Td()]===!0);d.useEffect(()=>{const me=sessionStorage.getItem("homeScrollPosition");me&&window.scrollTo(0,parseInt(me));const he=()=>{sessionStorage.setItem("homeScrollPosition",window.scrollY.toString())};return window.addEventListener("scroll",he),()=>window.removeEventListener("scroll",he)},[]),d.useEffect(()=>{if(O)return;(async()=>{var he;try{const be=await fetch("/data/quiz_questions_bank.csv").then(et=>et.text()),{data:ke}=hr.parse(be,{header:!0,skipEmptyLines:!0});if(!ke.length)throw new Error("empty");const Ue=ke[Math.floor(Math.random()*ke.length)],qt=[Ue.option1,Ue.option2,Ue.option3,Ue.option4].filter(Boolean);$({category:Ue.category||"General",prompt:Ue.question,options:qt,answerIndex:["A","B","C","D"].indexOf((he=Ue.answer)==null?void 0:he.toUpperCase())||0})}catch{$({category:"Science",prompt:"Which planet is known as the Red Planet?",options:["Earth","Mars","Jupiter","Venus"],answerIndex:1})}})()},[O]);const de=(me,he)=>{if(P!==null)return;_(me);const be=me===Y.answerIndex;if(be){if(f(),he!=null&&he.currentTarget&&k.current){const ke=he.currentTarget.getBoundingClientRect();m(),ne({startRect:ke,count:10,amount:Q})}}else p();setTimeout(()=>{if(A(!0),L(!0),be){const ke=Td();dg("dq_daily_log",{..._d("dq_daily_log",{}),[ke]:!0}),te(!0);const Ue=Number(localStorage.getItem("dq_streak")||0);localStorage.setItem("dq_streak",String(Ue+1))}},600)},je=me=>{if(me.slug==="more"){v(!0);return}b(me),j(!0)},Le=()=>{console.log("Starting quiz with energy:",a.energy),console.log("Category:",h.slug),s(`/quiz/${h.slug}`,{state:{mode:"quiz",difficulty:T,count:g,timer:{type:"per_q",seconds:N},source:"adventure"}}),j(!1)},Be=()=>{console.log("Starting practice, category:",ee),s(`/quiz/${ee}`,{state:{mode:"practice",difficulty:ce,count:G,timer:{type:"off",seconds:0}}}),B(!1)},Ee=[{icon:"🎯",label:"Quests",color:"bg-gradient-to-br from-orange-500 to-pink-500",action:()=>{sessionStorage.setItem("questsFromHome","true"),s("/profile/quests")}},{icon:"🔥",label:"Streak",color:"bg-gradient-to-br from-red-500 to-orange-500",action:()=>s("/profile/streaks")},{icon:"🏆",label:"Achieve",color:"bg-gradient-to-br from-blue-500 to-purple-500",action:()=>s("/profile/achievements")},{icon:"🎁",label:"Rewards",color:"bg-gradient-to-br from-green-500 to-teal-500",action:()=>s("/profile/rewards")}];return r.jsxs(r.Fragment,{children:[r.jsx(e,{}),t&&r.jsx(lg,{player:a,onContinue:()=>n(!1)}),r.jsxs("div",{className:"min-h-screen bg-base-bg text-base-text",children:[r.jsx("div",{className:"fixed inset-0 -z-10 pointer-events-none",style:{background:"linear-gradient(to bottom, #0B0F1A, #111827)"}}),r.jsxs("div",{className:"relative z-10 px-4 pt-10 pb-24",children:[r.jsx("style",{jsx:!0,children:`
          @keyframes float {
        ...
        `}),X&&r.jsx(Ci,{startRect:X.startRect,targetRef:k,count:X.count,onDone:()=>{M||(i(re),o(X.amount),K(!0)),ne(null)}}),r.jsxs("div",{className:"mb-8",children:[r.jsxs("div",{className:"flex justify-between items-start mb-4",children:[r.jsx("div",{className:"cursor-pointer hover:scale-105 transition-transform",onClick:()=>H(!0),children:r.jsx(Xx,{player:a,size:"small",showLevel:!0,showName:!0})}),r.jsx("div",{className:"flex gap-2",children:r.jsxs("button",{ref:k,onClick:()=>q(!0),className:"px-3 py-1.5 rounded-xl bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/30 flex items-center gap-2 hover:from-yellow-500/20 hover:to-orange-500/20 transition",children:[r.jsx("span",{className:"text-lg",children:"🪙"}),r.jsx("span",{className:"font-bold",children:a.coins})]})})]}),r.jsx(Kx,{current:l.current,required:l.required,level:a.level,animate:!0})]}),r.jsx(Jx,{onClick:()=>s("/play")}),r.jsx(Zx,{actions:Ee}),r.jsx(ng,{dailyQ:Y,isFlipped:D,picked:P,onAnswer:de,dailyCompleted:O,DAILY_Q_COINS:Q,DAILY_Q_XP:re}),r.jsx(eg,{categories:Em,onCategorySelect:je}),r.jsx(tg,{onClick:()=>B(!0),isPulsing:a.energy<10}),r.jsx(rg,{show:Z,onClose:()=>H(!1),player:a,changeAvatar:u,GAME_CONSTANTS:ft}),r.jsx(ig,{show:E,onClose:()=>j(!1),selectedCategory:h,difficulty:T,setDifficulty:S,count:g,setCount:y,timer:N,setTimer:R,onStart:Le}),r.jsx(og,{show:z,onClose:()=>B(!1),allCategories:Rm,category:ee,setCategory:ae,difficulty:ce,setDifficulty:U,count:G,setCount:W,onStart:Be}),r.jsx(sg,{show:C,onClose:()=>v(!1),categories:Pm,onCategorySelect:je}),r.jsx(ag,{show:I,onClose:()=>q(!1),coins:a.coins,onNavigateToPlay:()=>{q(!1),s("/play")}})]})]})]})}const en={COINS:"qp_coins",XP:"qp_xp",LEVEL:"qp_level",OWNED_CHARACTERS:"owned_characters",SOUND:"play_sound_on"},tn={get:(e,t=null)=>{try{const n=localStorage.getItem(e);return n?JSON.parse(n):t}catch{return t}},set:(e,t)=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}}};function lc(){const[e,t]=d.useState(()=>tn.get(en.COINS,0)),[n,s]=d.useState(()=>tn.get(en.XP,0)),[a,i]=d.useState(()=>tn.get(en.LEVEL,1)),[o,l]=d.useState(()=>tn.get(en.OWNED_CHARACTERS,[])),[c,u]=d.useState(()=>tn.get(en.SOUND,!0));return d.useEffect(()=>tn.set(en.COINS,e),[e]),d.useEffect(()=>tn.set(en.XP,n),[n]),d.useEffect(()=>tn.set(en.LEVEL,a),[a]),d.useEffect(()=>tn.set(en.OWNED_CHARACTERS,o),[o]),d.useEffect(()=>tn.set(en.SOUND,c),[c]),{coins:e,xp:n,level:a,ownedCharacters:o,soundOn:c,addCoins:x=>t(k=>k+x),addXp:x=>s(k=>k+x),unlockCharacter:x=>{l(k=>[...new Set([...k,x])])},setSoundOn:u,checkLevelUp:()=>{const x=100*a*(a-1);return n>=x?(i(k=>k+1),!0):!1},nextLevelThreshold:100*a*(a-1),xpProgress:n/(100*a*(a-1))}}const ug=[{name:"General Knowledge",questions:50,icon:"🧠",color:"#7C3AED"},{name:"Artificial Intelligence",questions:28,icon:"🤖",color:"#10B981"},{name:"Fun facts",questions:30,icon:"🎉",color:"#EF4444"},{name:"Science",questions:45,icon:"🧪",color:"#F59E0B"},{name:"History",questions:42,icon:"🏺",color:"#2563EB"},{name:"Geography",questions:38,icon:"🗺️",color:"#FACC15"}],rn=ug.slice(0,6),nr=360/rn.length,Tm={"general-knowledge":"TINA","artificial-intelligence":"ALBERT","fun-facts":"BONZO",science:"POP",history:"TITO",geography:"HECTOR"},Sn={FULL_TURNS:6,DURATION:2800,OVERSHOOT:12,SETTLE_DURATION:350},ir=e=>e.toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-"),Ad=e=>(e%360+360)%360,cc=e=>{try{navigator.vibrate&&navigator.vibrate(e)}catch{}},Dr=(e,t=.7)=>{try{const n=new Audio(e);n.volume=t,n.play()}catch{}};function fg({run:e,coins:t,xp:n,level:s,ownedCharacters:a,onSpin:i,onBack:o,spinning:l,angle:c,transition:u,result:f,showCallout:p,glowColor:m,soundOn:w,setSoundOn:x,showSparkle:k,pulseIdx:C,nextProgressIdx:v,pendingProgressIdx:h,coinBurstTick:b,lastAnswerWasCorrect:E}){const j=100*s*(s-1),[T,S]=d.useState(!1),g=d.useRef(0),y=d.useRef(null),N=d.useRef(null),[R,I]=d.useState({dx:110,dy:-260}),[q,Z]=d.useState(!1);return d.useEffect(()=>(document.body.classList.add("hide-bottom-nav"),()=>{document.body.classList.remove("hide-bottom-nav")}),[]),d.useEffect(()=>{if(h==null)return;S(!1);const H=setTimeout(()=>S(!0),30);return()=>clearTimeout(H)},[h]),d.useEffect(()=>{var Y,$,P,_;if(!b||!E||b===g.current)return;g.current=b;try{const F=($=(Y=N==null?void 0:N.current)==null?void 0:Y.getBoundingClientRect)==null?void 0:$.call(Y),L=(_=(P=y==null?void 0:y.current)==null?void 0:P.getBoundingClientRect)==null?void 0:_.call(P);if(F&&L){const D=F.left+F.width/2,A=F.top+F.height/2,X=L.left+L.width/2,ne=L.top+L.height/2;I({dx:X-D,dy:ne-A})}}catch{}w&&Dr("/sounds/coin.mp3",.7),Z(!0);const H=setTimeout(()=>Z(!1),700);return()=>clearTimeout(H)},[b,w,E]),r.jsx("div",{className:"fixed inset-0 bg-base-bg text-base-text overflow-hidden",children:r.jsxs("div",{className:"h-full overflow-y-auto mx-auto max-w-md px-5 pt-[calc(env(safe-area-inset-top)+3rem)] pb-[calc(env(safe-area-inset-bottom)+5.25rem)]",children:[r.jsxs("header",{className:"flex items-center justify-between mb-8",children:[r.jsx("button",{onClick:o,className:"h-10 w-10 rounded-full border border-base-border grid place-items-center bg-white/5 hover:bg-white/10 transition translate-y-[4px]",children:"←"}),r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsxs("button",{className:"px-3 py-1 rounded-2xl bg-white/5 border border-base-border text-left translate-y-[4px]",children:[r.jsxs("div",{className:"text-[11px]",children:["Lvl ",s," • ",n,"/",j]}),r.jsx("div",{className:"mt-1 h-1 w-full bg-white/10 rounded",children:r.jsx("div",{className:"h-1 bg-brand-blue rounded",style:{width:`${Math.min(n/j,1)*100}%`}})})]}),r.jsxs("button",{ref:y,className:"px-3 py-1 rounded-2xl bg-white/5 border border-base-border translate-y-[4px]",children:["🪙 ",t]})]}),r.jsx("button",{onClick:()=>x(!w),className:"h-10 w-10 rounded-full border border-base-border grid place-items-center bg-white/5 hover:bg-white/10 transition translate-y-[4px]",children:r.jsx("span",{className:"text-lg",children:w?"🔊":"🔇"})})]}),a.length>0&&r.jsx("div",{className:"flex justify-center mb-6",children:r.jsx("div",{className:"flex gap-2 px-4 py-2 bg-white/10 rounded-2xl backdrop-blur border border-base-border",children:a.map(H=>{const Y=rn.find(P=>ir(P.name)===H),$=Tm[H];return r.jsxs("div",{className:"flex flex-col items-center",children:[r.jsx("div",{className:"w-8 h-8 rounded-full bg-white/20 flex items-center justify-center border border-white/30",children:r.jsx("span",{className:"text-sm",children:Y==null?void 0:Y.icon})}),r.jsx("span",{className:"text-[10px] text-base-muted mt-1",children:$})]},H)})})}),r.jsx("div",{className:"flex justify-center mt-12 sm:mt-16 mb-6",children:r.jsxs("div",{className:"w-80 max-w-full",children:[r.jsx("style",{children:`
              @keyframes qp_sweep { from { transform: translateX(0); } to { transform: translateX(100%); } }
            `}),r.jsx("div",{className:"relative grid grid-cols-3 gap-1 h-3 rounded-full overflow-hidden bg-white/10 border border-white/15",children:[0,1,2].map(H=>{const Y=["#FF9800","#FFC107","#cadd75ff"],$=!!e.progress[H];return r.jsxs("div",{className:"relative h-full bg-white/10",children:[r.jsx("div",{className:"absolute inset-y-0 left-0 rounded-[6px]",style:{width:$?H===h?T?"100%":"0%":v===H&&h==null?"0%":"100%":"0%",backgroundColor:Y[H],transition:H===h?"width 1200ms ease-out":"none"}}),C===H&&r.jsx("span",{className:"absolute inset-y-0 left-0 w-full overflow-hidden pointer-events-none",children:r.jsx("span",{className:"absolute inset-y-0 left-0 w-1 rounded bg-white/80",style:{animation:"qp_sweep 1200ms ease-out forwards"}})}),k===H&&r.jsx("span",{className:"absolute right-[-2px] top-1/2 -translate-y-1/2 text-xs select-none",children:"✨"})]},H)})},e.qIndex)]})}),r.jsx("section",{className:"flex flex-col items-center mt-28 sm:mt-32 mb-10",children:r.jsxs("div",{ref:N,className:"relative w-96 h-96 rounded-full select-none",children:[m&&r.jsx("div",{className:"pointer-events-none absolute -inset-4 rounded-full",style:{boxShadow:`0 0 0 8px ${m}40, 0 0 40px 12px ${m}60`}}),r.jsx("div",{className:"absolute inset-0 rounded-full border-4 border-white/20 shadow-2xl overflow-hidden will-change-transform bg-base-card",style:{transform:`rotate(${c}deg)`,transition:u},children:r.jsxs("svg",{width:"100%",height:"100%",viewBox:"0 0 100 100",className:"block",children:[rn.map((H,Y)=>{const $=Y*nr,P=$+nr,_=nr>180?1:0,F=Math.PI*$/180,L=Math.PI*P/180,D=50+45*Math.cos(F),A=50-45*Math.sin(F),X=50+45*Math.cos(L),ne=50-45*Math.sin(L),re=$+nr/2,Q=28,M=50+Q*Math.cos(re*Math.PI/180),K=50-Q*Math.sin(re*Math.PI/180);return r.jsxs("g",{children:[r.jsx("path",{d:`M50,50 L${D},${A} A45,45 0 ${_} 0 ${X},${ne} Z`,fill:H.color,stroke:"rgba(255,255,255,0.3)",strokeWidth:"0.5"}),r.jsx("text",{x:M,y:K,fill:"white",fontSize:"8",dominantBaseline:"middle",textAnchor:"middle",className:"font-bold",children:H.icon})]},Y)}),r.jsx("circle",{cx:"50",cy:"50",r:"12",fill:"white",stroke:"#ddd",strokeWidth:"1"})]})}),r.jsx("button",{onClick:i,disabled:l,className:`absolute z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
      ...
      `}),r.jsxs("div",{className:"fixed inset-0 pointer-events-none",children:[r.jsx("div",{className:"absolute top-20 left-10 text-[100px] opacity-10 float-animation",children:S.emoji}),r.jsx("div",{className:"absolute top-40 right-20 text-[80px] opacity-10 float-animation",style:{animationDelay:"1s"},children:"⭐"}),r.jsx("div",{className:"absolute bottom-40 left-20 text-[90px] opacity-10 float-animation",style:{animationDelay:"2s"},children:"🎯"}),r.jsx("div",{className:"absolute bottom-20 right-10 text-[70px] opacity-10 float-animation",style:{animationDelay:"3s"},children:"🏆"})]}),r.jsxs("div",{className:"relative z-10 px-4 pt-[calc(env(safe-area-inset-top)+2rem)]",children:[r.jsxs("div",{className:"flex justify-between items-center mb-8 slide-in",children:[r.jsx("button",{onClick:()=>k(!0),className:"w-12 h-12 glass-card rounded-2xl shadow-lg flex items-center justify-center hover:scale-105 transition-transform",children:r.jsx("span",{className:"text-xl",children:"◀️"})}),r.jsx(kg,{lives:n}),r.jsx("button",{onClick:()=>w(!m),className:"w-12 h-12 glass-card rounded-2xl shadow-lg flex items-center justify-center hover:scale-105 transition-transform",children:r.jsx("span",{className:"text-xl",children:m?"🔊":"🔇"})})]}),r.jsx("div",{className:`glass-card rounded-3xl p-2 shadow-xl mb-2 mt-12 slide-in bg-gradient-to-r ${S.accentGradient}`,style:{animationDelay:"0.1s"},children:r.jsxs("div",{className:"grid grid-cols-3 gap-3",children:[r.jsxs("div",{className:"text-center",children:[r.jsx("div",{className:`text-3xl font-black bg-gradient-to-r ${S.color} bg-clip-text text-transparent ${E?"score-pulse":""}`,children:i}),r.jsx("div",{className:"text-xs text-white/60 font-medium mt-1",children:"Points"}),c&&u&&r.jsx("div",{className:"absolute -top-2 left-1/2 -translate-x-1/2",children:r.jsxs("span",{className:"text-green-400 font-bold text-sm coin-animation",children:["+",T[o]?o==="EASY"?10:o==="MEDIUM"?20:o==="HARD"?30:o==="EXPERT"?50:100:10]})})]}),r.jsxs("div",{className:"text-center",children:[r.jsx("div",{className:"text-3xl font-black text-white",children:s}),r.jsx("div",{className:"text-xs text-white/60 font-medium mt-1",children:"Questions"})]}),r.jsxs("div",{className:"text-center relative",children:[r.jsx("div",{className:`text-3xl font-black text-orange-400 ${a>0?"streak-flame":""}`,children:a}),r.jsx("div",{className:"text-xs text-white/60 font-medium mt-1",children:"Streak 🔥"})]})]})}),r.jsxs("div",{className:"flex justify-between items-center mb-1 slide-in",style:{animationDelay:"0.2s"},children:[r.jsx("div",{className:`px-4 py-3 rounded-full bg-gradient-to-r ${S.color} text-white shadow-lg`,children:r.jsxs("div",{className:"flex items-center gap-2",children:[r.jsx("span",{className:"text-2xl",children:S.emoji}),r.jsxs("div",{children:[r.jsx("div",{className:"font-bold text-sm",children:S.label}),r.jsxs("div",{className:"text-[10px] opacity-90",children:["Level ",s+1]})]})]})}),r.jsx("div",{className:"relative",children:r.jsxs("div",{className:"w-20 h-20 glass-card rounded-full shadow-xl flex items-center justify-center",children:[r.jsxs("svg",{className:"absolute inset-0 w-full h-full",children:[r.jsx("circle",{cx:"40",cy:"40",r:"35",fill:"none",stroke:"rgba(255, 255, 255, 0.1)",strokeWidth:"6",className:"progress-ring"}),r.jsx("circle",{cx:"40",cy:"40",r:"35",fill:"none",stroke:l<=5?"#ef4444":l<=10?"#f59e0b":"#10b981",strokeWidth:"6",strokeDasharray:`${l/30*220} 220`,strokeLinecap:"round",className:"progress-ring transition-all duration-1000"})]}),r.jsx("div",{className:"relative z-10",children:r.jsx("span",{className:`text-2xl font-black ${l<=5?"text-red-400 animate-pulse":l<=10?"text-amber-400":"text-white"}`,children:l})})]})})]})]}),r.jsxs("div",{className:"px-4 slide-in",style:{animationDelay:"0.3s"},children:[r.jsxs("div",{className:"glass-card rounded-3xl shadow-xl p-6 mb-6 border border-white/10",children:[r.jsx("div",{className:"text-center mb-2",children:r.jsxs("span",{className:"text-xs font-bold text-white/40 uppercase tracking-wider",children:["Question ",s+1]})}),r.jsx("h2",{className:"text-xl font-bold text-center text-white leading-relaxed",children:e.prompt})]}),r.jsx("div",{className:"space-y-3",children:e.options.map((y,N)=>{const R=["A","B","C","D"],I=["from-blue-400 to-blue-500","from-green-400 to-green-500","from-yellow-400 to-yellow-500","from-purple-400 to-purple-500"];let q="glass-card border border-white/10",Z="";return c&&(N===e.correctIndex?(q="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-2 border-green-400",Z="correct-bounce"):C===N&&!u&&(q="bg-gradient-to-r from-red-500/20 to-pink-500/20 border-2 border-red-400",Z="wrong-shake")),r.jsx("button",{onClick:()=>g(N),disabled:c,className:`w-full p-4 rounded-2xl shadow-lg transition-all ${q} ${Z} 
                  ${c?"":"hover:scale-[1.02] active:scale-[0.98] hover:bg-white/10"} slide-in`,style:{animationDelay:`${.4+N*.05}s`},children:r.jsxs("div",{className:"flex items-center gap-4",children:[r.jsx("div",{className:`w-12 h-12 rounded-xl bg-gradient-to-br ${I[N]} 
                    text-white font-bold text-xl flex items-center justify-center shadow-md`,children:R[N]}),r.jsx("span",{className:"flex-1 text-left font-medium text-white",children:y}),c&&N===e.correctIndex&&r.jsx("span",{className:"text-2xl",children:"✅"}),c&&C===N&&!u&&r.jsx("span",{className:"text-2xl",children:"❌"})]})},N)})}),c&&r.jsx("div",{className:"mt-6 text-center slide-in",children:r.jsx("p",{className:"text-sm font-medium text-white/70",children:u?S.motivationalText:"No worries! Keep trying! 💪"})}),f>0&&r.jsx("div",{className:"mt-4 flex justify-center slide-in",style:{animationDelay:"0.6s"},children:r.jsx("div",{className:"glass-card rounded-full px-4 py-2 shadow-lg border border-white/10",children:r.jsxs("div",{className:"flex items-center gap-2",children:[r.jsx("span",{className:"text-xl",children:"🏁"}),r.jsxs("span",{className:"text-sm font-bold text-white/80",children:["Checkpoint: Question ",f]})]})})})]}),h&&r.jsx("div",{className:"fixed inset-0 pointer-events-none flex items-center justify-center z-50",children:r.jsx("div",{className:"bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-8 py-6 rounded-3xl shadow-2xl animate-bounce",children:r.jsxs("div",{className:"text-center",children:[r.jsx("div",{className:"text-5xl mb-3",children:"🎉"}),r.jsx("div",{className:"text-2xl font-black mb-2",children:"AMAZING STREAK!"}),r.jsx("div",{className:"text-lg",children:"You earned a life back! ❤️"})]})})}),x&&r.jsx("div",{className:"fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 px-6",children:r.jsxs("div",{className:"bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-6 max-w-sm w-full shadow-2xl slide-in border border-white/10",children:[r.jsxs("div",{className:"text-center mb-6",children:[r.jsx("div",{className:"text-5xl mb-3",children:"🚪"}),r.jsx("h3",{className:"text-xl font-bold text-white mb-2",children:"Leave the game?"}),r.jsx("p",{className:"text-white/70",children:"Your progress saves at checkpoints!"})]}),r.jsxs("div",{className:"flex gap-3",children:[r.jsx("button",{onClick:()=>k(!1),className:"flex-1 py-3 bg-gradient-to-r from-green-400 to-emerald-500 text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all hover:scale-[1.02]",children:"Keep Playing"}),r.jsx("button",{onClick:p,className:"flex-1 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all hover:scale-[1.02]",children:"Exit"})]})]})})]})}function Cg({score:e,questionsAnswered:t,highScore:n,checkpoint:s,onRestart:a,onContinue:i,onBack:o}){const l=e>n,[c,u]=d.useState(!1),[f,p]=d.useState(0),[m,w]=d.useState(!1),x=d.useRef(null);d.useEffect(()=>{const b=e/60;let E=0;const j=setInterval(()=>{E+=b,E>=e?(p(e),clearInterval(j),l&&(u(!0),setTimeout(()=>u(!1),5e3))):p(Math.floor(E))},2e3/60);return setTimeout(()=>w(!0),2200),()=>clearInterval(j)},[e,l]),d.useEffect(()=>(document.body.classList.add("hide-bottom-nav"),()=>{document.body.classList.remove("hide-bottom-nav")}),[]);const C=(()=>t>=100?{emoji:"👑",title:"LEGENDARY!",subtitle:"You're a true Quiz Legend!",color:"from-purple-400 to-pink-500",stars:5}:t>=50?{emoji:"🏆",title:"CHAMPION!",subtitle:"Outstanding performance!",color:"from-yellow-400 to-amber-500",stars:5}:t>=30?{emoji:"💎",title:"EXPERT!",subtitle:"You're getting really good!",color:"from-blue-400 to-cyan-500",stars:4}:t>=20?{emoji:"⭐",title:"STAR PLAYER!",subtitle:"Keep up the great work!",color:"from-green-400 to-emerald-500",stars:3}:t>=10?{emoji:"🎯",title:"NICE TRY!",subtitle:"You're improving fast!",color:"from-orange-400 to-red-500",stars:2}:{emoji:"🌟",title:"GOOD START!",subtitle:"Every expert was once a beginner!",color:"from-indigo-400 to-purple-500",stars:1})();return r.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white relative overflow-hidden",children:[r.jsx("style",{jsx:!0,children:`
        @keyframes slideUp {
          from { transform: translateY(100px); opacity: 0; }
          to { transform: translateY(0); opacity: 1; }
        }
      ...
      `}),r.jsx("div",{className:"absolute inset-0 pointer-events-none",children:e.visualElements.bgEmojis.map((H,Y)=>r.jsx("div",{className:"absolute text-7xl opacity-10 float-animation",style:{top:`${20+Y*15}%`,left:`${10+Y*18}%`,animationDelay:`${Y*.5}s`,animationDuration:`${3+Y}s`},children:H},Y))}),r.jsxs("div",{className:"relative z-10 px-3 pt-[calc(env(safe-area-inset-top)+4rem)]",children:[r.jsxs("div",{className:"flex justify-between items-center mb-3",children:[r.jsx("button",{onClick:()=>S(!0),className:"w-10 h-10 glass-card rounded-xl shadow-lg flex items-center justify-center hover:scale-105 transition-transform",children:r.jsx("span",{className:"text-xl",children:"⬅️"})}),r.jsx("div",{className:"glass-card rounded-xl px-3 py-1.5 shadow-lg",children:r.jsxs("div",{className:"flex items-center gap-1.5",children:[r.jsx("span",{className:"text-xl",children:e.emoji}),r.jsx("span",{className:"text-gray-800 font-bold text-sm",children:e.name})]})}),r.jsx("button",{onClick:()=>p(!f),className:"w-10 h-10 glass-card rounded-xl shadow-lg flex items-center justify-center hover:scale-105 transition-transform",children:r.jsx("span",{className:"text-xl",children:f?"🔊":"🔇"})})]}),r.jsxs("div",{className:"glass-card rounded-xl p-3 shadow-xl mb-3",children:[r.jsxs("div",{className:"grid grid-cols-4 gap-2",children:[r.jsxs("div",{className:"text-center",children:[r.jsx("div",{className:`text-xl font-black ${Z==="critical"?"text-red-600 time-pulse-critical":Z==="warning"?"text-orange-600":"text-gray-800"}`,children:R(i)}),r.jsx("div",{className:"text-[10px] text-gray-700 font-medium",children:"Time"})]}),r.jsxs("div",{className:"text-center",children:[r.jsxs("div",{className:"text-xl font-black text-gray-800",children:[n,"/",s]}),r.jsx("div",{className:"text-[10px] text-gray-700 font-medium",children:"Question"})]}),r.jsxs("div",{className:"text-center relative",children:[r.jsx("div",{className:"text-xl font-black text-orange-600",children:o}),r.jsx("div",{className:"text-[10px] text-gray-700 font-medium",children:"Coins"}),x&&C&&r.jsx("div",{className:"absolute -top-3 left-1/2 -translate-x-1/2",children:r.jsxs("span",{className:"text-orange-600 font-bold text-xs coin-float",children:["+",e.rewards.perCorrectAnswer]})})]}),r.jsxs("div",{className:"text-center relative",children:[r.jsx("div",{className:"text-xl font-black text-blue-600",children:l}),r.jsx("div",{className:"text-[10px] text-gray-700 font-medium",children:"Gems"}),E&&r.jsx("div",{className:"absolute -top-3 left-1/2 -translate-x-1/2",children:r.jsx("span",{className:"text-blue-600 text-xl gem-sparkle",children:"💎"})})]})]}),r.jsx("div",{className:"mt-2",children:r.jsx("div",{className:"w-full h-1.5 bg-gray-800/20 rounded-full overflow-hidden",children:r.jsx("div",{className:"h-full bg-gradient-to-r from-green-500 to-emerald-600 progress-bar",style:{width:`${(n-1)/s*100}%`}})})})]}),r.jsx("div",{className:"flex justify-center mb-3 pt-2",children:r.jsx(Ag,{shovelsRemaining:a,showBreak:x&&!C})})]}),r.jsxs("div",{className:"px-3 pt-8 slide-in",children:[r.jsxs("div",{ref:N,className:`glass-card rounded-2xl shadow-xl p-4 mb-4 ${x&&!C?"wrong-shake":""}`,children:[r.jsx("div",{className:"text-center mb-2",children:r.jsxs("span",{className:"text-xs font-bold text-gray-600 uppercase tracking-wider",children:["Question ",n]})}),r.jsx("h2",{className:"text-lg font-bold text-center text-gray-800 leading-relaxed",children:t.prompt})]}),r.jsx("div",{className:"space-y-2.5",children:t.options.map((H,Y)=>{const $=["A","B","C","D"],P=m===Y,_=Y===t.correctIndex;let F="glass-card option-card",L="border border-gray-800/20";return x&&(_?(F+=" correct-pulse",L="border-2 border-green-500 bg-green-400/20"):P&&!C&&(F+=" wrong-shake",L="border-2 border-red-500 bg-red-400/20"),F+=" disabled"),r.jsx("button",{onClick:()=>q(Y),disabled:g,className:`w-full p-3 rounded-xl shadow-lg ${F} ${L}`,children:r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsx("div",{className:`w-10 h-10 rounded-lg bg-gradient-to-br ${Y===0?"from-blue-400 to-blue-500":Y===1?"from-green-400 to-green-500":Y===2?"from-yellow-400 to-yellow-500":"from-purple-400 to-purple-500"} text-white font-bold text-lg flex items-center justify-center shadow-md`,children:$[Y]}),r.jsx("span",{className:"flex-1 text-left font-medium text-gray-800 text-sm",children:H}),x&&_&&r.jsx("span",{className:"text-2xl",children:"✅"}),x&&P&&!C&&r.jsx("span",{className:"text-2xl",children:"❌"})]})},Y)})}),x&&r.jsx("div",{className:"mt-3 text-center slide-in",children:r.jsx("p",{className:"text-base font-bold text-gray-800",children:C?`Great job! Let's dig for treasure! ${e.visualElements.diggingEmoji}`:"Oops! Your shovel broke! Try the next question! 💪"})})]}),h&&r.jsx(Ig,{island:e,foundGem:E,onComplete:()=>b(!1)}),T&&r.jsx("div",{className:"fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 px-6",children:r.jsxs("div",{className:"bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-6 max-w-sm w-full shadow-2xl slide-in border border-white/10",children:[r.jsxs("div",{className:"text-center mb-6",children:[r.jsx("div",{className:"text-5xl mb-3",children:"🗺️"}),r.jsx("h3",{className:"text-xl font-bold text-white mb-2",children:"Leave the Island?"}),r.jsx("p",{className:"text-white/70",children:"Your progress won't be saved!"})]}),r.jsxs("div",{className:"flex gap-3",children:[r.jsx("button",{onClick:()=>S(!1),className:"flex-1 py-3 bg-gradient-to-r from-green-400 to-emerald-500 text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all hover:scale-[1.02]",children:"Keep Playing"}),r.jsx("button",{onClick:u,className:"flex-1 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all hover:scale-[1.02]",children:"Leave Island"})]})]})})]})}function Mg({island:e,session:t,earnedTreasure:n,onRetry:s,onContinue:a,soundOn:i}){const[o,l]=d.useState(0),[c,u]=d.useState(!1),[f,p]=d.useState(!1),m=t.correctAnswers===ze.QUESTIONS_PER_ISLAND,w=Rg(t.correctAnswers,e.id);return d.useEffect(()=>{const x=t.coinsEarned,k=2e3,C=30,v=x/C;let h=0;const b=setInterval(()=>{h+=v,h>=x?(l(x),clearInterval(b),n&&setTimeout(()=>u(!0),500),setTimeout(()=>p(!0),n?1500:500)):l(Math.floor(h))},k/C);return()=>clearInterval(b)},[t.coinsEarned,n]),r.jsxs("div",{className:`fixed inset-0 bg-gradient-to-br ${e.theme.background} overflow-hidden flex flex-col`,children:[r.jsx("style",{jsx:!0,children:`
        @keyframes slideUp {
          from { transform: translateY(100px); opacity: 0; }
          to { transform: translateY(0); opacity: 1; }
        }
      ...
      `}),p&&r.jsx("div",{className:"fixed inset-0 pointer-events-none",children:[...Array(15)].map((w,x)=>r.jsx("div",{className:"absolute firework",style:{left:`${20+Math.random()*60}%`,top:`${20+Math.random()*60}%`,animationDelay:`${Math.random()*2}s`,fontSize:`${40+Math.random()*40}px`},children:["✨","⭐","💫","🌟"][Math.floor(Math.random()*4)]},x))}),r.jsx("div",{className:"fixed inset-0 pointer-events-none",children:[...Array(20)].map((w,x)=>r.jsx("div",{className:"absolute coin-rain",style:{left:`${Math.random()*100}%`,animationDelay:`${Math.random()*3}s`,animationDuration:`${3+Math.random()*2}s`,fontSize:`${20+Math.random()*20}px`},children:["🪙","💰","💎"][Math.floor(Math.random()*3)]},x))}),r.jsxs("div",{className:"relative z-10 flex flex-col items-center justify-center min-h-screen px-6",children:[r.jsxs("div",{className:"text-center mb-8",children:[r.jsx("h1",{className:"text-6xl font-black text-white mb-4",children:"LEGENDARY!"}),r.jsx("div",{className:"text-8xl bounce-animation",children:"👑"})]}),s&&r.jsxs("div",{className:`relative mb-8 ${s?"chest-appear":""}`,children:[r.jsx("div",{className:`text-[150px] ${i?"chest-open":""}`,children:"📦"}),i&&r.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:rr.map((w,x)=>r.jsx("div",{className:"absolute text-6xl float-animation treasure-glow",style:{transform:`rotate(${x*72}deg) translateY(-100px)`,animationDelay:`${x*.2}s`},children:w.rewards.treasurePiece},w.id))})]}),l&&r.jsxs("div",{className:"glass-card rounded-3xl p-6 max-w-md w-full mb-6",children:[r.jsx("h2",{className:"text-2xl font-black text-white text-center mb-6",children:"🏆 FINAL TREASURE UNLOCKED! 🏆"}),r.jsx("div",{className:"bg-gradient-to-r from-yellow-400 to-amber-500 rounded-2xl p-4 mb-4",children:r.jsxs("div",{className:"text-center",children:[r.jsx("div",{className:"text-5xl mb-2",children:"💰"}),r.jsx("div",{className:"text-4xl font-black text-white",children:ze.FINAL_TREASURE_REWARD}),r.jsx("div",{className:"text-white/90 font-medium",children:"Bonus Coins!"})]})}),r.jsxs("div",{className:"grid grid-cols-2 gap-3 mb-4",children:[r.jsxs("div",{className:"glass-card rounded-xl p-3 text-center",children:[r.jsx("div",{className:"text-3xl mb-1",children:"🏝️"}),r.jsx("div",{className:"text-2xl font-black text-white",children:"5/5"}),r.jsx("div",{className:"text-white/70 text-xs",children:"Islands"})]}),r.jsxs("div",{className:"glass-card rounded-xl p-3 text-center",children:[r.jsx("div",{className:"text-3xl mb-1",children:"🧩"}),r.jsx("div",{className:"text-2xl font-black text-white",children:"5/5"}),r.jsx("div",{className:"text-white/70 text-xs",children:"Treasures"})]}),r.jsxs("div",{className:"glass-card rounded-xl p-3 text-center",children:[r.jsx("div",{className:"text-3xl mb-1",children:"💰"}),r.jsx("div",{className:"text-2xl font-black text-yellow-300",children:e.totalCoinsEarned+ze.FINAL_TREASURE_REWARD}),r.jsx("div",{className:"text-white/70 text-xs",children:"Total Coins"})]}),r.jsxs("div",{className:"glass-card rounded-xl p-3 text-center",children:[r.jsx("div",{className:"text-3xl mb-1",children:"💎"}),r.jsx("div",{className:"text-2xl font-black text-cyan-300",children:e.totalGemsFound}),r.jsx("div",{className:"text-white/70 text-xs",children:"Total Gems"})]})]}),u&&r.jsxs("div",{className:"text-center p-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl",children:[r.jsx("div",{className:"text-3xl mb-2",children:"🏆"}),r.jsx("div",{className:"text-xl font-black text-white title-shine",children:ze.FINAL_TREASURE_TITLE}),r.jsx("div",{className:"text-white/90 text-sm mt-1",children:"New Title Unlocked!"})]})]}),l&&r.jsx("button",{onClick:t,className:"w-full max-w-md py-4 bg-gradient-to-r from-white to-gray-100 text-gray-800 rounded-2xl font-black text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] active:scale-[0.98]",children:r.jsxs("div",{className:"flex items-center justify-center gap-3",children:[r.jsx("span",{className:"text-2xl",children:"🎉"}),r.jsx("span",{children:"Complete Adventure"}),r.jsx("span",{className:"text-2xl",children:"🎉"})]})}),r.jsx("div",{className:"absolute inset-0 pointer-events-none",children:[...Array(10)].map((w,x)=>r.jsx("div",{className:"absolute text-2xl sparkle-animation",style:{left:`${Math.random()*100}%`,top:`${Math.random()*100}%`,animationDelay:`${Math.random()*2}s`},children:"✨"},x))})]})]})}function Fg({onBack:e}){const{coins:t,xp:n,level:s,soundOn:a,addCoins:i,addXp:o,setSoundOn:l}=lc(),[c,u]=d.useState("map"),[f,p]=d.useState(null),[m,w]=d.useState([]),[x,k]=d.useState(()=>{const P=localStorage.getItem(ze.STORAGE_KEYS.PROGRESS);if(P)try{return JSON.parse(P)}catch(_){console.error("Failed to load progress:",_)}return rr.reduce((_,F)=>(_[F.id]={unlocked:F.id===1,completed:!1,treasurePiece:!1,perfectScore:!1,bestScore:0,attempts:0},_),{})}),[C,v]=d.useState({islandId:null,questions:[],currentQuestionIndex:0,shovelsRemaining:ze.SHOVELS_PER_ISLAND,correctAnswers:0,wrongAnswers:0,timeRemaining:300,gemsFound:0,coinsEarned:0,questionTimes:[],startTime:null}),[h,b]=d.useState(()=>{const P=localStorage.getItem(ze.STORAGE_KEYS.STATS);if(P)try{return JSON.parse(P)}catch(_){console.error("Failed to load stats:",_)}return{totalCoinsEarned:0,totalGemsFound:0,totalTreasurePieces:0,totalQuestionsAnswered:0,totalCorrectAnswers:0,islandsCompleted:0,gameCompleted:!1}}),E=d.useRef(null),j=d.useRef(null);d.useEffect(()=>(T(),()=>{E.current&&clearInterval(E.current)}),[]),d.useEffect(()=>{localStorage.setItem(ze.STORAGE_KEYS.PROGRESS,JSON.stringify(x))},[x]),d.useEffect(()=>{localStorage.setItem(ze.STORAGE_KEYS.STATS,JSON.stringify(h))},[h]),d.useEffect(()=>(c==="playing"&&C.timeRemaining>0?E.current=setInterval(()=>{v(P=>{const _=P.timeRemaining-1;return _<=0?(R(),{...P,timeRemaining:0}):(_===30&&a&&Y(ze.SOUNDS.TICK,.6),{...P,timeRemaining:_})})},1e3):E.current&&clearInterval(E.current),()=>{E.current&&clearInterval(E.current)}),[c,C.timeRemaining,a]);const T=async()=>{try{const _=await(await fetch("/data/quiz_questions_bank.csv")).text(),{data:F}=hr.parse(_,{header:!0,skipEmptyLines:!0,transformHeader:D=>D.trim().toLowerCase()}),L=F.map((D,A)=>{var Q;const X=[D.option1,D.option2,D.option3,D.option4].map(M=>(M||"").trim()).filter(Boolean);if(X.length<4)return null;let re={a:0,b:1,c:2,d:3}[(Q=D.answer)==null?void 0:Q.toLowerCase()];return re===void 0&&(re=X.findIndex(M=>M.toLowerCase()===(D.answer||"").toLowerCase())),re===-1&&(re=0),{id:D.id||`q_${A}`,prompt:(D.question||"").trim(),options:X,correctIndex:re,category:(D.category||D.subject||"general").trim(),difficulty:(D.difficulty||"medium").toLowerCase()}}).filter(Boolean);w(L)}catch(P){console.error("Failed to load questions:",P)}},S=P=>{const _=cn(P);if(!_||m.length===0)return[];let F=m.filter(D=>_.questionDifficulty.includes(D.difficulty));return F.length<ze.QUESTIONS_PER_ISLAND&&(F=m),[...F].sort(()=>Math.random()-.5).slice(0,ze.QUESTIONS_PER_ISLAND)},g=P=>{if(!Pg(P,x)){a&&Y("/sounds/locked.mp3",.5),$([100]);return}p(P),u("island-detail"),a&&Y("/sounds/select.mp3",.5)},y=P=>{const _=cn(P),F=S(P);v({islandId:P,questions:F,currentQuestionIndex:0,shovelsRemaining:ze.SHOVELS_PER_ISLAND,correctAnswers:0,wrongAnswers:0,timeRemaining:_.timeLimit,gemsFound:0,coinsEarned:0,questionTimes:[],startTime:Date.now()}),j.current=Date.now(),u("playing"),a&&Y("/sounds/start.mp3",.6)},N=P=>{const _=C.questions[C.currentQuestionIndex],F=P===_.correctIndex,L=(Date.now()-j.current)/1e3;v(D=>{const A={...D,questionTimes:[...D.questionTimes,L]};if(F){const X=cn(D.islandId);let ne=X.rewards.perCorrectAnswer;L<ze.SPEED_BONUS_THRESHOLD&&(ne+=X.rewards.speedBonus),Math.random()<X.rewards.gemChance&&(ne+=X.rewards.gemBonus,A.gemsFound=D.gemsFound+1),A.correctAnswers=D.correctAnswers+1,A.coinsEarned=D.coinsEarned+ne}else A.wrongAnswers=D.wrongAnswers+1,A.shovelsRemaining=D.shovelsRemaining-1,$([200]);return A}),setTimeout(()=>{const D=C.currentQuestionIndex+1;C.shovelsRemaining===0&&!F||D>=ze.QUESTIONS_PER_ISLAND?I():(v(A=>({...A,currentQuestionIndex:D})),j.current=Date.now())},F?2e3:1500)},R=()=>{I()},I=()=>{const P=cn(C.islandId),_=C.correctAnswers>=P.requiredCorrect,F=C.correctAnswers===ze.QUESTIONS_PER_ISLAND;let L=C.coinsEarned;F&&(L+=P.rewards.perfectBonus),_&&(L+=P.rewards.completionCoins),k(A=>{const X={...A},ne=X[C.islandId];if(ne.completed=!0,ne.attempts+=1,_&&!ne.treasurePiece){ne.treasurePiece=!0;const re=rr.find(Q=>Q.id===C.islandId+1);re&&X[re.id]&&(X[re.id].unlocked=!0,a&&setTimeout(()=>Y(ze.SOUNDS.ISLAND_UNLOCK,.7),2e3))}return F&&(ne.perfectScore=!0),ne.bestScore=Math.max(ne.bestScore||0,C.correctAnswers),X}),b(A=>({...A,totalCoinsEarned:A.totalCoinsEarned+L,totalGemsFound:A.totalGemsFound+C.gemsFound,totalTreasurePieces:A.totalTreasurePieces+(_&&!x[C.islandId].treasurePiece?1:0),totalQuestionsAnswered:A.totalQuestionsAnswered+(C.correctAnswers+C.wrongAnswers),totalCorrectAnswers:A.totalCorrectAnswers+C.correctAnswers,islandsCompleted:A.islandsCompleted+(x[C.islandId].completed?0:1)})),i(L),o(C.correctAnswers),v(A=>({...A,coinsEarned:L})),a&&Y(_?ze.SOUNDS.TREASURE_FOUND:ze.SOUNDS.ISLAND_COMPLETE,.7),rr.every(A=>{var X;return((X=x[A.id])==null?void 0:X.treasurePiece)===!0})&&!h.gameCompleted?(b(A=>({...A,gameCompleted:!0})),setTimeout(()=>{u("final-treasure"),a&&Y(ze.SOUNDS.FINAL_TREASURE,.8)},3e3)):u("reward")},q=()=>{y(C.islandId)},Z=()=>{u("map"),p(null)},H=()=>{i(ze.FINAL_TREASURE_REWARD),o(10),b(P=>({...P,totalCoinsEarned:P.totalCoinsEarned+ze.FINAL_TREASURE_REWARD})),u("map")},Y=(P,_=.5)=>{try{const F=new Audio(P);F.volume=_,F.play()}catch(F){console.error("Failed to play sound:",F)}},$=P=>{navigator.vibrate&&navigator.vibrate(P)};switch(d.useEffect(()=>(document.body.classList.add("hide-bottom-nav"),()=>{document.body.classList.remove("hide-bottom-nav")}),[]),c){case"map":return r.jsx(_g,{islands:rr,islandProgress:x,onSelectIsland:g,onBack:e,soundOn:a,setSoundOn:l,totalStats:h});case"island-detail":return r.jsx(Lg,{island:cn(f),progress:x[f],onStart:()=>y(f),onClose:()=>u("map"),soundOn:a});case"playing":return r.jsx(Dg,{island:cn(C.islandId),question:C.questions[C.currentQuestionIndex],questionNumber:C.currentQuestionIndex+1,totalQuestions:ze.QUESTIONS_PER_ISLAND,shovelsRemaining:C.shovelsRemaining,timeRemaining:C.timeRemaining,coinsEarned:C.coinsEarned,gemsFound:C.gemsFound,onAnswer:N,onQuit:()=>u("map"),soundOn:a,setSoundOn:l});case"reward":return r.jsx(Mg,{island:cn(C.islandId),session:C,earnedTreasure:C.correctAnswers>=cn(C.islandId).requiredCorrect,onRetry:q,onContinue:Z,soundOn:a});case"final-treasure":return r.jsx(zg,{totalStats:h,onContinue:H,soundOn:a});default:return null}}const Og=[{name:"General Knowledge",questions:50,icon:"🧠",color:"#7C3AED"},{name:"Artificial Intelligence",questions:28,icon:"🤖",color:"#10B981"},{name:"Fun facts",questions:30,icon:"🎉",color:"#EF4444"},{name:"Science",questions:45,icon:"🧪",color:"#F59E0B"},{name:"History",questions:42,icon:"🏺",color:"#2563EB"},{name:"Geography",questions:38,icon:"🗺️",color:"#FACC15"}],Lm=Og.slice(0,6),no=360/Lm.length;function $g({onModeSelect:e,onNavigateHome:t}){return r.jsx("div",{className:"fixed inset-0 bg-base-bg text-base-text overflow-hidden",children:r.jsxs("div",{className:"h-full overflow-y-auto mx-auto max-w-md px-4 pt-[calc(env(safe-area-inset-top)+5rem)] pb-[calc(env(safe-area-inset-bottom)+5.25rem)]",children:[r.jsx("header",{className:"flex items-center mb-8",children:r.jsx("h1",{className:"text-center text-xl font-bold w-full",children:"Choose a quiz mode"})}),r.jsxs("div",{className:"space-y-8",children:[r.jsxs("button",{onClick:()=>e("classic"),className:"w-full relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-400 to-blue-500 p-8 text-left shadow-lg hover:shadow-xl transition-all active:scale-[0.98]",children:[r.jsx("div",{className:"absolute top-0 right-0 w-32 h-32 opacity-30",children:r.jsxs("svg",{viewBox:"0 0 100 100",className:"w-full h-full animate-spin",style:{animationDuration:"20s"},children:[Lm.map((n,s)=>{const a=s*no,i=a+no,o=no>180?1:0,l=Math.PI*a/180,c=Math.PI*i/180,u=50+40*Math.cos(l),f=50-40*Math.sin(l),p=50+40*Math.cos(c),m=50-40*Math.sin(c);return r.jsx("path",{d:`M50,50 L${u},${f} A40,40 0 ${o} 0 ${p},${m} Z`,fill:n.color,stroke:"white",strokeWidth:"0.5"},s)}),r.jsx("circle",{cx:"50",cy:"50",r:"8",fill:"white"})]})}),r.jsx("div",{className:"absolute top-4 left-8 text-3xl opacity-60",children:"🏆"}),r.jsx("div",{className:"absolute top-12 right-16 text-xl opacity-40",children:"⭐"}),r.jsx("div",{className:"absolute bottom-6 left-6 text-2xl opacity-50",children:"🎲"}),r.jsx("div",{className:"absolute bottom-4 right-12 text-3xl opacity-60",children:"🍪"}),r.jsx("div",{className:"absolute top-1/2 left-4 text-lg opacity-40",children:"🥨"}),r.jsx("h2",{className:"text-5xl font-black text-white mb-10 relative z-10",style:{transform:"translateX(-20px)"},children:"CLASSIC"})]}),r.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[r.jsxs("button",{onClick:()=>e("survival"),className:"aspect-square rounded-3xl bg-gradient-to-br from-yellow-400 to-orange-400 p-4 text-left hover:shadow-xl transition-all active:scale-[0.98] relative overflow-hidden",children:[r.jsx("div",{className:"text-2xl mb-2",children:"💀"}),r.jsx("h4",{className:"text-lg font-black text-white",children:"SURVIVAL"})]}),r.jsxs("button",{onClick:()=>e("treasureHunt"),className:"aspect-square rounded-3xl bg-gradient-to-br from-purple-400 to-green-500 p-4 text-left hover:shadow-xl transition-all active:scale-[0.98] relative overflow-hidden",children:[r.jsxs("div",{className:"absolute inset-0 opacity-20",children:[r.jsx("div",{className:"absolute top-2 right-2 text-4xl animate-pulse",children:"🏝️"}),r.jsx("div",{className:"absolute bottom-2 left-2 text-3xl animate-bounce",style:{animationDelay:"0.5s"},children:"⛏️"}),r.jsx("div",{className:"absolute top-1/2 right-4 text-2xl animate-pulse",style:{animationDelay:"1s"},children:"💎"})]}),r.jsx("div",{className:"text-2xl mb-2 relative z-10",children:"🏴‍☠️"}),r.jsx("h4",{className:"text-lg font-black text-white relative z-10",children:"TREASURE HUNT"}),r.jsx("div",{className:"absolute bottom-2 right-2",children:r.jsx("span",{className:"text-xs bg-white/20 px-2 py-1 rounded-full text-white font-bold",children:"NEW!"})})]}),r.jsxs("button",{disabled:!0,className:"aspect-square rounded-3xl bg-gradient-to-br from-pink-500 to-purple-500 p-4 text-left opacity-60",children:[r.jsx("div",{className:"text-2xl mb-2",children:"⚔️"}),r.jsx("h4",{className:"text-lg font-black text-white",children:"SURVIVAL ARENA"})]}),r.jsxs("button",{disabled:!0,className:"aspect-square rounded-3xl bg-gradient-to-br from-blue-400 to-cyan-400 p-4 text-left opacity-60",children:[r.jsx("div",{className:"text-2xl mb-2",children:"📱"}),r.jsx("h4",{className:"text-lg font-black text-white",children:"TRIVIA VIDEO"})]})]})]})]})})}function Bg(){const[e,t]=d.useState(null),n=He(),s=bt();d.useEffect(()=>{const l=new URLSearchParams(s.search);l.get("mode")==="survival"&&l.get("from")==="quest"&&t("survival")},[s]);const a=l=>{l==="classic"?t("classic"):l==="survival"?t("survival"):l==="treasureHunt"&&t("treasureHunt")},i=()=>{n("/")},o=()=>{t(null)};if(e==="classic")return r.jsx(Ng,{onBack:o});if(e==="survival"){const c=new URLSearchParams(s.search).get("from")==="quest";return r.jsx(Eg,{onBack:o,isFromQuest:c})}return e==="treasureHunt"?r.jsx(Fg,{onBack:o}):r.jsx($g,{onModeSelect:a,onNavigateHome:i})}const Ug=({session:e,mode:t,category:n,difficulty:s,timerConfig:a,onComplete:i,onQuit:o})=>{const l=He(),[c,u]=d.useState(0),[f,p]=d.useState([]),[m,w]=d.useState([]),[x,k]=d.useState([]),[C,v]=d.useState(!1),[h,b]=d.useState(null),[E,j]=d.useState(Date.now()),[T,S]=d.useState(0),[g,y]=d.useState([]),[N,R]=d.useState(!1),[I,q]=d.useState(!1),[Z,H]=d.useState({}),[Y,$]=d.useState({}),[P,_]=d.useState([]);d.useState(!0);const[F,L]=d.useState([]),[D,A]=d.useState(0),[X,ne]=d.useState(0),[re,Q]=d.useState(!1),[M,K]=d.useState(!1),[z,B]=d.useState(""),[ee,ae]=d.useState(!1),[ce,U]=d.useState(!1),[G,W]=d.useState(!0),[O,te]=d.useState(!1),[de,je]=d.useState(0),[Le,Be]=d.useState(0),[Ee,me]=d.useState(0),[he,be]=d.useState(null),[ke,Ue]=d.useState(0),qt=d.useRef(null),et=d.useRef(null),we=t==="practice",Ae=f[c],Qt=fe=>{try{const ue=new Audio(fe);ue.volume=.6,ue.play()}catch{console.log("Sound not available:",fe)}},Gn=[{id:1,category:"General Knowledge",difficulty:"medium",prompt:"Which element has the atomic number 1?",options:["Helium","Carbon","Hydrogen","Oxygen"],answerIndex:2,explanation:"Hydrogen is the first element on the periodic table with atomic number 1!"},{id:2,category:"General Knowledge",difficulty:"medium",prompt:"What is the largest ocean on Earth?",options:["Atlantic","Pacific","Indian","Arctic"],answerIndex:1,explanation:"The Pacific Ocean covers about one-third of Earth's surface!"},{id:3,category:"General Knowledge",difficulty:"easy",prompt:"What color do you get when you mix red and yellow?",options:["Purple","Orange","Green","Pink"],answerIndex:1,explanation:"Red and yellow make orange - like a beautiful sunset!"}],Ge=e&&e.questions&&Array.isArray(e.questions)&&e.questions.length>0?e.questions:Gn,J=Ge[c]||Ge[0]||Gn[0],le=Ge.length;d.useEffect(()=>{Ge.length>0&&(p(new Array(Ge.length).fill(null)),w(new Array(Ge.length).fill(!1)),_(new Array(Ge.length).fill(!1)),k(new Array(Ge.length).fill((a==null?void 0:a.seconds)||45)))},[Ge.length,a==null?void 0:a.seconds]);const _e=()=>{if(N){B("Once per quiz"),setTimeout(()=>B(""),1e3);return}if(Ae!==null){B("Already answered"),setTimeout(()=>B(""),1e3);return}if(!J)return;const ue=[0,1,2,3].filter(ge=>ge!==J.answerIndex).sort(()=>Math.random()-.5).slice(0,2);H({...Z,[c]:ue}),R(!0)},Se=()=>{if(I){B("Once per quiz"),setTimeout(()=>B(""),1e3);return}if(Ae!==null){B("Already answered"),setTimeout(()=>B(""),1e3);return}if(!J)return;const fe=J.answerIndex,ue=[0,0,0,0],ge=40+Math.floor(Math.random()*31);ue[fe]=ge;let tt=100-ge;const Re=[0,1,2,3].filter(Ce=>Ce!==fe);for(let Ce=0;Ce<Re.length-1;Ce++){const Ke=Math.min(tt-(Re.length-1-Ce),tt/2),ln=Math.floor(Math.random()*(Ke+1));ue[Re[Ce]]=ln,tt-=ln}ue[Re[Re.length-1]]=tt,$({...Y,[c]:ue}),q(!0)},Ve=()=>{const fe=new Date;return`${fe.getFullYear()}-${fe.getMonth()+1}-${fe.getDate()}`},ve=()=>{we&&window.location.search.includes("from=quest")?l("/profile/quests",{state:{questCompleted:!0,questType:"practiceQuestions"}}):o()},ie=d.useCallback((fe,ue)=>{if(!J||we&&P[c]||Z[c]&&Z[c].includes(fe))return;const ge=[...f];if(ge[c]=f[c]===fe?null:fe,p(ge),j(Date.now()),we&&!g.includes(c)&&ge[c]!==null){const Re=g.length+1;if(S(Re),y(Ce=>[...Ce,c]),window.location.search.includes("from=quest")){let Ce={};try{const ln=localStorage.getItem("questProgress");ln&&(Ce=JSON.parse(ln))}catch(ln){console.error("Error reading progress:",ln)}const Ke=Ce.practiceQuestions||0;Ce.practiceQuestions=Math.max(Ke,Re),Ce.date=`${new Date().getFullYear()}-${new Date().getMonth()+1}-${new Date().getDate()}`,localStorage.setItem("questProgress",JSON.stringify(Ce)),console.log("Saved practice progress:",Ce.practiceQuestions),window.dispatchEvent(new CustomEvent("questProgressUpdate",{detail:{practiceQuestions:Ce.practiceQuestions}}))}}ge[c]!==null&&(W(!1),clearInterval(et.current));const tt=ge[c]===J.answerIndex;if(tt){const Re=Ee+1;if(me(Re),A(Ce=>Ce+1),ne(0),we){je(Ke=>Ke+1);const Ce=10;Be(Ke=>Ke+Ce),Qt("/sounds/correct.mp3"),setTimeout(()=>Qt("/sounds/coin.mp3"),500),U(!0),setTimeout(()=>U(!1),2e3),be({type:"correct",stars:1,coins:10}),setTimeout(()=>be(null),2e3)}}else ge[c]!==null&&(me(0),A(0),ne(Re=>Re+1),we&&(c===0&&F.length,Qt("/sounds/wrong.mp3")));if(L(Re=>[...Re.slice(-2),tt]),ge[c]!==null&&m[c]){const Re=[...m];Re[c]=!1,w(Re)}we&&ge[c]!==null&&(ae(!0),_(Re=>{const Ce=[...Re];return Ce[c]=!0,Ce}),setTimeout(()=>{const Re=document.querySelector(".main-scrollable-container");if(Re){const Ce=Re.scrollHeight,Ke=Re.clientHeight;Ce>Ke&&Re.scrollTo({top:Ce-Ke,behavior:"smooth"})}},300)),!we&&ge[c]!==null&&(clearTimeout(qt.current),qt.current=setTimeout(()=>{c<le-1?pe():(Q(!0),v(!0))},5e3))},[J,we,P,c,f,m,le,Ee,Z,F,D,T,g]),oe=()=>{j(Date.now()),c>0&&(clearInterval(et.current),W(!1),u(fe=>fe-1),ae(!1),we&&f[c-1]!==null&&setTimeout(()=>ae(!0),100))},pe=()=>{if(j(Date.now()),clearInterval(et.current),Ae===null){const fe=[...m];fe[c]=!0,w(fe),me(0)}W(!1),ae(!1),c<le-1?(u(fe=>fe+1),we&&f[c+1]!==null?setTimeout(()=>ae(!0),100):setTimeout(()=>W(!0),100)):Q(!0)},Pe=()=>{j(Date.now());const fe=[...m];fe[c]=!0,w(fe),me(0),pe()},xe=()=>{const fe=Ge.reduce((ue,ge,tt)=>ue+(f[tt]===ge.answerIndex?1:0),0);if(we&&window.location.search.includes("from=quest")){const ue=f.filter(tt=>tt!==null).length,ge=JSON.parse(localStorage.getItem("questProgress")||"{}");ge.practiceQuestions=Math.min(ue,15),ge.date=Ve(),localStorage.setItem("questProgress",JSON.stringify(ge)),console.log("Final practice progress saved:",ge.practiceQuestions)}if(we)i&&i({questions:Ge,answers:f,skipped:m,correct:fe,total:le,mode:t,category:n,difficulty:s,earnedStars:de,earnedCoins:Le,finalStreak:Ee});else{const ue=fe*10;Ue(ue),te(!0),setTimeout(()=>{Qt("/sounds/coin.mp3"),U(!0),setTimeout(()=>U(!1),3e3)},1e3)}},Ie=()=>{i&&i({questions:Ge,answers:f,skipped:m,correct:Ge.reduce((fe,ue,ge)=>fe+(f[ge]===ue.answerIndex?1:0),0),total:le,mode:t,category:n,difficulty:s,earnedStars:0,earnedCoins:ke,finalStreak:Ee})};d.useEffect(()=>{if(!(C||h!==null||re||!G||f[c]!==null))return et.current=setInterval(()=>{k(fe=>{const ue=[...fe],ge=ue[c];return ge<=1?(clearInterval(et.current),c===le-1?(Date.now()-E>=5e3&&Q(!0),ue):(b(c),ue)):(ue[c]=ge-1,ue)})},1e3),()=>clearInterval(et.current)},[C,h,c,re,le,G,f,E]),d.useEffect(()=>{f[c]===null&&!re&&!h?W(!0):W(!1)},[c,f,re,h]);const it=fe=>{const ue=Math.floor(fe/60),ge=fe%60;return`${ue}:${ge.toString().padStart(2,"0")}`},Nn=(c+1)/Ge.length*100,At=f.filter(fe=>fe!==null).length,pr=m.filter(Boolean).length,Vn=x[c]||0,mc=Ge.reduce((fe,ue,ge)=>fe+(f[ge]===ue.answerIndex?1:0),0);return r.jsxs("div",{className:"h-dvh bg-gray-900 text-white relative flex flex-col",children:[he&&r.jsx("div",{className:"fixed inset-0 flex items-center justify-center z-50 pointer-events-none",children:r.jsxs("div",{className:"bg-gradient-to-r from-yellow-500 to-orange-500 text-white px-8 py-4 rounded-full text-xl font-bold animate-bounce shadow-2xl",children:["+",he.coins," Coins!"]})}),ce&&r.jsx("div",{className:"fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-40 pointer-events-none",children:[...Array(8)].map((fe,ue)=>r.jsx("div",{className:"absolute text-3xl animate-ping",style:{left:`${-30+Math.random()*60}px`,top:`${-30+Math.random()*60}px`,animationDelay:`${ue*150}ms`,animationDuration:"2s"},children:"🪙"},ue))}),r.jsxs("div",{className:`main-scrollable-container flex-1 flex flex-col ${we&&Ae!==null?"overflow-y-auto":"overflow-hidden"}`,children:[r.jsxs("div",{className:"bg-gray-900 flex-shrink-0",children:[r.jsxs("div",{className:"flex items-center justify-between px-4 py-2 border-b border-gray-800 shadow-lg",children:[r.jsxs("button",{onClick:()=>K(!0),className:"bg-gray-700 hover:bg-gray-600 px-3 py-1.5 rounded-full flex items-center gap-2 transition-colors text-sm",children:[r.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:r.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})}),r.jsx("span",{className:"font-medium",children:"Back"})]}),r.jsx("div",{className:"flex-1"}),r.jsxs("div",{className:"flex items-center gap-2",children:[we&&r.jsxs(r.Fragment,{children:[r.jsxs("div",{className:"bg-yellow-600/20 px-2 py-1 rounded-full flex items-center gap-1",children:[r.jsx("span",{className:"text-yellow-400 text-sm",children:"🪙"}),r.jsx("span",{className:"text-yellow-200 font-semibold text-sm",children:Le})]}),r.jsxs("div",{className:"bg-orange-600/20 px-2 py-1 rounded-full flex items-center gap-1",children:[r.jsx("span",{className:"text-orange-400 text-sm",children:"🔥"}),r.jsx("span",{className:"text-orange-200 font-semibold text-sm",children:Ee})]})]}),r.jsx("div",{className:`px-2 py-1 rounded-full font-mono font-semibold text-sm ${Vn<=10?"bg-red-600/20 text-red-400 animate-pulse":Vn<=30?"bg-yellow-600/20 text-yellow-400":"bg-green-600/20 text-green-400"}`,children:it(Vn)})]})]}),r.jsxs("div",{className:"px-4 pb-1 bg-gray-900",children:[r.jsxs("div",{className:"flex justify-between items-center mb-1",children:[r.jsxs("span",{className:"text-xs text-gray-400",children:["Question ",c+1," of ",le]}),r.jsxs("span",{className:"text-xs text-gray-400",children:[Math.round(Nn),"% Complete"]})]}),r.jsx("div",{className:"h-2 bg-gray-700 rounded-full overflow-hidden",children:r.jsx("div",{className:"h-full bg-gradient-to-r from-blue-500 to-purple-500 transition-all duration-500",style:{width:`${Nn}%`}})}),r.jsx("div",{className:"flex justify-center gap-1 mt-1",children:Array.from({length:le}).map((fe,ue)=>r.jsx("div",{className:`w-1.5 h-1.5 rounded-full transition-all ${ue===c?"bg-white scale-125":f[ue]!==null?"bg-green-500":m[ue]?"bg-yellow-500":"bg-gray-600"}`},ue))}),r.jsx("div",{className:"text-center mt-4",children:r.jsx("span",{className:"text-xs text-gray-500",children:J.category})})]})]}),r.jsx("div",{className:`px-4 flex flex-col ${we&&Ae!==null?"pb-36":"flex-1 justify-between pb-[180px]"}`,children:r.jsxs("div",{className:"flex-1 flex flex-col justify-center max-h-full",children:[r.jsxs("div",{className:"relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 rounded-3xl p-6 mb-6 flex-shrink-0 shadow-2xl shadow-blue-600/20 border border-blue-400/20",children:[r.jsx("div",{className:"absolute top-2 right-2 w-16 h-16 bg-white/10 rounded-full blur-xl"}),r.jsx("div",{className:"absolute bottom-2 left-2 w-12 h-12 bg-white/5 rounded-full blur-lg"}),r.jsxs("div",{className:"relative text-center",children:[r.jsxs("div",{className:"inline-block bg-white/10 px-3 py-1 rounded-full text-xs font-medium text-blue-100 mb-3",children:["Question ",c+1]}),r.jsx("h2",{className:"text-xl font-bold leading-relaxed text-white tracking-wide",children:J.prompt}),J.difficulty&&r.jsx("div",{className:"mt-3 inline-block",children:r.jsx("span",{className:`px-2 py-1 rounded-full text-xs font-semibold ${J.difficulty==="easy"?"bg-green-500/20 text-green-300":J.difficulty==="medium"?"bg-yellow-500/20 text-yellow-300":"bg-red-500/20 text-red-300"}`,children:J.difficulty.toUpperCase()})})]})]}),r.jsx("div",{className:"grid grid-cols-1 gap-3 mb-2 flex-shrink-0",children:J.options.map((fe,ue)=>{const ge=Ae===ue,tt=ue===J.answerIndex,Re=we&&Ae!==null&&ee,Ce=Z[c]&&Z[c].includes(ue);let Ke="p-4 rounded-xl transition-all duration-300 border-2 min-h-[64px] flex items-center ";Ce?Ke+="bg-gray-700/30 border-gray-600/30 text-gray-500/50 cursor-not-allowed":(Ke+="cursor-pointer ",Re?ge&&tt?Ke+="bg-green-600 border-green-500 text-white shadow-lg shadow-green-600/25":ge&&!tt?Ke+="bg-red-600 border-red-500 text-white shadow-lg shadow-red-600/25":!ge&&tt?Ke+="bg-green-600/20 border-green-500 text-green-300 animate-pulse":Ke+="bg-gray-700 border-gray-600 text-gray-400":ge?Ke+="bg-gray-600 border-gray-500 text-white":Ke+="bg-gray-800 border-gray-700 text-gray-200 hover:bg-gray-750 hover:border-gray-600");const ln=["🅰️","🅱️","🅲️","🅳️"];return r.jsx("button",{onClick:Fm=>ie(ue,Fm),disabled:we&&P[c],className:Ke,children:r.jsxs("div",{className:"flex items-center gap-2 w-full",children:[r.jsx("div",{className:"text-lg flex-shrink-0 mr-1",children:ln[ue]}),r.jsx("div",{className:"flex-1 text-left font-semibold text-base leading-relaxed",children:fe}),Y[c]&&Y[c][ue]>0&&!Ce&&r.jsxs("div",{className:"bg-purple-600/20 px-2 py-1 rounded-full text-xs text-purple-300",children:[Y[c][ue],"%"]}),Re&&ge&&tt&&!Ce&&r.jsx("div",{className:"text-lg animate-bounce",children:"🎉"}),Re&&ge&&!tt&&!Ce&&r.jsx("div",{className:"text-lg",children:"😔"}),Re&&!ge&&tt&&!Ce&&r.jsx("div",{className:"text-base animate-pulse",children:"✨"})]})},ue)})}),we&&ee&&Ae!==null&&r.jsx("div",{className:"bg-gray-800 rounded-xl p-4 mb-2 mt-4 border border-gray-700 flex-shrink-0",children:r.jsxs("div",{className:"flex gap-3",children:[r.jsx("div",{className:"text-lg flex-shrink-0",children:Ae===J.answerIndex?"🎊":"💡"}),r.jsxs("div",{className:"flex-1",children:[r.jsx("h4",{className:`font-semibold mb-3 text-sm ${Ae===J.answerIndex?"text-green-400":"text-blue-400"}`,children:Ae===J.answerIndex?"Perfect! Well done!":"Good try! Here's why:"}),J.explanation&&r.jsx("p",{className:"text-gray-300 text-sm leading-relaxed",children:J.explanation})]})]})})]})})]}),r.jsxs("div",{className:"fixed bottom-0 left-0 right-0 z-50",children:[r.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/95 to-gray-900/80 backdrop-blur-xl"}),r.jsxs("div",{className:"relative p-4 pb-8",children:[!we&&r.jsxs("div",{className:"flex justify-center gap-3 mb-4",children:[r.jsxs("button",{onClick:_e,disabled:Ae!==null,className:`${N?"bg-white/5 text-gray-500":"bg-gradient-to-r from-orange-500 to-orange-600"} 
                  disabled:bg-white/5 disabled:text-gray-500
                  px-4 py-2.5 rounded-2xl font-semibold transition-all transform active:scale-95
                  shadow-lg flex items-center gap-2 text-sm`,children:[r.jsx("span",{children:"⚡"}),"50:50"]}),r.jsxs("button",{onClick:Se,disabled:Ae!==null,className:`${I?"bg-white/5 text-gray-500":"bg-gradient-to-r from-purple-500 to-purple-600"} 
                  disabled:bg-white/5 disabled:text-gray-500
                  px-4 py-2.5 rounded-2xl font-semibold transition-all transform active:scale-95
                  shadow-lg flex items-center gap-2 text-sm`,children:[r.jsx("span",{children:"👥"}),"Ask Friends"]})]}),r.jsxs("div",{className:"flex gap-2 mb-3",children:[r.jsx("button",{onClick:oe,disabled:c===0,className:`flex-1 bg-white/10 backdrop-blur-md border border-white/20 
                disabled:opacity-30 disabled:cursor-not-allowed
                py-3.5 rounded-2xl font-semibold transition-all transform active:scale-95
                hover:bg-white/15 text-white shadow-xl`,children:"Previous"}),r.jsx("button",{onClick:Pe,disabled:Ae!==null,className:`flex-1 py-3.5 rounded-2xl font-semibold transition-all transform active:scale-95 shadow-xl ${Ae!==null?"bg-white/5 text-gray-500 cursor-not-allowed":"bg-gradient-to-r from-amber-500 to-yellow-500 text-white hover:from-amber-600 hover:to-yellow-600"}`,children:"Skip"}),r.jsx("button",{onClick:pe,className:`flex-1 bg-gradient-to-r from-blue-500 to-indigo-500 
                hover:from-blue-600 hover:to-indigo-600
                py-3.5 rounded-2xl font-semibold transition-all transform active:scale-95
                text-white shadow-xl`,children:c===le-1?"Finish":"Next"})]}),r.jsxs("button",{onClick:()=>Q(!0),className:`w-full bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500
              hover:from-emerald-600 hover:via-green-600 hover:to-teal-600
              py-4 rounded-2xl font-bold text-white transition-all transform active:scale-[0.98]
              shadow-2xl shadow-green-500/25 relative overflow-hidden group`,children:[r.jsx("div",{className:"absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 bg-gradient-to-r from-transparent via-white/20 to-transparent"}),r.jsx("span",{className:"relative",children:"Submit Quiz"})]})]})]}),O&&r.jsx("div",{className:"fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4",children:r.jsxs("div",{className:"bg-gray-800 rounded-3xl p-6 max-w-sm w-full text-center border border-gray-700",children:[r.jsx("div",{className:"text-4xl mb-4",children:"🎉"}),r.jsx("h3",{className:"text-xl font-bold mb-2",children:"Quiz Complete!"}),r.jsx("p",{className:"text-gray-400 mb-6",children:"Here's how you performed"}),r.jsxs("div",{className:"bg-gray-700/50 rounded-2xl p-4 mb-6 space-y-3",children:[r.jsxs("div",{className:"flex justify-between items-center",children:[r.jsx("span",{className:"text-gray-300",children:"Questions Attempted:"}),r.jsxs("span",{className:"text-white font-semibold",children:[At," / ",le]})]}),r.jsxs("div",{className:"flex justify-between items-center",children:[r.jsx("span",{className:"text-gray-300",children:"Correct Answers:"}),r.jsx("span",{className:"text-green-400 font-semibold",children:mc})]}),r.jsxs("div",{className:"flex justify-between items-center",children:[r.jsx("span",{className:"text-gray-300",children:"Accuracy:"}),r.jsxs("span",{className:"text-blue-400 font-semibold",children:[At>0?Math.round(mc/At*100):0,"%"]})]}),r.jsx("div",{className:"border-t border-gray-600 pt-3 mt-3",children:r.jsxs("div",{className:"flex justify-between items-center",children:[r.jsx("span",{className:"text-yellow-300 flex items-center gap-1",children:"🪙 Coins Earned:"}),r.jsx("span",{className:"text-yellow-400 font-bold text-lg",children:ke})]})})]}),r.jsx("button",{onClick:Ie,className:"w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 py-3 rounded-xl font-medium transition-colors",children:"Continue"})]})}),M&&r.jsx("div",{className:"fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4",children:r.jsxs("div",{className:"bg-gray-800 rounded-3xl p-6 max-w-sm w-full text-center border border-gray-700",children:[r.jsx("div",{className:"text-4xl mb-4",children:"🤔"}),r.jsx("h3",{className:"text-xl font-bold mb-2",children:"Leave Quiz?"}),r.jsx("p",{className:"text-gray-400 mb-6",children:"Your progress will be lost"}),r.jsxs("div",{className:"flex gap-3",children:[r.jsx("button",{onClick:()=>K(!1),className:"flex-1 bg-blue-600 hover:bg-blue-700 py-3 rounded-xl font-medium",children:"Stay"}),r.jsx("button",{onClick:ve,className:"flex-1 bg-gray-700 hover:bg-gray-600 py-3 rounded-xl font-medium",children:"Leave"})]})]})}),re&&!O&&r.jsx("div",{className:"fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4",children:r.jsxs("div",{className:"bg-gray-800 rounded-3xl p-6 max-w-sm w-full text-center border border-gray-700",children:[r.jsx("div",{className:"text-4xl mb-4",children:"🏆"}),r.jsx("h3",{className:"text-xl font-bold mb-2",children:"Ready to finish?"}),r.jsxs("p",{className:"text-gray-400 mb-4",children:[At," of ",le," answered • ",pr," skipped"]}),we&&r.jsx("div",{className:"bg-gradient-to-r from-yellow-600/20 to-orange-600/20 p-4 rounded-2xl mb-6 border border-yellow-600/30",children:r.jsxs("div",{className:"flex justify-center gap-6",children:[r.jsxs("div",{className:"text-center",children:[r.jsx("div",{className:"text-2xl mb-1",children:"⭐"}),r.jsx("div",{className:"text-yellow-400 font-bold",children:de}),r.jsx("div",{className:"text-xs text-gray-400",children:"Stars"})]}),r.jsxs("div",{className:"text-center",children:[r.jsx("div",{className:"text-2xl mb-1",children:"🪙"}),r.jsx("div",{className:"text-yellow-400 font-bold",children:Le}),r.jsx("div",{className:"text-xs text-gray-400",children:"Coins"})]})]})}),r.jsxs("div",{className:"flex gap-3",children:[r.jsx("button",{onClick:()=>{Q(!1),b(null),j(Date.now())},className:"flex-1 bg-gray-700 hover:bg-gray-600 py-3 rounded-xl font-medium",children:"Back"}),r.jsx("button",{onClick:fe=>{fe.preventDefault(),fe.stopPropagation(),console.log("Submit button clicked"),xe()},className:"flex-1 bg-green-600 hover:bg-green-700 py-3 rounded-xl font-medium",children:"Submit"})]})]})}),h===c&&!re&&r.jsx("div",{className:"fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4",children:r.jsxs("div",{className:"bg-gray-800 rounded-3xl p-6 max-w-sm w-full text-center border border-gray-700",children:[r.jsx("div",{className:"text-4xl mb-4 animate-pulse",children:"⏰"}),r.jsx("h3",{className:"text-xl font-bold mb-2",children:"Time's Up!"}),r.jsx("p",{className:"text-gray-400 mb-6",children:"Let's move to the next question"}),r.jsx("button",{onClick:()=>{b(null),j(Date.now()),c<Ge.length-1?pe():Q(!0)},className:"w-full bg-blue-600 hover:bg-blue-700 py-3 rounded-xl font-medium",children:c<Ge.length-1?"Continue":"See Results"})]})}),z&&r.jsx("div",{className:"fixed top-20 left-1/2 transform -translate-x-1/2 bg-red-600 text-white px-4 py-2 rounded-full font-medium animate-bounce z-50",children:z}),r.jsx("style",{jsx:!0,children:`
        @keyframes fadeInOut {
          0% {
            opacity: 0;
      ...
      `})]})},as=[{name:"GK",slug:"general-knowledge",questions:50,icon:"🧠",color:"#FF6B6B",gradient:"from-red-500 to-pink-500"},{name:"Science",slug:"science",questions:45,icon:"🧪",color:"#4ECDC4",gradient:"from-cyan-500 to-teal-500"},{name:"Fun Facts",slug:"fun-facts",questions:30,icon:"🎉",color:"#FFD93D",gradient:"from-yellow-400 to-orange-500"},{name:"History",slug:"history",questions:42,icon:"🏺",color:"#A8E6CF",gradient:"from-green-400 to-emerald-500"},{name:"AI & Tech",slug:"artificial-intelligence",questions:28,icon:"🤖",color:"#C7B8FF",gradient:"from-purple-400 to-indigo-500"},{name:"Geography",slug:"geography",questions:38,icon:"🗺️",color:"#FACC15",gradient:"from-yellow-400 to-amber-500"},{name:"Computer",slug:"computer",questions:34,icon:"💻",color:"#3B82F6",gradient:"from-blue-400 to-blue-600"},{name:"Aptitude",slug:"aptitude",questions:36,icon:"📐",color:"#EC4899",gradient:"from-pink-500 to-rose-500"},{name:"Iconic Figures",slug:"iconic-figures",questions:26,icon:"🌟",color:"#8B5CF6",gradient:"from-purple-500 to-violet-600"}],qg=()=>r.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:r.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})}),Qg=()=>r.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:r.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"})}),Yg=()=>r.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:r.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"})}),Hg=()=>r.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:r.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"})}),Wg=()=>r.jsx("svg",{className:"w-3 h-3",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:r.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M13 10V3L4 14h7v7l9-11h-7z"})}),Gg=({results:e={correct:8,total:10,category:"general-knowledge",mode:"quiz",elapsedMs:125e3,questions:[],returnPath:null,fromQuest:!1},onRetake:t=()=>{},onReview:n=()=>{},onNavigate:s=(u,f)=>{},isRetake:a=!1,isPractice:i=!1,player:o={level:1,coins:0,combo:0,energy:5},categories:l=[],addCoins:c=()=>{}})=>{const[u,f]=d.useState(o.coins),p=d.useRef(null),[m,w]=d.useState(null),[x]=zt("/sounds/coin.mp3",{volume:.75}),[k,C]=d.useState(!1),[v,h]=d.useState(!1),[b,E]=d.useState(0),[j,T]=d.useState(!1),[S,g]=d.useState(!1),y=()=>{if(console.log("QuizResults handleBack:",{fromQuest:e.fromQuest,returnPath:e.returnPath,isPractice:e.isPractice||i}),e.fromQuest){const z=e.isPractice||i?"practiceQuestions":"dailyQuizzes";e.isPractice||i?s("/profile/quests"):s("/profile/quests",{state:{questCompleted:!0,questType:z,increment:1}})}else{const z=e.returnPath||"/";s(z)}},{correct:N,total:R,category:I,categorySlug:q,difficulty:Z,mode:H,elapsedMs:Y}=e,$=R?Math.round(N/R*100):0,P=$===100,_=$>=80,F=Math.floor(Y/1e3),L=R>0?Math.floor(F/R):0,D=i?e.earnedCoins||0:Math.round(N*5*(P?1.5:_?1.2:1)),A=as.find(z=>z.slug===I)||as[0],ne=(()=>P?{emoji:"🏆",text:"Perfect!",color:"text-yellow-400"}:$>=90?{emoji:"🌟",text:"Excellent!",color:"text-purple-400"}:$>=80?{emoji:"✨",text:"Great job!",color:"text-blue-400"}:$>=70?{emoji:"👍",text:"Good effort!",color:"text-green-400"}:$>=60?{emoji:"💪",text:"Keep going!",color:"text-orange-400"}:{emoji:"📚",text:"Keep practicing!",color:"text-gray-400"})();d.useEffect(()=>{!m&&!k&&f(o.coins)},[o.coins,m,k]),d.useEffect(()=>{e.coinsProcessed||D>0&&p.current&&setTimeout(()=>{if(p.current.getBoundingClientRect(),x)try{x()}catch(z){console.error("Error playing coin sound:",z)}else console.warn("Coin sound not loaded");w({startRect:{left:window.innerWidth/2-50,top:window.innerHeight/2,width:100,height:100},count:Math.min(D,10),amount:D}),C(!0),e.coinsProcessed=!0},500)},[]),d.useEffect(()=>{document.documentElement.scrollIntoView({behavior:"smooth",block:"start"}),(P||_)&&(h(!0),setTimeout(()=>h(!1),3e3));let z=0;const B=N/20,ee=setInterval(()=>{z+=B,z>=N?(E(N),clearInterval(ee)):E(Math.floor(z))},50);return()=>clearInterval(ee)},[N,P,_]);const re=[{score:7,total:10},{score:6,total:10},{score:8,total:10},{score:9,total:10},{score:N,total:R}],Q=()=>{try{const z=localStorage.getItem("qp_recent");if(z)return JSON.parse(z).slice(0,10).map(ee=>ee.slug||ee.cat).filter(ee=>ee&&ee!==e.categorySlug)}catch(z){console.error("Error reading recent categories:",z)}return[]},M=()=>{const z=q||I,B=Z||"medium",ee=Q(),ae=(l||as||[]).filter(G=>G.slug!==z&&!ee.slice(0,3).includes(G.slug)),U=(()=>{if(ae.length===0){const G=(l||as||[]).filter(W=>W.slug!==z);return G[Math.floor(Math.random()*G.length)]||(l||as)[0]}return ae[Math.floor(Math.random()*ae.length)]})();if($<60)return i?[{icon:"🎯",title:"Try Fewer Questions",desc:"Start with just 5",color:"from-blue-500 to-cyan-500",action:()=>s(`/quiz/${z}`,{mode:"practice",difficulty:"easy",count:5,timer:{type:"off",seconds:0}})},{icon:U.icon,title:U.name,desc:"Fresh start with new topic",color:U.gradient,action:()=>s(`/quiz/${U.slug}`,{mode:"practice",difficulty:"easy",count:10,timer:{type:"off",seconds:0}})},{icon:"📖",title:"Review Mistakes",desc:"Learn from errors",color:"from-purple-500 to-pink-500",action:()=>n()}]:[{icon:"📚",title:"Practice Mode",desc:"No timer, learn at your pace",color:"from-green-500 to-teal-500",action:()=>s(`/quiz/${z}`,{mode:"practice",difficulty:"easy",count:10,timer:{type:"off",seconds:0}})},{icon:B!=="easy"?"🎯":"🔄",title:B!=="easy"?"Easy Mode":"Try Again",desc:B!=="easy"?"Build confidence":"You can do this!",color:"from-blue-500 to-cyan-500",action:()=>B!=="easy"?s(`/quiz/${z}`,{mode:"quiz",difficulty:"easy",count:5,timer:{type:"per_q",seconds:60}}):t()},{icon:U.icon,title:U.name,desc:"Try something different",color:U.gradient,action:()=>s(`/quiz/${U.slug}`,{mode:"quiz",difficulty:"easy",count:10,timer:{type:"per_q",seconds:45}})}];if($>=80)return B==="hard"&&$>=90?[{icon:"⚡",title:"Lightning Round",desc:"20 questions, 10s each",color:"from-yellow-500 to-red-500",action:()=>s(`/quiz/${z}`,{mode:"quiz",difficulty:"hard",count:20,timer:{type:"per_q",seconds:10}})},{icon:U.icon,title:`${U.name} Challenge`,desc:"Hard mode, new topic",color:U.gradient,action:()=>s(`/quiz/${U.slug}`,{mode:"quiz",difficulty:"hard",count:15,timer:{type:"per_q",seconds:30}})},{icon:"🎲",title:"Mixed Categories",desc:"Test all your knowledge",color:"from-purple-500 to-indigo-500",action:()=>s("/quiz/mixed",{mode:"quiz",difficulty:"hard",count:20,timer:{type:"per_q",seconds:30}})}]:[{icon:B==="hard"?"🔥":"🎯",title:B==="hard"?"Perfect Score Challenge":"Hard Mode",desc:B==="hard"?"Can you get 100%?":"Level up your skills",color:"from-red-500 to-orange-500",action:()=>s(`/quiz/${z}`,{mode:"quiz",difficulty:"hard",count:B==="hard"?10:20,timer:{type:"per_q",seconds:30}})},{icon:U.icon,title:U.name,desc:"Master new topics",color:U.gradient,action:()=>s(`/quiz/${U.slug}`,{mode:"quiz",difficulty:B,count:10,timer:{type:"per_q",seconds:45}})},{icon:"⚡",title:"Speed Challenge",desc:"10 questions, 15s each",color:"from-purple-500 to-pink-500",action:()=>s(`/quiz/${z}`,{mode:"quiz",difficulty:"medium",count:10,timer:{type:"per_q",seconds:15}})}];{const G=$<70;return[{icon:G?"📚":"🎯",title:G?"Practice More":"Try Again",desc:G?"Improve accuracy":"Beat your score",color:G?"from-green-500 to-teal-500":"from-blue-500 to-purple-500",action:G?()=>s(`/quiz/${z}`,{mode:"practice",difficulty:B,count:10,timer:{type:"off",seconds:0}}):()=>t()},{icon:U.icon,title:U.name,desc:"Explore new topics",color:U.gradient,action:()=>s(`/quiz/${U.slug}`,{mode:"quiz",difficulty:"medium",count:10,timer:{type:"per_q",seconds:45}})},{icon:B==="easy"?"⬆️":"💪",title:B==="easy"?"Medium Difficulty":"More Questions",desc:B==="easy"?"Ready for more?":"Test endurance",color:"from-indigo-500 to-purple-500",action:()=>s(`/quiz/${z}`,{mode:"quiz",difficulty:B==="easy"?"medium":B,count:B==="easy"?10:20,timer:{type:"per_q",seconds:45}})}]}},K=pt.useMemo(()=>M(),[$,i,e.categorySlug,e.difficulty]);return r.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white p-4",children:[m&&r.jsx(Ci,{startRect:m.startRect,targetRef:p,count:m.count,onDone:()=>{m.amount>0&&!S&&(console.log("[QuizResults] Adding coins once:",m.amount),c(m.amount),g(!0),f(o.coins+m.amount)),w(null)}}),r.jsx("style",{children:`
        @keyframes coinRotate {
          from { transform: rotateY(0deg); }
          to { transform: rotateY(360deg); }
        }
      `}),v&&r.jsx("div",{className:"fixed inset-0 pointer-events-none z-50 flex items-center justify-center",children:r.jsx("div",{className:"text-8xl animate-bounce",children:P?"🎉":"⭐"})}),r.jsxs("div",{className:"flex justify-between items-center mb-6",children:[r.jsxs("button",{onClick:y,className:"p-2 rounded-xl bg-white/10 backdrop-blur hover:bg-white/20 transition-all flex items-center gap-2",children:[r.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:r.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})}),r.jsx("span",{className:"text-sm font-medium",children:"Back"})]}),r.jsxs("div",{className:"flex gap-2",children:[r.jsxs("div",{className:"px-3 py-1.5 rounded-full bg-white/10 backdrop-blur text-sm font-medium",children:["Level ",o.level]}),r.jsxs("button",{ref:p,onClick:()=>T(!0),className:"px-3 py-1.5 rounded-full bg-yellow-500/20 backdrop-blur text-sm font-medium text-yellow-300 hover:bg-yellow-500/30 transition-all cursor-pointer",children:[u," 🪙"]})]})]}),r.jsxs("div",{className:"relative overflow-hidden rounded-3xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 p-8 mb-6",children:[r.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-purple-500/10 via-transparent to-blue-500/10 animate-pulse"}),r.jsxs("div",{className:"relative text-center",children:[r.jsxs("div",{className:`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur mb-4 ${ne.color}`,children:[r.jsx("span",{className:"text-2xl",children:ne.emoji}),r.jsx("span",{className:"font-semibold",children:ne.text})]}),r.jsxs("div",{className:"mb-6",children:[r.jsxs("div",{className:"text-7xl font-bold mb-2 bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent",children:[b,"/",R]}),r.jsxs("div",{className:"flex items-center justify-center gap-2 text-sm text-white/60",children:[r.jsx("span",{className:"text-xl",children:A.icon}),r.jsx("span",{children:A.name})]})]}),r.jsxs("div",{className:"grid grid-cols-3 gap-4 max-w-md mx-auto",children:[r.jsxs("div",{className:"text-center",children:[r.jsxs("div",{className:"text-3xl font-bold",children:[$,"%"]}),r.jsx("div",{className:"text-xs text-white/60",children:"Accuracy"})]}),r.jsxs("div",{className:"text-center",children:[r.jsxs("div",{className:"text-3xl font-bold",children:[L,"s"]}),r.jsx("div",{className:"text-xs text-white/60",children:"Avg Speed"})]}),r.jsxs("div",{className:"text-center",children:[r.jsx("div",{className:"text-3xl font-bold text-yellow-400",children:D>0?`+${D}`:"0"}),r.jsx("div",{className:"text-xs text-white/60",children:"Coins"})]})]})]})]}),r.jsxs("div",{className:"rounded-2xl bg-white/5 backdrop-blur border border-white/10 p-4 mb-6",children:[r.jsxs("div",{className:"flex items-center justify-between mb-3",children:[r.jsxs("div",{className:"flex items-center gap-2",children:[r.jsx(Hg,{}),r.jsx("span",{className:"text-sm font-medium",children:"Your Progress"})]}),o.combo>0&&r.jsxs("div",{className:"flex items-center gap-1 px-2 py-1 rounded-full bg-orange-500/20 text-orange-400 text-xs",children:[r.jsx(Wg,{}),o.combo," streak"]})]}),r.jsx("div",{className:"flex items-end gap-1 h-12 mb-2",children:re.map((z,B)=>r.jsx("div",{className:`flex-1 rounded-t transition-all ${B===re.length-1?"bg-gradient-to-t from-purple-500 to-purple-400":"bg-white/20"}`,style:{height:`${z.score/z.total*100}%`,minHeight:"4px"}},B))}),r.jsx("div",{className:"text-xs text-white/40 text-center",children:"Last 5 quizzes"})]}),r.jsxs("div",{className:"grid grid-cols-2 gap-3 mb-6",children:[r.jsxs("button",{onClick:n,className:"relative overflow-hidden group rounded-2xl bg-gradient-to-r from-blue-500 to-purple-500 p-4 transition-all hover:scale-105 active:scale-95",children:[r.jsx("div",{className:"absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform"}),r.jsxs("div",{className:"relative flex items-center justify-between",children:[r.jsxs("div",{className:"text-left",children:[r.jsx("div",{className:"font-semibold",children:"Review"}),r.jsx("div",{className:"text-xs opacity-80",children:"Check answers"})]}),r.jsx(Yg,{})]})]}),r.jsx("button",{onClick:t,className:"relative overflow-hidden group rounded-2xl bg-white/10 backdrop-blur border border-white/20 p-4 transition-all hover:scale-105 active:scale-95 hover:bg-white/15",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{className:"text-left",children:[r.jsx("div",{className:"font-semibold",children:"Try Again"}),r.jsx("div",{className:"text-xs opacity-60",children:"New questions"})]}),r.jsx(Qg,{})]})})]}),r.jsxs("div",{className:"space-y-3",children:[r.jsx("div",{className:"text-sm font-medium text-white/60 px-1",children:"Recommended for you"}),K.map((z,B)=>r.jsx("button",{onClick:z.action,className:"w-full group relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur border border-white/10 p-4 transition-all hover:bg-white/10 hover:border-white/20",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsx("div",{className:`p-2 rounded-xl bg-gradient-to-r ${z.color} opacity-20 group-hover:opacity-30 transition-opacity`,children:r.jsx("span",{className:"text-xl",children:z.icon})}),r.jsxs("div",{className:"text-left",children:[r.jsx("div",{className:"font-medium text-sm",children:z.title}),r.jsx("div",{className:"text-xs text-white/40",children:z.desc})]})]}),r.jsx(qg,{})]})},B))]}),r.jsx("div",{className:"mt-6 pt-6 border-t border-white/10",children:r.jsx("button",{onClick:()=>s("/profile/history",{replace:!0}),className:"w-full text-center text-sm text-white/40 hover:text-white/60 transition-colors",children:"View all history →"})}),j&&r.jsx("div",{className:"fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4",onClick:z=>{z.target===z.currentTarget&&T(!1)},children:r.jsxs("div",{className:"bg-gray-800 rounded-3xl p-6 w-full max-w-md border border-gray-700 relative overflow-hidden",onClick:z=>z.stopPropagation(),children:[r.jsx("div",{className:"absolute inset-0 opacity-10",children:r.jsx("div",{className:"h-full bg-gradient-to-br from-yellow-400 to-orange-500"})}),r.jsxs("div",{className:"relative",children:[r.jsxs("div",{className:"flex items-center justify-between mb-6",children:[r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsx("div",{className:"text-5xl",style:{animation:"coinRotate 2s linear infinite"},children:"🪙"}),r.jsxs("div",{children:[r.jsx("h3",{className:"text-2xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent",children:"Your Treasure"}),r.jsxs("p",{className:"text-3xl font-bold text-white mt-1",children:[o.coins," Coins"]})]})]}),r.jsx("button",{onClick:()=>T(!1),className:"w-8 h-8 rounded-lg bg-white/5 border border-gray-600 grid place-items-center hover:bg-white/10 transition",children:"✕"})]}),r.jsxs("div",{className:"mb-6",children:[r.jsx("h4",{className:"text-sm font-medium text-gray-400 mb-3",children:"Ways to Earn"}),r.jsxs("div",{className:"space-y-3",children:[r.jsx("div",{className:"p-4 rounded-xl bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 hover:scale-[1.02] transition-transform",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{children:[r.jsxs("div",{className:"font-medium flex items-center gap-2",children:[r.jsx("span",{className:"text-2xl",children:"✅"}),"Complete Quizzes"]}),r.jsx("div",{className:"text-xs text-gray-400 mt-1",children:"+5 coins per correct answer"})]}),r.jsx("div",{className:"text-green-400 font-bold",children:"+5"})]})}),r.jsx("div",{className:"p-4 rounded-xl bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20 hover:scale-[1.02] transition-transform",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{children:[r.jsxs("div",{className:"font-medium flex items-center gap-2",children:[r.jsx("span",{className:"text-2xl",children:"🎯"}),"Daily Challenge"]}),r.jsx("div",{className:"text-xs text-gray-400 mt-1",children:"Complete daily for bonus"})]}),r.jsx("div",{className:"text-blue-400 font-bold",children:"+5"})]})}),r.jsx("div",{className:"p-4 rounded-xl bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 hover:scale-[1.02] transition-transform",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{children:[r.jsxs("div",{className:"font-medium flex items-center gap-2",children:[r.jsx("span",{className:"text-2xl",children:"🎰"}),"Spin & Play"]}),r.jsx("div",{className:"text-xs text-gray-400 mt-1",children:"Test your luck!"})]}),r.jsx("div",{className:"text-purple-400 font-bold",children:"+50"})]})}),r.jsx("div",{className:"p-4 rounded-xl bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 hover:scale-[1.02] transition-transform",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{children:[r.jsxs("div",{className:"font-medium flex items-center gap-2",children:[r.jsx("span",{className:"text-2xl",children:"🏆"}),"Achievements"]}),r.jsx("div",{className:"text-xs text-gray-400 mt-1",children:"Unlock special rewards"})]}),r.jsx("div",{className:"text-orange-400 font-bold",children:"+???"})]})})]})]}),r.jsxs("div",{className:"mb-6",children:[r.jsxs("div",{className:"flex justify-between text-xs text-gray-400 mb-2",children:[r.jsx("span",{children:"Next reward"}),r.jsxs("span",{children:[100-o.coins%100," coins to go"]})]}),r.jsx("div",{className:"h-2 bg-white/10 rounded-full overflow-hidden",children:r.jsx("div",{className:"h-full bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full transition-all",style:{width:`${o.coins%100}%`}})})]}),r.jsx("button",{onClick:()=>{T(!1),s("/play")},className:"w-full py-3 rounded-xl bg-gradient-to-r from-yellow-400 to-orange-500 text-white font-bold hover:scale-[1.02] transition-transform shadow-lg",children:"Start Earning Now! 🚀"})]})]})})]})},Vg=({questions:e,answers:t,skipped:n,onBack:s,onRetake:a,fromHistory:i=!1})=>{const o=He(),l=()=>{i?o("/profile/history",{replace:!0}):s?s():o(-1)},c=e.reduce((p,m,w)=>p+(t[w]===m.answerIndex?1:0),0),u=(n==null?void 0:n.filter(Boolean).length)||0,f=e.length-c-u;return r.jsxs("div",{className:"mt-2 card rounded-3xl p-5 w-full max-w-none mx-auto pb-24",children:[r.jsxs("div",{className:"flex items-center justify-between mb-4",children:[r.jsx("button",{className:"px-3 py-1.5 rounded-xl border border-base-border bg-white/5",onClick:l,children:"← Back"}),r.jsx("h2",{className:"text-lg font-semibold",children:"Review Answers"}),r.jsx("div",{className:"w-16"})," "]}),r.jsxs("div",{className:"grid grid-cols-3 gap-2 mb-4",children:[r.jsxs("div",{className:"rounded-xl bg-green-600/10 border border-green-500/30 p-2 text-center",children:[r.jsx("div",{className:"text-xs text-green-400",children:"Correct"}),r.jsx("div",{className:"text-lg font-bold text-green-400",children:c})]}),r.jsxs("div",{className:"rounded-xl bg-red-600/10 border border-red-500/30 p-2 text-center",children:[r.jsx("div",{className:"text-xs text-red-400",children:"Incorrect"}),r.jsx("div",{className:"text-lg font-bold text-red-400",children:f})]}),r.jsxs("div",{className:"rounded-xl bg-amber-600/10 border border-amber-500/30 p-2 text-center",children:[r.jsx("div",{className:"text-xs text-amber-400",children:"Skipped"}),r.jsx("div",{className:"text-lg font-bold text-amber-400",children:u})]})]}),r.jsx("ol",{className:"space-y-4",children:e.map((p,m)=>{const w=t[m],x=!w&&w!==0,k=w===p.answerIndex;return r.jsxs("li",{className:"rounded-2xl border border-base-border bg-white/5 p-4 md:p-5",children:[r.jsxs("div",{className:"flex items-start justify-between mb-3",children:[r.jsxs("div",{className:"flex-1",children:[r.jsxs("div",{className:"text-sm md:text-base font-medium",children:["Q",m+1,". ",p.prompt]}),p.category&&r.jsxs("div",{className:"text-xs text-base-muted mt-1",children:["Category: ",p.category," • Difficulty: ",p.difficulty||"Medium"]})]}),r.jsx("div",{className:"ml-2",children:x?r.jsx("span",{className:"px-2 py-1 rounded text-xs bg-amber-600/20 text-amber-400",children:"Skipped"}):k?r.jsx("span",{className:"px-2 py-1 rounded text-xs bg-green-600/20 text-green-400",children:"✓ Correct"}):r.jsx("span",{className:"px-2 py-1 rounded text-xs bg-red-600/20 text-red-400",children:"✗ Wrong"})})]}),r.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:p.options.map((C,v)=>{const h=w===v,b=v===p.answerIndex;let E="w-full text-left px-3 py-2 rounded-xl border transition-all ";return b?E+="bg-green-600/20 border-green-500/50 text-green-300":h&&!b?E+="bg-red-600/20 border-red-500/50 text-red-300":E+="bg-base-bg/40 border-base-border text-base-muted",r.jsxs("div",{className:E,children:[r.jsxs("span",{className:"font-semibold mr-2",children:[["A","B","C","D"][v],"."]}),C,b&&r.jsx("span",{className:"ml-2 text-green-400",children:"✓"}),h&&!b&&r.jsx("span",{className:"ml-2 text-red-400",children:"✗"})]},v)})}),p.explanation&&r.jsxs("div",{className:"mt-3 p-3 rounded-xl bg-white/5 border border-base-border",children:[r.jsx("div",{className:"text-xs font-semibold text-brand-blue mb-1",children:"Explanation:"}),r.jsx("div",{className:"text-sm text-base-muted",children:p.explanation})]})]},p.id||m)})}),r.jsxs("div",{className:"mt-6 flex gap-2 justify-center sticky bottom-4",children:[r.jsx("button",{className:"px-4 py-2.5 rounded-xl border border-base-border bg-base-card backdrop-blur",onClick:l,children:"Back to Results"}),a&&r.jsx("button",{className:"px-4 py-2.5 rounded-xl bg-gradient-to-r from-brand-blue to-brand-purple text-white font-medium",onClick:a,children:"Retake Quiz"})]})]})},Xg="qp_resume",zd="qp_mistakes",Fd="qp_stats",Od="qp_lastset",$d="qp_recent",Bd="qp_review_snapshot",Kg=50,is=(e="")=>e.replace(/-/g," ").replace(/\b\w/g,t=>t.toUpperCase()),Da=(e="")=>e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-"),Jg=(e,t)=>e.slice().sort(()=>Math.random()-.5).slice(0,t),Am=e=>{const t=e.slice();for(let n=t.length-1;n>0;n--){const s=Math.floor(Math.random()*(n+1));[t[n],t[s]]=[t[s],t[n]]}return t},Zg=(e,t,n)=>Math.max(t,Math.min(n,e)),os=(e,t)=>{try{const n=localStorage.getItem(e);return n?JSON.parse(n):t}catch{return t}};async function ev(){const e="/data/quiz_questions_bank.csv",t=await fetch(e);if(!t.ok)throw new Error(`CSV not found at ${e}`);const n=await t.text(),{data:s}=hr.parse(n,{header:!0,skipEmptyLines:!0,transformHeader:i=>String(i).trim().toLowerCase()}),a={a:0,b:1,c:2,d:3};return s.map((i,o)=>{var m;const l=[i.option1,i.option2,i.option3,i.option4].map(w=>(w??"").trim());if(l.some(w=>!w))return null;let c=-1;const u=String(i.answer??"").trim();if(a[u.toLowerCase()]!==void 0)c=a[u.toLowerCase()];else{const w=l.findIndex(x=>x.toLowerCase()===u.toLowerCase());c=w>=0?w:0}const f=String(i.category??i.subject??"General Knowledge").trim(),p=String(i.difficulty??"medium").toLowerCase().trim();return{id:((m=i.id)==null?void 0:m.trim())||`q_${o}`,category:f,difficulty:p,prompt:String(i.question??"").trim(),options:l,answerIndex:c,explanation:String(i.explanation??"").trim()}}).filter(Boolean)}function tv(e,{categorySlug:t,difficulty:n,count:s}){console.log("=== BUILD SESSION DEBUG ==="),console.log("categorySlug:",t),console.log("difficulty:",n),console.log("count:",s),console.log("Total questions available:",e.length);const i=t==="mixed"?()=>!0:f=>Da(f.category)===t,o=n?f=>(f.difficulty||"medium")===n:()=>!0,l=e.filter(f=>i(f)&&o(f));if(console.log("Filtered pool size:",l.length),console.log("Sample categories from all questions:",[...new Set(e.slice(0,10).map(f=>`"${f.category}" -> "${Da(f.category)}"`))]),l.length===0)return console.error("No questions match the filter criteria!"),console.log("Available categories:",[...new Set(e.map(f=>Da(f.category)))]),{questions:[],poolSize:0};const u=Jg(l,Math.min(s,l.length)).map(f=>{const p=Am([0,1,2,3]),m=p.map(x=>f.options[x]),w=p.indexOf(f.answerIndex);return{...f,options:m,answerIndex:w}});return console.log("Final questions:",u.length),{questions:u,poolSize:l.length}}function nv(){const e=He(),{category:t}=Yp(),n=bt(),{energy:s,useEnergy:a,player:i,addCoins:o,addXP:l,updateDailyStreak:c}=jn(),u=new URLSearchParams(n.search),f=u.get("review")==="1",p=u.get("retake")==="1",m=n.state||{},w=m.mode||"quiz",x=String(m.difficulty||"medium").toLowerCase(),k=m.returnPath||null,C=m.fromQuest||!1,v=Zg(Number(m.count||10),1,50),h=m.timer||{type:"per_q",seconds:45};m.resume,m.daily,m.source;const b=p||!!m.retake,E=!!m.fromHistory,j=w==="practice";console.log("Quiz Component - Mode Detection:",{routerState:m,mode:w,isPractice:j,location:n.pathname,state:n.state});const[T,S]=d.useState([]),[g,y]=d.useState(!0),[N,R]=d.useState(""),[I,q]=d.useState({questions:[]}),[Z,H]=d.useState("quiz"),[Y,$]=d.useState(null),[P,_]=d.useState(null),[F,L]=d.useState(0);d.useEffect(()=>{let Q=!0;return(async()=>{try{const M=await ev();if(!Q)return;S(M)}catch(M){console.error(M),R("Failed to load questions. Check /public/data/quiz_questions_bank.csv")}finally{y(!1)}})(),()=>{Q=!1}},[]),d.useEffect(()=>{if(g||N||f||T.length===0)return;console.log("=== SESSION INIT ==="),console.log("Category:",t),console.log("Mode:",w),console.log("Difficulty:",x),console.log("Count:",v);const Q=tv(T,{categorySlug:t,difficulty:x,count:v});if(Q.questions.length===0){console.error("No questions found!"),console.log("Looking for category:",t),console.log("Available categories (first 10):",[...new Set(T.map(M=>Da(M.category)))].slice(0,10)),R(`No questions found for "${is(t)}" with difficulty "${x}"`);return}console.log("Session built with",Q.questions.length,"questions"),q(Q),_(Date.now()),L(0),H("quiz")},[T,t,w,x,v,n.state,n.search]),d.useEffect(()=>{if(Z!=="quiz"||!P)return;const Q=setInterval(()=>{L(Date.now()-P)},1e3);return()=>clearInterval(Q)},[Z,P]);const D=d.useCallback(Q=>{if(console.log("Quiz completed - Mode:",w,"isPractice:",j,"Results:",Q),!Q||!Q.questions){console.error("Invalid results object:",Q);return}const M=Q.questions.filter((z,B)=>Q.answers[B]!==null&&Q.answers[B]!==z.answerIndex).map(z=>z.id);try{const z=os(zd,[]),B=Array.from(new Set([...M,...z]));localStorage.setItem(zd,JSON.stringify(B))}catch(z){console.error("Error saving mistakes:",z)}try{const z=os(Fd,{sessions:[]});z.sessions.push({cat:is(t),mode:j?"practice":"quiz",total:Q.total,correct:Q.correct,skipped:Q.skipped.filter(Boolean).length,ms:F,timestamp:Date.now(),earnedXP:j?0:Q.correct*10,earnedCoins:j?0:Q.correct*5}),localStorage.setItem(Fd,JSON.stringify(z))}catch(z){console.error("Error saving stats:",z)}const K={ts:Date.now(),slug:t,categoryLabel:is(t),mode:j?"practice":"quiz",difficulty:x,total:Q.total,timer:j?null:h,ms:F,attempted:Q.answers.filter(z=>z!==null).length,correct:Q.correct,questions:Q.questions,answers:Q.answers,skipped:Q.skipped,isPractice:j};try{localStorage.setItem(Od,JSON.stringify(K)),localStorage.setItem(Bd,JSON.stringify({questions:Q.questions,answers:Q.answers,skipped:Q.skipped}));const z=os($d,[]),ee=[{id:K.ts,ts:K.ts,cat:K.categoryLabel,slug:t,mode:j?"Practice":"Quiz",total:Q.total,correct:Q.correct,ms:F,snapshot:K},...z].slice(0,Kg);localStorage.setItem($d,JSON.stringify(ee))}catch(z){console.error("Error saving snapshot:",z)}if(localStorage.removeItem(Xg),j&&Q.earnedCoins?Q.earnedCoins:!j&&Q.correct>0&&Q.correct*5,!j&&Q.correct>0){const z=Q.correct*10;l(z)}c(),console.log("Setting review snapshot with:",{returnPath:k||"/",fromQuest:C||!1}),$({...Q,category:is(t),categorySlug:t,difficulty:x,mode:j?"practice":"quiz",elapsedMs:F,isPractice:j,hasTimer:!j,earnedXP:j?0:Q.correct*10,earnedCoins:j?Q.earnedCoins||0:Q.correct*5,returnPath:k||"/",fromQuest:C||!1}),H("results")},[t,w,h,F,j,k,C]),A=d.useCallback(()=>{k?e(k,{replace:!0}):E?e("/profile/history",{replace:!0,state:null}):e("/")},[E,e,k]),X=d.useCallback(()=>{console.log("Retake requested - Mode:",w,"isPractice:",j);const Q=os(Od,null);if(!Q||Q.slug!==t){e(`/quiz/${t}?r=${Date.now()}`,{replace:!0,state:{mode:j?"practice":"quiz",difficulty:x,count:v,timer:j?null:h,retake:!0}});return}const M=Q.questions.map(K=>{const z=Am([0,1,2,3]);return{...K,options:z.map(B=>K.options[B]),answerIndex:z.indexOf(K.answerIndex)}});q({questions:M,poolSize:M.length}),_(Date.now()),L(0),H("quiz"),window.scrollTo(0,0)},[t,w,x,v,h,e,j]),ne=d.useCallback((Q=null)=>{if(Q)$(Q);else if(!Y){const M=os(Bd,null);M&&$({questions:M.questions||[],answers:M.answers||[],skipped:M.skipped||[]})}H("review")},[Y]),re=d.useCallback(()=>{E?e("/profile/history",{replace:!0}):H("results")},[E,e]);return g?r.jsx("div",{className:"fixed inset-0 bg-inherit text-white flex items-center justify-center",children:r.jsx("div",{className:"text-sm text-base-muted",children:"Loading questions…"})}):N?r.jsx("div",{className:"fixed inset-0 bg-inherit text-white flex items-center justify-center",children:r.jsx("div",{className:"text-sm text-red-400",children:N})}):(console.log("Render - Current view:",Z,"Session questions:",I.questions.length,"Mode:",w,"isPractice:",j),r.jsx("div",{className:"fixed inset-0 bg-inherit text-white z-0 overflow-x-hidden max-w-[100vw]",children:r.jsxs("div",{className:"h-full overflow-y-auto overscroll-y-none overflow-x-hidden touch-pan-y px-0 pt-[max(env(safe-area-inset-top),72px)] pb-[clamp(12px,env(safe-area-inset-bottom),20px)]",children:[Z==="quiz"&&I.questions.length>0&&r.jsx(Ug,{session:I,mode:j?"practice":"quiz",category:is(t),difficulty:x,timerConfig:j?null:h,onComplete:D,onQuit:A,isPractice:j}),Z==="results"&&Y&&r.jsx(Gg,{results:Y,onRetake:X,onReview:()=>ne(Y),isRetake:b,isPractice:j,player:i,categories:Rm,addCoins:o,onNavigate:(Q,M)=>{console.log("onNavigate called with:",Q,M),M!=null&&M.state?e(Q,{state:M.state,replace:M.replace||!1}):e(Q)}}),Z==="review"&&Y&&r.jsx(Vg,{questions:Y.questions||[],answers:Y.answers||[],skipped:Y.skipped||[],onBack:re,onRetake:X,fromHistory:E,isPractice:j})]})}))}const En=[{label:"General Knowledge",slug:"general-knowledge",color:"#7C3AED",soon:!1},{label:"Current Affairs",slug:"current-affairs",color:"#2563EB",soon:!1},{label:"Fun Facts",slug:"fun-facts",color:"#EF4444",soon:!1},{label:"Science",slug:"science",color:"#10B981",soon:!1},{label:"History",slug:"history",color:"#F59E0B",soon:!0},{label:"Geography",slug:"geography",color:"#FACC15",soon:!0},{label:"Cat 1",slug:"cat-1",color:"#06B6D4",soon:!0},{label:"Cat 2",slug:"cat-2",color:"#D946EF",soon:!0}],Xn=360/En.length,rv=42,ro=3e3,Ud=10,qd=260,sv="cubic-bezier(.15,.7,.1,1)",av="cubic-bezier(.2,.7,.2,1)",Cn=5,iv=5,ov=(e="")=>String(e).toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");function lv({muted:e=!1,size:t=18}){return r.jsxs("svg",{width:t,height:t,viewBox:"0 0 24 24","aria-hidden":"true",children:[r.jsx("path",{d:"M3 9h4l5-4v14l-5-4H3z",fill:"currentColor"}),!e&&r.jsxs(r.Fragment,{children:[r.jsx("path",{d:"M16 8c1.5 1.5 1.5 6 0 7.5",stroke:"currentColor",strokeWidth:"2",fill:"none",strokeLinecap:"round"}),r.jsx("path",{d:"M19 6c3 3 3 10 0 13",stroke:"currentColor",strokeWidth:"2",fill:"none",strokeLinecap:"round"})]}),e&&r.jsx("line",{x1:"3",y1:"21",x2:"21",y2:"3",stroke:"#EF4444",strokeWidth:"2.5",strokeLinecap:"round"})]})}function cv({q:e,locked:t,onPick:n,result:s}){if(!e)return null;const a=[e.option1,e.option2,e.option3,e.option4];return r.jsxs("div",{className:"mt-5 rounded-3xl bg-white/5 border border-white/10 p-4",children:[r.jsx("div",{className:"text-sm text-base-muted mb-1",children:"Quick question"}),r.jsx("div",{className:"text-xl font-semibold mb-4",children:e.question}),a.map((i,o)=>{const l=s&&i===e.answer,c=s&&s.pick===i&&i!==e.answer;return r.jsx("button",{disabled:t||!!s,onClick:()=>n(i),className:["w-full text-left px-4 py-2 rounded-xl mb-2 border transition",!s&&!t?"bg-white/5 hover:bg-white/10 border-white/10":"bg-white/5 border-white/10",l?"bg-green-600/20 border-green-400/60 text-green-200":"",c?"bg-red-600/20 border-red-400/60 text-red-200":""].join(" "),children:i},o)}),s&&r.jsxs("div",{className:"mt-3 text-sm",children:[s.correct?r.jsx("span",{className:"text-green-400 font-medium",children:"✅ Correct!"}):r.jsxs("span",{className:"text-red-400 font-medium",children:["❌ Not quite. Answer: ",r.jsx("b",{children:e.answer})]}),e.explanation&&r.jsxs("div",{className:"text-xs text-base-muted mt-1",children:["Tip: ",e.explanation]})]})]})}function dv(){const e=He(),[t]=zt("/sounds/correct.mp3",{volume:.7}),[n]=zt("/sounds/wrong.mp3",{volume:.7}),[s,a]=d.useState(()=>[{name:"Player 1",color:"#60A5FA",scores:Array(Cn).fill(null)},{name:"Player 2",color:"#F472B6",scores:Array(Cn).fill(null)}]),[i,o]=d.useState(0),[l,c]=d.useState(1),u=s.reduce((M,K)=>M+K.scores.reduce((z,B)=>z+(B??0),0),0),[f,p]=d.useState(!0),m=d.useRef(null);d.useEffect(()=>{const M=new Audio("/sounds/spin.mp3");return M.loop=!0,M.volume=.7,m.current=M,()=>{try{M.pause(),M.src=""}catch{}}},[]);const w=()=>{if(f&&m.current)try{m.current.currentTime=0,m.current.play()}catch{}},x=()=>{if(m.current)try{m.current.pause(),m.current.currentTime=0}catch{}},[k,C]=d.useState(0),[v,h]=d.useState("none"),[b,E]=d.useState(!1),[j,T]=d.useState(null),[S,g]=d.useState(null),y=d.useMemo(()=>typeof window<"u"?window.matchMedia("(prefers-reduced-motion: reduce)").matches:!1,[]),[N,R]=d.useState([]);d.useEffect(()=>{(async()=>{try{const M=await fetch("/data/quiz_questions_bank.csv").then(ee=>ee.text()),{data:K}=hr.parse(M,{header:!0,skipEmptyLines:!0,transformHeader:ee=>String(ee).trim().toLowerCase()}),z={a:0,b:1,c:2,d:3},B=K.map((ee,ae)=>{var te;const ce=(ee.question??"").trim();if(!ce)return null;const U=[ee.option1,ee.option2,ee.option3,ee.option4].map(de=>String(de??"").trim());if(U.some(de=>!de))return null;let G=String(ee.answer??"").trim(),W=z[G.toLowerCase()];if(W===void 0){const de=U.findIndex(je=>je.toLowerCase()===G.toLowerCase());W=de>=0?de:0}const O=U[W];return{id:((te=ee.id)==null?void 0:te.trim())||`ps_${ae}`,question:ce,option1:U[0],option2:U[1],option3:U[2],option4:U[3],answer:O,explanation:String(ee.explanation??"").trim(),catSlug:ov(ee.category??ee.subject??"general knowledge"),difficulty:String(ee.difficulty??"medium").toLowerCase().trim()}}).filter(Boolean);R(B)}catch{R([])}})()},[]);const[I,q]=d.useState(null),[Z,H]=d.useState(null),[Y,$]=d.useState(!1),P=M=>(M%360+360)%360,_=M=>P(M),F=l>Cn;function L(){if(s.length>=4)return;const M=["#60A5FA","#F472B6","#F59E0B","#34D399","#F87171","#A78BFA"],K=M[(s.length*2+1)%M.length];a(z=>[...z,{name:`Player ${z.length+1}`,color:K,scores:Array(Cn).fill(null)}])}function D(){s.length<=2||(a(M=>M.slice(0,-1)),o(M=>Math.min(M,s.length-2)))}function A(M){a(K=>K.map((z,B)=>B===i?{...z,scores:z.scores.map((ee,ae)=>ae===l-1?M:ee)}:z))}function X(){if(b||F)return;T(null),g(null),q(null),H(null),E(!0),w();const M=Math.floor(Math.random()*En.length),K=En[M],z=Xn*.28,B=(Math.random()*2-1)*z,ee=P(k),ae=180,U=M*Xn+Xn/2+B;let G=_(U-ee-ae);const W=rv*360+G,O=k+W+Ud;h(`transform ${y?800:ro}ms ${sv}`),C(O);try{navigator.vibrate&&!y&&navigator.vibrate([10,40,10])}catch{}setTimeout(()=>{h(`transform ${y?160:qd}ms ${av}`),C(te=>te-Ud)},y?800:ro),setTimeout(()=>{if(x(),E(!1),T(M),g(K.color),K.soon)return;const te=N.filter(je=>je.catSlug===K.slug&&je.difficulty==="easy"),de=te.length?te:N.filter(je=>je.catSlug===K.slug);if(de.length){const je=de[Math.floor(Math.random()*de.length)];q(je)}else q({question:"No question found for this category yet. Try re-spinning!",option1:"Okay",option2:"Okay",option3:"Okay",option4:"Okay",answer:"Okay",explanation:""})},(y?800:ro)+(y?160:qd)+40)}function ne(M){if(!I||Z)return;const K=M===I.answer;if(H({correct:K,pick:M}),K){t(),$(!0),setTimeout(()=>$(!1),900);try{navigator.vibrate&&navigator.vibrate([8,16])}catch{}A(iv)}else{n();try{navigator.vibrate&&navigator.vibrate([4])}catch{}A(0)}}function re(){const M=(i+1)%s.length,K=M===0?l+1:l;o(M),c(K),T(null),g(null),q(null),H(null)}function Q(){const M=s.map(B=>B.scores.reduce((ee,ae)=>ee+(ae??0),0)),K=Math.max(...M),z=s.filter((B,ee)=>M[ee]===K).map(B=>B.name).join(", ");alert(`${z} win${z.includes(",")?"":"s"} the pot of ${u} coins! 🎉`),e("/play")}return r.jsxs("div",{className:"min-h-screen bg-black text-white",children:[Y&&r.jsx(_m,{numberOfPieces:120,recycle:!1}),r.jsxs("div",{className:"mx-auto max-w-md px-5 pt-[calc(env(safe-area-inset-top)+1.25rem)] pb-[calc(5.25rem+env(safe-area-inset-bottom))]",children:[r.jsxs("header",{className:"flex items-center justify-between mb-4",children:[r.jsx("button",{onClick:()=>e("/play"),className:"h-10 w-10 grid place-items-center rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition","aria-label":"Back",children:"←"}),r.jsxs("div",{className:"text-center",children:[r.jsx("h1",{className:"text-2xl font-bold",children:"Party Spin"}),r.jsx("p",{className:"text-sm text-base-muted",children:"Pass & play • Winner takes the pot"})]}),r.jsx("button",{onClick:()=>p(M=>!M),className:"h-10 w-10 grid place-items-center rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition","aria-label":f?"Mute sound":"Unmute sound",title:f?"Sound on":"Sound off",children:r.jsx(lv,{muted:!f})})]}),r.jsxs("section",{className:"rounded-2xl border border-white/10 bg-white/5 p-3 mb-4",children:[r.jsxs("div",{className:"flex items-center justify-between mb-2",children:[r.jsxs("div",{className:"text-sm",children:["Round ",r.jsx("b",{children:Math.min(l,Cn)}),"/",r.jsx("b",{children:Cn})]}),r.jsxs("div",{className:"flex items-center gap-2",children:[r.jsx("button",{onClick:L,className:"btn-ghost px-2 py-1 text-sm",children:"+"}),r.jsx("span",{className:"text-sm text-base-muted",children:"Player"}),r.jsx("button",{onClick:D,className:"btn-ghost px-2 py-1 text-sm",children:"−"})]}),r.jsxs("div",{className:"text-sm",children:["Pot: ",r.jsx("b",{className:"text-yellow-300",children:u})," 🪙"]})]}),r.jsx("div",{className:"overflow-x-auto",children:r.jsxs("table",{className:"w-full table-fixed text-sm tracking-tight tabular-nums",children:[r.jsxs("colgroup",{children:[r.jsx("col",{style:{width:"42%"}}),r.jsx("col",{style:{width:"9%"}}),r.jsx("col",{style:{width:"9%"}}),r.jsx("col",{style:{width:"9%"}}),r.jsx("col",{style:{width:"9%"}}),r.jsx("col",{style:{width:"9%"}}),r.jsx("col",{style:{width:"13%"}})]}),r.jsx("thead",{children:r.jsxs("tr",{className:"text-base-muted",children:[r.jsx("th",{className:"text-left font-medium py-1 pr-1",children:"Player"}),Array.from({length:Cn}).map((M,K)=>r.jsxs("th",{className:"font-medium text-center",children:["R",K+1]},K)),r.jsx("th",{className:"font-medium text-right pr-1",children:"Total"})]})}),r.jsx("tbody",{children:s.map((M,K)=>{const z=M.scores.reduce((ee,ae)=>ee+(ae??0),0),B=K===i;return r.jsxs("tr",{className:B?"bg-white/6":"",children:[r.jsx("td",{className:"py-1 pr-1",children:r.jsxs("div",{className:"flex items-center gap-2",children:[r.jsx("span",{className:"inline-block h-3 w-3 rounded-full shrink-0",style:{background:M.color}}),r.jsx("input",{className:"bg-transparent outline-none font-semibold w-full",value:M.name,onChange:ee=>a(ae=>ae.map((ce,U)=>U===K?{...ce,name:ee.target.value}:ce))})]})}),M.scores.map((ee,ae)=>r.jsx("td",{className:"text-center",children:ee===null?"–":ee},ae)),r.jsx("td",{className:"text-right pr-1 font-semibold",children:z})]},K)})})]})})]}),r.jsx("section",{className:"flex flex-col items-center",children:r.jsxs("div",{className:"relative w-[320px] h-[320px] md:w-[380px] md:h-[380px] rounded-full select-none",children:[S&&r.jsx("div",{className:"pointer-events-none absolute -inset-2 rounded-full",style:{boxShadow:`0 0 0 6px ${S}33, 0 0 30px 8px ${S}44`}}),r.jsx("div",{className:"absolute inset-0 rounded-full border border-white/10 shadow-2xl bg-black/20 overflow-hidden will-change-transform",style:{transform:`rotate(${k}deg)`,transition:v},"aria-label":"Category wheel",role:"group",children:r.jsxs("svg",{width:"100%",height:"100%",viewBox:"0 0 100 100",className:"block",children:[En.map((M,K)=>{const z=K*Xn,B=z+Xn,ee=Xn>180?1:0,ae=Math.PI*z/180,ce=Math.PI*B/180,U=50+50*Math.cos(ae),G=50-50*Math.sin(ae),W=50+50*Math.cos(ce),O=50-50*Math.sin(ce),te=j===K;return r.jsxs("g",{style:{opacity:j==null?.95:te?1:.78,filter:j!=null&&!te?"blur(0.6px)":"none"},children:[r.jsx("path",{d:`M50,50 L${U},${G} A50,50 0 ${ee} 0 ${W},${O} Z`,fill:M.color,stroke:te?`${M.color}AA`:"rgba(255,255,255,0.14)",strokeWidth:te?"1.2":"0.6"}),r.jsx("text",{x:"50",y:"50",fill:"#ffffff",fontSize:"4",fontWeight:"700",dominantBaseline:"middle",transform:`rotate(${z+Xn/2} 50 50) translate(12 0)`,children:r.jsxs("tspan",{children:[M.label,M.soon?" (soon)":""]})})]},M.slug)}),r.jsx("circle",{cx:"50",cy:"50",r:"9",fill:"rgba(0,0,0,0.55)",stroke:"white",strokeOpacity:"0.25"})]})}),r.jsx("button",{onClick:X,disabled:b||F,className:["absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2","h-16 w-16 rounded-full grid place-items-center","bg-white text-black font-extrabold shadow-soft transition active:scale-[0.98]",b||F?"opacity-60 cursor-not-allowed":"hover:bg-gray-200"].join(" "),"aria-label":"Spin the wheel",children:"SPIN"}),r.jsx("div",{className:"absolute left-1/2 -translate-x-1/2 -bottom-3 z-20",children:r.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",children:r.jsx("path",{d:"M12 4 L20 20 L4 20 Z",fill:"#ffffff"})})}),j!=null&&!b&&r.jsx("div",{className:"absolute left-1/2 -translate-x-1/2 -bottom-10",children:r.jsxs("div",{className:"px-3 py-1 rounded-full bg-white/10 border border-white/20 text-sm backdrop-blur",children:[r.jsx("span",{className:"inline-block h-2.5 w-2.5 rounded-full mr-2 align-middle",style:{background:En[j].color}}),En[j].label]})})]})}),r.jsx("section",{className:"mt-4",children:F?r.jsxs("div",{className:"rounded-2xl border border-white/10 bg-white/5 p-4",children:[r.jsx("div",{className:"text-xl font-semibold mb-2",children:"Match Over"}),r.jsxs("p",{className:"text-sm text-base-muted mb-3",children:["Top score takes the pot of ",r.jsx("b",{className:"text-yellow-300",children:u})," coins."]}),r.jsx("button",{className:"btn-primary w-full",onClick:Q,children:"End match"})]}):j!=null&&En[j].soon?r.jsxs("div",{className:"rounded-2xl border border-white/10 bg-white/5 p-4",children:[r.jsx("div",{className:"text-lg font-semibold mb-1",children:En[j].label}),r.jsx("p",{className:"text-sm text-base-muted mb-3",children:"This category is arriving soon. Spin again!"}),r.jsx("button",{className:"btn-primary",onClick:X,disabled:b,children:"Re-spin"})]}):r.jsxs(r.Fragment,{children:[r.jsxs("div",{className:"text-sm text-center text-base-muted mb-1",children:["Turn: ",r.jsx("span",{style:{color:s[i].color},children:s[i].name})," ","| Round ",l,"/",Cn]}),r.jsx(cv,{q:I,locked:b||!I,onPick:ne,result:Z}),Z&&r.jsx("div",{className:"mt-3 flex justify-center",children:r.jsx("button",{className:"btn-primary",onClick:re,children:"Next turn"})})]})})]}),r.jsx("div",{className:"pointer-events-none fixed inset-x-0 bottom-0 bg-[#0B0F1A]",style:{height:"calc(5.25rem + env(safe-area-inset-bottom))"},"aria-hidden":!0})]})}const uv=({onSelect:e})=>{const t=[{id:"random",emoji:"🎲",title:"Random Mix",color:"from-purple-500 to-pink-500"},{id:"trending",emoji:"📈",title:"Trending Now",color:"from-blue-500 to-cyan-500"},{id:"level",emoji:"📊",title:"Your Level",color:"from-green-500 to-teal-500"},{id:"daily",emoji:"🎯",title:"Daily Challenge",color:"from-orange-500 to-red-500"}];return r.jsxs("div",{className:"fixed inset-0 bg-gray-900 overflow-hidden flex flex-col justify-center items-center px-4",children:[r.jsx("h1",{className:"text-2xl font-bold text-white mb-20",children:"Choose a swipe mode"}),r.jsx("div",{className:"grid grid-cols-2 gap-4 w-full max-w-md h-[55vh]",children:t.map(n=>r.jsxs("button",{onClick:()=>e(n.id,n.title),className:`rounded-3xl bg-gradient-to-br ${n.color} p-6 flex flex-col items-center justify-center gap-3 transform hover:scale-105 transition-all shadow-xl`,children:[r.jsx("span",{className:"text-5xl",children:n.emoji}),r.jsx("span",{className:"text-white font-bold text-lg text-center",children:n.title})]},n.id))})]})},fv=()=>{He();const{player:e,addCoins:t,addXP:n}=jn(),[s,a]=d.useState([]),[i,o]=d.useState(0),[l,c]=d.useState({}),[u,f]=d.useState(0),[p,m]=d.useState(5),[w,x]=d.useState(0),[k,C]=d.useState(!0),[v,h]=d.useState(null),[b,E]=d.useState(!0),[j,T]=d.useState(null),[S,g]=d.useState(""),[y,N]=d.useState(!1),[R,I]=d.useState(""),[q,Z]=d.useState(!1),[H,Y]=d.useState(!1),[$,P]=d.useState(!1),[_,F]=d.useState(!1),[L,D]=d.useState(!1),[A,X]=d.useState(!1),[ne,re]=d.useState(0),[Q,M]=d.useState(0),[K,z]=d.useState(-1),[B,ee]=d.useState(-1),[ae,ce]=d.useState({}),[U,G]=d.useState({}),W=d.useRef(null),O=d.useRef(null),[te]=zt("/sounds/correct.mp3",{volume:.6}),[de]=zt("/sounds/wrong.mp3",{volume:.6}),[je]=zt("/sounds/coin.mp3",{volume:.75}),Le=["🐼","🐱","🐶","🦊","🐰","🐨","🐯","🦁","🐸","🐵"],Be=()=>{a([]),o(0),c({}),f(0),m(5),x(0),C(!0),h(null),N(!1),I(""),Z(!1),Y(!1),P(!1),F(!1),D(!1),X(!1),re(0),M(0),z(-1),ee(-1),ce({}),G({}),T(null),g(""),me(null)};d.useEffect(()=>(Be(),E(!0),()=>{document.body.classList.remove("hide-bottom-nav"),Be(),O.current&&clearTimeout(O.current)}),[]),d.useEffect(()=>{!b&&s.length>0?document.body.classList.add("hide-bottom-nav"):document.body.classList.remove("hide-bottom-nav")},[b,s.length]),d.useEffect(()=>{!b&&s.length>0&&F(!0)},[b,s.length]);const[Ee,me]=d.useState(null);d.useEffect(()=>{const J=le=>{var _e;if(_&&!$){const Se=le.target.closest('button[type="button"]'),Ve=(_e=Se==null?void 0:Se.querySelector(".text-\\[10px\\]"))==null?void 0:_e.textContent;Ve&&["Home","Play","Profile","Swipe"].includes(Ve)&&(le.preventDefault(),le.stopPropagation(),me({Home:"/",Play:"/play",Profile:"/profile",Swipe:"/swipe"}[Ve]),Y(!0))}};return document.addEventListener("click",J,!0),()=>document.removeEventListener("click",J,!0)},[_,$]),d.useEffect(()=>{const J=W.current;if(!J)return;let le=!1,_e=0,Se=null;const Ve=pe=>{!b&&s.length>0&&pe.preventDefault()},ve=pe=>{_e=pe.touches[0].clientY,le=!1},ie=pe=>{!b&&s.length>0&&!H&&!q&&pe.preventDefault()},oe=pe=>{if(le||H||q)return;const Pe=pe.changedTouches[0].clientY,xe=_e-Pe;if(Math.abs(xe)>30){if(le=!0,Se&&clearTimeout(Se),xe>0&&i<s.length-1){const Ie=i+1;o(Ie),J.scrollTo({top:Ie*window.innerHeight,behavior:"smooth"})}else if(xe<0&&i>0){const Ie=i-1;o(Ie),J.scrollTo({top:Ie*window.innerHeight,behavior:"smooth"})}Se=setTimeout(()=>{le=!1},800)}};return J.addEventListener("touchstart",ve,{passive:!1}),J.addEventListener("touchmove",ie,{passive:!1}),J.addEventListener("touchend",oe,{passive:!1}),J.addEventListener("wheel",Ve,{passive:!1}),()=>{J.removeEventListener("touchstart",ve),J.removeEventListener("touchmove",ie),J.removeEventListener("touchend",oe),J.removeEventListener("wheel",Ve),Se&&clearTimeout(Se)}},[i,s.length,b]),d.useEffect(()=>{const J=W.current;J&&(H||q?(J.style.overflow="hidden",J.style.touchAction="none"):(J.style.overflow="auto",J.style.touchAction="auto"))},[H,q]),d.useEffect(()=>{(H||q)&&O.current&&(clearTimeout(O.current),O.current=null)},[H,q]);const he=async J=>{try{const _e=await(await fetch("/data/quiz_questions_bank.csv")).text(),{data:Se}=hr.parse(_e,{header:!0,skipEmptyLines:!0}),ie=Se.map((oe,pe)=>{var Ie,it;const Pe=[oe.option1,oe.option2,oe.option3,oe.option4].filter(Boolean),xe={A:0,B:1,C:2,D:3};return{id:oe.id||`q_${pe}`,prompt:oe.question,options:Pe,answerIndex:xe[(Ie=oe.answer)==null?void 0:Ie.toUpperCase()]||0,category:oe.category||"General Knowledge",difficulty:((it=oe.difficulty)==null?void 0:it.toLowerCase())||"medium",explanation:oe.explanation||"",stats:{views:Math.floor(Math.random()*1e4)+1e3,attempted:Math.floor(Math.random()*5e3)+500,correctRate:Math.floor(Math.random()*40)+30}}}).filter(oe=>oe.prompt&&oe.options.length===4).sort(()=>Math.random()-.5).slice(0,50).map(oe=>({...oe,mascot:Le[Math.floor(Math.random()*Le.length)]}));a(ie),C(!1)}catch(le){console.error("Failed to load questions:",le),C(!1)}},be=J=>J===1||J===3||J===7||J===10||J===15||J===20||J>20&&J%5===0,ke=(J,le)=>{if(l[J]!==void 0)return;const _e=s.find(ve=>ve.id===J),Se=le===_e.answerIndex,Ve=s.findIndex(ve=>ve.id===J);if(c(ve=>({...ve,[J]:le})),re(ve=>ve+1),M(ve=>ve+1),Se){if(te(),f(ve=>ve+1),x(ve=>ve+10),X(!0),setTimeout(()=>{je()},300),setTimeout(()=>X(!1),2e3),Ue(),be(Ve+1)){const ve=["Awesome!","Perfect!","Brilliant!","Outstanding!","Incredible!"];I(ve[Math.floor(Math.random()*ve.length)]),N(!0),setTimeout(()=>N(!1),2e3)}}else if(de(),f(0),D(!0),setTimeout(()=>D(!1),1500),m(ve=>{const ie=Math.max(0,ve-1);return ie===0&&setTimeout(()=>Z(!0),500),ie}),p>1&&be(Ve+1)){const ve=["Keep trying!","You got this!","Don't give up!","Stay strong!","Keep going!"];I(ve[Math.floor(Math.random()*ve.length)]),N(!0),setTimeout(()=>N(!1),2e3)}(p>1||Se)&&(O.current=setTimeout(()=>{qt()},2500))},Ue=()=>{const J=document.createElement("div");J.style.position="fixed",J.style.inset="0",J.style.pointerEvents="none",J.style.zIndex="1000",document.body.appendChild(J);const le=["🎉","✨","⭐","🎊","🌟"];for(let _e=0;_e<20;_e++){const Se=document.createElement("div");Se.textContent=le[Math.floor(Math.random()*le.length)],Se.style.position="fixed",Se.style.left=`${Math.random()*100}%`,Se.style.top="-50px",Se.style.fontSize="24px",Se.style.animation=`fall ${2+Math.random()*2}s ease-out`,J.appendChild(Se)}setTimeout(()=>J.remove(),4e3)},qt=()=>{if(!(H||q)&&i<s.length-1){const J=i+1,le=document.getElementById(`question-${J}`);le==null||le.scrollIntoView({behavior:"smooth"}),o(J)}},et=J=>{const le=s.findIndex(ve=>ve.id===J);if(K>=0&&ne<5){h(`After ${5-ne} attempts`),setTimeout(()=>h(null),2e3);return}const _e=s[le],Ve=[0,1,2,3].filter(ve=>ve!==_e.answerIndex).sort(()=>Math.random()-.5).slice(0,2);ce({...ae,[J]:Ve}),z(le),re(0)},we=J=>{const le=s.findIndex(pe=>pe.id===J);if(B>=0&&Q<5){h(`After ${5-Q} attempts`),setTimeout(()=>h(null),2e3);return}const Se=s[le].answerIndex,Ve=[0,0,0,0],ve=40+Math.floor(Math.random()*31);Ve[Se]=ve;let ie=100-ve;const oe=[0,1,2,3].filter(pe=>pe!==Se);for(let pe=0;pe<oe.length-1;pe++){const Pe=Math.floor(Math.random()*(ie/2));Ve[oe[pe]]=Pe,ie-=Pe}Ve[oe[oe.length-1]]=ie,G({...U,[J]:Ve}),ee(le),M(0)},Ae=(J,le)=>{Be(),T(J),g(le),E(!1),he()},Qt=()=>{me("/swipe"),Y(!0)},Gn=()=>{P(!0),Y(!1),document.body.classList.remove("hide-bottom-nav")},Ge=()=>{const J=Object.keys(l).filter(le=>{const _e=s.find(Se=>Se.id===le);return l[le]===(_e==null?void 0:_e.answerIndex)}).length;return d.useEffect(()=>{document.body.classList.add("hide-bottom-nav");const le=setTimeout(()=>{t(w),Be(),F(!1),P(!1),E(!0),document.body.classList.remove("hide-bottom-nav")},2e3);return()=>{clearTimeout(le),document.body.classList.remove("hide-bottom-nav")}},[]),r.jsx("div",{className:"fixed inset-0 bg-gray-900 z-50 flex items-center justify-center p-4",children:r.jsxs("div",{className:"bg-gray-800 rounded-3xl p-8 max-w-md w-full text-center border border-gray-700",children:[r.jsx("div",{className:"text-5xl mb-4",children:"🎉"}),r.jsx("h2",{className:"text-2xl font-bold text-white mb-4",children:"Session Complete!"}),r.jsxs("div",{className:"space-y-4",children:[r.jsxs("div",{className:"bg-gray-700/50 rounded-xl p-4",children:[r.jsx("div",{className:"text-gray-400 text-sm mb-1",children:"Questions Answered"}),r.jsx("div",{className:"text-2xl font-bold text-white",children:Object.keys(l).length})]}),r.jsxs("div",{className:"bg-gray-700/50 rounded-xl p-4",children:[r.jsx("div",{className:"text-gray-400 text-sm mb-1",children:"Correct Answers"}),r.jsx("div",{className:"text-2xl font-bold text-green-400",children:J})]}),r.jsxs("div",{className:"bg-gray-700/50 rounded-xl p-4",children:[r.jsx("div",{className:"text-gray-400 text-sm mb-1",children:"Coins Earned"}),r.jsxs("div",{className:"text-2xl font-bold text-yellow-400",children:["🪙 ",w]})]}),r.jsxs("div",{className:"bg-gray-700/50 rounded-xl p-4",children:[r.jsx("div",{className:"text-gray-400 text-sm mb-1",children:"Lives Remaining"}),r.jsx("div",{className:"text-2xl font-bold text-red-400",children:Array.from({length:5},(le,_e)=>r.jsx("span",{className:_e<p?"":"opacity-30",children:"❤️"},_e))})]})]})]})})};return $?r.jsx(Ge,{}):b?r.jsx(uv,{onSelect:Ae}):k?r.jsx("div",{className:"h-screen bg-gray-900 flex items-center justify-center",children:r.jsx("div",{className:"text-white",children:"Loading questions..."})}):r.jsxs("div",{className:"h-screen bg-gray-900 relative",children:[r.jsxs("div",{className:"fixed top-0 left-0 right-0 bg-gray-900/95 backdrop-blur z-50 border-b border-gray-800 pt-12",children:[r.jsxs("div",{className:"flex items-center justify-between px-4 py-3",children:[r.jsx("button",{onClick:Qt,className:"inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md border border-white/15 rounded-xl text-white text-sm font-medium hover:bg-white/15 transition-all",children:"← Back"}),r.jsxs("div",{className:"flex items-center gap-4",children:[r.jsxs("div",{className:"flex items-center gap-1 bg-yellow-500/20 px-3 py-1 rounded-full",children:[r.jsx("span",{children:"🪙"}),r.jsx("span",{className:"font-bold text-yellow-400",children:w})]}),r.jsxs("div",{className:"flex items-center gap-1 bg-orange-500/20 px-3 py-1 rounded-full",children:[r.jsx("span",{children:"🔥"}),r.jsx("span",{className:"font-bold text-orange-400",children:u})]})]}),r.jsx("div",{className:"flex items-center gap-1",children:Array.from({length:5},(J,le)=>r.jsx("span",{className:`${le<p?"text-red-500":"text-gray-600 opacity-30"} ${L&&le===p-1?"animate-heartLoss":""}`,children:"❤️"},le))})]}),S&&r.jsx("div",{className:"text-center py-1",children:r.jsx("span",{className:"text-xs text-gray-400",children:S})})]}),A&&r.jsx("div",{className:"fixed top-24 left-1/2 transform -translate-x-1/2 z-50 pointer-events-none",children:r.jsx("div",{className:"bg-yellow-500 text-white px-4 py-2 rounded-full font-bold animate-coinFloat",children:"+10 🪙"})}),r.jsx("div",{ref:W,className:"h-full overflow-y-hidden snap-y snap-mandatory pt-32",style:{scrollBehavior:"smooth",overscrollBehavior:"none",WebkitOverflowScrolling:"touch",touchAction:"none"},children:s.map((J,le)=>r.jsx(mv,{question:J,index:le,answered:l[J.id],onAnswer:_e=>ke(J.id,_e),onFiftyFifty:()=>et(J.id),onAudience:()=>we(J.id),eliminated:ae[J.id]||[],audiencePercentages:U[J.id],canUseFiftyFifty:K<0||ne>=5,canUseAudience:B<0||Q>=5},J.id))}),q&&r.jsx("div",{className:"fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4",children:r.jsxs("div",{className:"bg-gray-800 rounded-3xl p-6 max-w-sm w-full text-center border border-gray-700",children:[r.jsx("div",{className:"text-5xl mb-4",children:"😔"}),r.jsx("h3",{className:"text-xl font-bold mb-2 text-white",children:"No Lives Left!"}),r.jsx("p",{className:"text-gray-400 mb-6",children:"Sorry, you have no lives left to continue swiping."}),r.jsx("button",{onClick:()=>{P(!0),document.body.classList.remove("hide-bottom-nav")},className:"w-full bg-gradient-to-r from-blue-600 to-purple-600 py-3 rounded-xl text-white font-medium",children:"View Results"})]})}),H&&r.jsx("div",{className:"fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4",children:r.jsxs("div",{className:"bg-gray-800 rounded-3xl p-6 max-w-sm w-full text-center border border-gray-700",children:[r.jsx("div",{className:"text-4xl mb-4",children:"🤔"}),r.jsx("h3",{className:"text-xl font-bold mb-2 text-white",children:"Leave Swipe Mode?"}),r.jsx("p",{className:"text-gray-400 mb-6",children:"Your progress will be saved"}),r.jsxs("div",{className:"flex gap-3",children:[r.jsx("button",{onClick:()=>Y(!1),className:"flex-1 bg-blue-600 hover:bg-blue-700 py-3 rounded-xl font-medium text-white",children:"Stay"}),r.jsx("button",{onClick:Gn,className:"flex-1 bg-gray-700 hover:bg-gray-600 py-3 rounded-xl font-medium text-white",children:"Leave"})]})]})}),y&&r.jsx("div",{className:"fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50",children:r.jsx("div",{className:"bg-gradient-to-br from-purple-600 to-pink-600 px-8 py-6 rounded-3xl text-white font-bold text-2xl shadow-2xl animate-fadeIn",children:R})}),v&&r.jsx("div",{className:"fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 pointer-events-none",children:r.jsx("div",{className:"bg-gray-800/90 px-6 py-3 rounded-full text-white font-bold animate-fadeIn",children:v})}),r.jsx("style",{jsx:!0,children:`
        @keyframes fadeIn {
  ...
  `,c=a.required>0?a.current/a.required*100:0;return r.jsxs("div",{className:"min-h-full bg-[#0B0C10] text-white pt-10 px-3",children:[r.jsxs("div",{className:"mb-6",children:[r.jsxs("div",{className:"flex items-center justify-between mb-4",children:[r.jsx("div",{children:r.jsxs("h1",{className:"text-2xl font-bold px-3",children:[t,", ",(s==null?void 0:s.name)||"Player"," 👋"]})}),r.jsx("button",{onClick:()=>e("/profile/settings"),className:"w-10 h-10 rounded-2xl bg-white/10 border border-white/20 grid place-items-center hover:bg-white/20 transition",children:r.jsx("span",{className:"text-xl",children:"⚙️"})})]}),r.jsxs("div",{className:"rounded-3xl bg-gradient-to-r from-slate-800/50 to-slate-900/50 border border-white/10 p-4 backdrop-blur-sm",children:[r.jsxs("div",{className:"flex items-center gap-4 mb-3",children:[r.jsx("div",{className:"w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 grid place-items-center text-2xl font-bold",children:o.name[0]}),r.jsxs("div",{className:"flex-1",children:[r.jsx("div",{className:"text-lg font-semibold",children:s.name||"Player"}),r.jsxs("div",{className:"text-white/60 text-sm",children:["Level ",s.level]})]}),r.jsxs("div",{className:"text-right",children:[r.jsxs("div",{className:"text-yellow-400 font-bold text-lg",children:[s.coins," 🪙"]}),r.jsxs("div",{className:"text-white/60 text-sm",children:["Rank #",o.rank]})]})]}),r.jsxs("div",{className:"mb-3",children:[r.jsxs("div",{className:"flex justify-between text-xs text-white/60 mb-1",children:[r.jsx("span",{children:"XP Progress"}),r.jsxs("span",{children:[a.current,"/",a.required]})]}),r.jsx("div",{className:"h-2 bg-white/10 rounded-full overflow-hidden",children:r.jsx("div",{className:"h-full bg-gradient-to-r from-blue-400 to-purple-500 rounded-full transition-all duration-1000 ease-out",style:{width:`${c}%`}})})]}),r.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[r.jsxs("div",{className:"text-center p-2 rounded-xl bg-white/5",children:[r.jsxs("div",{className:"text-orange-400 font-bold text-lg",children:["🔥 ",o.streak]}),r.jsx("div",{className:"text-white/60 text-xs",children:"Day Streak"})]}),r.jsxs("div",{className:"text-center p-2 rounded-xl bg-white/5",children:[r.jsxs("div",{className:"text-green-400 font-bold text-lg",children:["+",o.todayCoins]}),r.jsx("div",{className:"text-white/60 text-xs",children:"Today"})]})]})]})]}),r.jsxs("button",{onClick:()=>e("/profile/leaderboard"),className:`${l} w-full mb-4 bg-gradient-to-br from-[#5AA9FF] via-[#6C63FF] to-[#9C6BFF]`,children:[r.jsx("div",{className:"absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -translate-y-8 translate-x-8 animate-pulse"}),r.jsxs("div",{className:"relative flex items-start justify-between",children:[r.jsxs("div",{children:[r.jsx("div",{className:"text-xs opacity-90 mb-1",children:"🏆 Rank & Coins"}),r.jsx("div",{className:"text-3xl font-extrabold tracking-tight mb-2",children:"LEADERBOARD"}),r.jsxs("div",{className:"text-xs opacity-75 flex items-center gap-2",children:[r.jsx("span",{className:"w-2 h-2 bg-green-400 rounded-full animate-pulse"}),"Weekly reset · Ends in 2d 14h"]})]}),r.jsx("div",{className:"w-16 h-16 rounded-2xl bg-white/20 backdrop-blur-sm grid place-items-center text-2xl border border-white/30",children:"🏆"})]})]}),r.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[r.jsxs("button",{onClick:()=>e("/profile/history"),className:`${l} bg-gradient-to-br from-[#D19A00] to-[#C94B4B] relative`,children:[r.jsx("div",{className:"absolute top-2 right-2 w-3 h-3 bg-white/20 rounded-full"}),r.jsx("div",{className:"text-3xl mb-3",children:"📊"}),r.jsx("div",{className:"text-sm font-bold mb-1",children:"HISTORY"}),r.jsx("div",{className:"text-[11px] opacity-80",children:"Quizzes & Practice"}),r.jsxs("div",{className:"text-[10px] opacity-60 mt-1",children:["+",o.todayQuizzes," today"]})]}),r.jsxs("button",{onClick:()=>e("/profile/rewards"),className:`${l} bg-gradient-to-br from-[#2EB872] to-[#1EA07A] relative`,children:[r.jsx("div",{className:"absolute top-2 right-2 w-2 h-2 bg-red-500 rounded-full animate-bounce"}),r.jsx("div",{className:"text-3xl mb-3",children:"🎁"}),r.jsx("div",{className:"text-sm font-bold mb-1",children:"REWARDS"}),r.jsx("div",{className:"text-[11px] opacity-80",children:"Claim & Redeem"}),r.jsx("div",{className:"text-[10px] opacity-60 mt-1",children:"2 available"})]}),r.jsxs("button",{onClick:()=>e("/profile/badges"),className:`${l} bg-gradient-to-br from-[#E65C00] to-[#F9D423] relative`,children:[r.jsx("div",{className:"absolute -top-1 -right-1 w-6 h-6 bg-purple-600 rounded-full grid place-items-center text-[10px] font-bold animate-pulse",children:"NEW"}),r.jsx("div",{className:"text-3xl mb-3",children:"🏅"}),r.jsx("div",{className:"text-sm font-bold mb-1",children:"BADGES"}),r.jsx("div",{className:"text-[11px] opacity-80",children:"Collectables"}),r.jsx("div",{className:"text-[10px] opacity-60 mt-1",children:"4/15 unlocked"})]}),r.jsxs("button",{onClick:()=>e("/profile/achievements"),className:`${l} bg-gradient-to-br from-[#5D26C1] to-[#A17FE0] relative`,children:[r.jsx("div",{className:"text-3xl mb-3",children:"🎯"}),r.jsx("div",{className:"text-sm font-bold mb-1",children:"ACHIEVEMENTS"}),r.jsx("div",{className:"text-[11px] opacity-80",children:"Milestones"}),r.jsx("div",{className:"text-[10px] opacity-60 mt-1",children:"67% complete"})]})]}),r.jsxs("div",{className:"mt-4 space-y-3",children:[r.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[r.jsx("button",{onClick:()=>e("/profile/streaks"),className:`${l} bg-gradient-to-r from-orange-600/80 to-red-600/80 backdrop-blur-sm border border-orange-500/30`,children:r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsx("div",{className:"text-2xl",children:"🔥"}),r.jsxs("div",{children:[r.jsx("div",{className:"text-sm font-bold",children:"STREAK"}),r.jsxs("div",{className:"text-[11px] opacity-80",children:[o.streak," days strong"]})]})]})}),r.jsx("button",{onClick:()=>e("/profile/quests"),className:`${l} bg-gradient-to-r from-blue-600/80 to-cyan-600/80 backdrop-blur-sm border border-blue-500/30`,children:r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsx("div",{className:"text-2xl",children:"⚡"}),r.jsxs("div",{children:[r.jsx("div",{className:"text-sm font-bold",children:"QUESTS"}),r.jsx("div",{className:"text-[11px] opacity-80",children:"2 active goals"})]})]})})]}),r.jsx("button",{onClick:()=>e("/profile/settings"),className:`${l} w-full bg-gradient-to-r from-slate-700/50 to-slate-800/50 backdrop-blur-sm border border-white/10`,children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{className:"flex items-center gap-4",children:[r.jsx("div",{className:"w-12 h-12 rounded-2xl bg-white/10 grid place-items-center text-xl",children:"⚙️"}),r.jsxs("div",{children:[r.jsx("div",{className:"text-sm font-bold",children:"SETTINGS"}),r.jsx("div",{className:"text-[11px] opacity-70",children:"Customize your experience"})]})]}),r.jsx("div",{className:"text-white/40",children:"→"})]})})]}),r.jsx("div",{className:"h-6"})]})}const ls="🪙",ma={global:[{rank:1,name:"Bryan Wolf",handle:"@bryan",score:43,avatar:"/profile/rank1.png",trend:"+5",streak:12,country:"🇺🇸"},{rank:2,name:"Meghan Jess…",handle:"@meghan",score:40,avatar:"/profile/rank2.png",trend:"+2",streak:8,country:"🇨🇦"},{rank:3,name:"Alex Turner",handle:"@alex",score:38,avatar:"/profile/rank3.png",trend:"±0",streak:15,country:"🇬🇧"},{rank:4,name:"Marsha Fisher",handle:"@marsha",score:36,trend:"-1",streak:5,country:"🇦🇺"},{rank:5,name:"Juanita Cormier",handle:"@juanita",score:35,trend:"+1",streak:3,country:"🇲🇽"},{rank:6,name:"You",handle:"@you",score:34,you:!0,avatar:"/profile/avatar.png",trend:"+3",streak:7,country:"🇮🇳"},{rank:7,name:"Tamara Schmidt",handle:"@tamara",score:33,trend:"-2",streak:2,country:"🇩🇪"},{rank:8,name:"Ricardo Veum",handle:"@ricardo",score:32,trend:"+1",streak:4,country:"🇧🇷"}],friends:[{rank:1,name:"You",handle:"@you",score:34,you:!0,avatar:"/profile/avatar.png",trend:"+2",streak:7,country:"🇮🇳"},{rank:2,name:"Sarah Chen",handle:"@sarah",score:31,trend:"-1",streak:4,country:"🇸🇬",friend:!0},{rank:3,name:"Mike Johnson",handle:"@mike",score:29,trend:"+3",streak:2,country:"🇺🇸",friend:!0},{rank:4,name:"Priya Sharma",handle:"@priya",score:27,trend:"±0",streak:5,country:"🇮🇳",friend:!0},{rank:5,name:"David Kim",handle:"@david",score:25,trend:"+1",streak:3,country:"🇰🇷",friend:!0},{rank:6,name:"Emma Wilson",handle:"@emma",score:23,trend:"-2",streak:1,country:"🇬🇧",friend:!0}],india:[{rank:1,name:"Rohit Sharma",handle:"@rohit",score:45,trend:"+4",streak:10,country:"🇮🇳"},{rank:2,name:"Priya Patel",handle:"@priya",score:42,trend:"+1",streak:8,country:"🇮🇳"},{rank:3,name:"You",handle:"@you",score:34,you:!0,avatar:"/profile/avatar.png",trend:"+3",streak:7,country:"🇮🇳"},{rank:4,name:"Arjun Singh",handle:"@arjun",score:32,trend:"-1",streak:5,country:"🇮🇳"},{rank:5,name:"Kavya Reddy",handle:"@kavya",score:30,trend:"+2",streak:3,country:"🇮🇳"},{rank:6,name:"Vikram Gupta",handle:"@vikram",score:28,trend:"±0",streak:4,country:"🇮🇳"}]},ha=[{name:"Diamond",min:40,color:"from-cyan-400 to-blue-600",icon:"💎"},{name:"Gold",min:30,color:"from-yellow-400 to-orange-500",icon:"🥇"},{name:"Silver",min:20,color:"from-gray-300 to-gray-500",icon:"🥈"},{name:"Bronze",min:10,color:"from-orange-600 to-red-600",icon:"🥉"}];function gv(){var m,w;const e=He(),{player:t}=jn(),n={global:ma.global.map(x=>x.you?{...x,name:(t==null?void 0:t.name)||"You",score:(t==null?void 0:t.coins)||0,streak:(t==null?void 0:t.currentStreak)||0}:x),friends:ma.friends.map(x=>x.you?{...x,name:(t==null?void 0:t.name)||"You",score:(t==null?void 0:t.coins)||0,streak:(t==null?void 0:t.currentStreak)||0}:x),india:ma.india.map(x=>x.you?{...x,name:(t==null?void 0:t.name)||"You",score:(t==null?void 0:t.coins)||0,streak:(t==null?void 0:t.currentStreak)||0}:x)};console.log("Debug - Player coins:",t==null?void 0:t.coins),console.log("Debug - Friends data:",n.friends[0]);const[s,a]=d.useState({days:2,hours:14,minutes:17}),[i,o]=d.useState("global"),l=n[i]||n.global;console.log("Player coins:",t==null?void 0:t.coins,"Current user score:",(m=l.find(x=>x.you))==null?void 0:m.score);const c=l.find(x=>x.you),u=l.slice(0,3),f=l.slice(3);d.useEffect(()=>{const x=k=>{k.preventDefault(),e(-1)};return window.addEventListener("popstate",x),()=>{window.removeEventListener("popstate",x)}},[e]),d.useEffect(()=>{const x=setInterval(()=>{a(k=>k.minutes>0?{...k,minutes:k.minutes-1}:k.hours>0?{...k,hours:k.hours-1,minutes:59}:k.days>0?{...k,days:k.days-1,hours:23,minutes:59}:k)},6e4);return()=>clearInterval(x)},[]);const p=x=>{const k=Math.max(...l.map(v=>v.score)),C=x/k*100;return C>=90?ha[0]:C>=70?ha[1]:C>=40?ha[2]:ha[3]};return r.jsxs("div",{className:"min-h-screen bg-black text-white pt-12",children:[r.jsxs("div",{className:"flex items-center justify-between mb-5",children:[r.jsx("button",{onClick:()=>e("/profile",{replace:!0}),className:"px-3 py-1.5 rounded-xl border border-white/10 bg-white/5 text-sm hover:bg-white/10 transition",children:"← Back"}),r.jsxs("div",{className:"text-center",children:[r.jsx("div",{className:"text-lg font-bold",children:"🏆 Leaderboard"}),r.jsxs("div",{className:"text-xs text-white/60",children:["Ends in ",s.days,"d ",s.hours,"h ",s.minutes,"m"]})]}),r.jsx("button",{className:"px-3 py-1.5 rounded-xl border border-white/10 bg-white/5 text-sm hover:bg-white/10 transition",children:"📊"})]}),r.jsxs("div",{className:`mb-5 rounded-2xl bg-gradient-to-r ${p(c==null?void 0:c.score).color} p-4 text-center relative overflow-hidden`,children:[r.jsx("div",{className:"absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -translate-y-10 translate-x-10 animate-pulse"}),r.jsx("div",{className:"absolute bottom-0 left-0 w-16 h-16 bg-white/5 rounded-full translate-y-8 -translate-x-8"}),r.jsxs("div",{className:"relative z-10",children:[r.jsx("div",{className:"text-2xl mb-1",children:p(c==null?void 0:c.score).icon}),r.jsxs("div",{className:"text-sm font-bold text-white",children:[p(c==null?void 0:c.score).name," League"]}),r.jsx("div",{className:"text-xs text-white/80",children:i==="friends"?"Competing with friends!":"You're competing with the best!"})]})]}),r.jsx("div",{className:"flex gap-2 mb-5",children:[{key:"global",label:"🌍 Global",count:"10M+"},{key:"friends",label:"👥 Friends",count:ma.friends.length},{key:"india",label:"🇮🇳 India",count:"2.5M"}].map(x=>r.jsxs("button",{onClick:()=>o(x.key),className:`flex-1 px-2 py-2 rounded-xl text-xs font-semibold transition-all duration-300 ${i===x.key?"bg-lime-500 text-black shadow-lg scale-105":"border border-white/10 bg-white/5 hover:bg-white/10"}`,children:[r.jsx("div",{children:x.label}),r.jsx("div",{className:`text-[10px] ${i===x.key?"text-black/70":"text-white/60"}`,children:x.count})]},x.key))}),r.jsx("div",{className:"mb-5 rounded-2xl bg-gradient-to-r from-lime-500/20 to-green-500/20 border border-lime-500/30 p-3",children:r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsxs("div",{className:"flex items-center gap-3",children:[r.jsx("div",{className:"w-10 h-10 rounded-xl bg-lime-500/20 grid place-items-center text-lg",children:"🧑‍💻"}),r.jsxs("div",{children:[r.jsx("div",{className:"font-bold text-lime-400 text-sm",children:"Your Position"}),r.jsxs("div",{className:"text-xs text-white/70 flex items-center gap-2",children:[r.jsxs("span",{children:["Rank #",c==null?void 0:c.rank]}),r.jsx("span",{className:`px-1.5 py-0.5 rounded-full text-[9px] font-bold ${c!=null&&c.trend.startsWith("+")?"bg-green-500/20 text-green-400":c!=null&&c.trend.startsWith("-")?"bg-red-500/20 text-red-400":"bg-gray-500/20 text-gray-400"}`,children:c==null?void 0:c.trend}),r.jsxs("span",{className:"text-white/50 text-[10px]",children:["in ",i==="global"?"Global":i==="friends"?"Friends":"India"]})]})]})]}),r.jsxs("div",{className:"text-right",children:[r.jsxs("div",{className:"text-lg font-bold text-lime-400",children:[c==null?void 0:c.score," ",ls]}),r.jsxs("div",{className:"text-xs text-white/60",children:["🔥 ",c==null?void 0:c.streak," streak"]})]})]})}),r.jsxs("div",{className:"mb-6",children:[r.jsx("h3",{className:"text-center text-sm font-semibold text-white/80 mb-4",children:"👑 Hall of Fame"}),r.jsxs("div",{className:"bg-gradient-to-b from-white/5 to-white/10 rounded-2xl p-4 border border-white/10 relative overflow-hidden",children:[r.jsx("div",{className:"absolute top-4 left-6 text-2xl opacity-40 animate-pulse",children:"🏆"}),r.jsx("div",{className:"absolute top-8 right-8 text-lg opacity-40 animate-bounce",style:{animationDelay:"1s"},children:"✨"}),r.jsx("div",{className:"absolute bottom-6 left-12 text-xl opacity-10 animate-pulse",style:{animationDelay:"2s"},children:"🥇"}),r.jsx("div",{className:"absolute bottom-4 right-6 text-lg opacity-40 animate-bounce",style:{animationDelay:"0.5s"},children:"⭐"}),r.jsxs("div",{className:"flex items-end justify-center gap-8 relative z-10",children:[u[1]&&r.jsxs("div",{className:"flex flex-col items-center",children:[r.jsxs("div",{className:"relative mb-2",children:[r.jsx(pa,{src:u[1].avatar,fallback:u[1].name,size:56}),r.jsx("div",{className:"absolute -bottom-1 left-1/2 -translate-x-1/2 w-7 h-7 bg-gradient-to-br from-gray-300 to-gray-500 rounded-full grid place-items-center text-sm font-bold text-black shadow-lg",children:"2"})]}),r.jsx("div",{className:"text-sm font-semibold mb-1 mt-1",children:xa(u[1].name,8)}),r.jsxs("div",{className:"text-xs text-lime-400 font-bold",children:[u[1].score," ",ls]})]}),u[0]&&r.jsxs("div",{className:"flex flex-col items-center -mb-3",children:[r.jsxs("div",{className:"relative mb-2",children:[r.jsx(pa,{src:u[0].avatar,fallback:u[0].name,size:72}),r.jsx("div",{className:"absolute -top-3 left-1/2 -translate-x-1/2",children:r.jsx(vv,{})}),r.jsx("div",{className:"absolute -bottom-1 left-1/2 -translate-x-1/2 w-8 h-8 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full grid place-items-center text-base font-bold text-black shadow-lg animate-pulse",children:"1"})]}),r.jsx("div",{className:"text-sm font-bold mb-1 mt-1",children:xa(u[0].name,8)}),r.jsxs("div",{className:"text-sm text-lime-400 font-bold mb-1",children:[u[0].score," ",ls]}),r.jsx("div",{className:"px-2 py-1 bg-yellow-400/20 rounded-full text-[9px] text-yellow-400 font-bold",children:"CHAMPION"})]}),u[2]&&r.jsxs("div",{className:"flex flex-col items-center",children:[r.jsxs("div",{className:"relative mb-2",children:[r.jsx(pa,{src:u[2].avatar,fallback:u[2].name,size:56}),r.jsx("div",{className:"absolute -bottom-1 left-1/2 -translate-x-1/2 w-7 h-7 bg-gradient-to-br from-orange-600 to-red-600 rounded-full grid place-items-center text-sm font-bold text-white shadow-lg",children:"3"})]}),r.jsx("div",{className:"text-sm font-semibold mb-1 mt-1",children:xa(u[2].name,8)}),r.jsxs("div",{className:"text-xs text-lime-400 font-bold",children:[u[2].score," ",ls]})]})]})]})]}),f.length>0&&r.jsxs("div",{className:"rounded-3xl bg-white/5 border border-white/10 p-2 mb-4",children:[r.jsxs("div",{className:"flex justify-between items-center mb-2 px-2",children:[r.jsx("h3",{className:"text-sm font-semibold",children:"Rankings"}),r.jsx("div",{className:"text-xs text-white/60",children:"Live updates"})]}),r.jsx("ul",{className:"space-y-1.5",children:f.map((x,k)=>r.jsxs("li",{className:`flex items-center justify-between px-3 py-2.5 rounded-xl transition-all duration-300 ${x.you?"bg-lime-500/90 text-black shadow-lg shadow-lime-500/20 scale-[1.02]":"bg-white/5 hover:bg-white/10"}`,style:{animationDelay:`${k*100}ms`,animation:"fadeInUp 0.6s ease-out forwards"},children:[r.jsxs("div",{className:"flex items-center gap-2.5",children:[r.jsx(yv,{n:x.rank,you:x.you}),r.jsx(pa,{src:x.avatar,fallback:x.name,size:36}),r.jsxs("div",{className:"flex flex-col leading-tight",children:[r.jsxs("div",{className:"flex items-center gap-2",children:[r.jsx("span",{className:"text-sm font-semibold",children:xa(x.name,12)}),r.jsx("span",{className:"text-xs",children:x.country}),x.friend&&r.jsx("span",{className:"text-[9px] bg-blue-500/20 text-blue-400 px-1 py-0.5 rounded-full",children:"Friend"})]}),r.jsxs("div",{className:`text-xs flex items-center gap-1.5 ${x.you?"text-black/70":"text-white/60"}`,children:[r.jsx("span",{children:x.handle}),r.jsxs("span",{children:["🔥",x.streak]})]})]})]}),r.jsxs("div",{className:"flex flex-col items-end",children:[r.jsxs("div",{className:"flex items-center gap-1 text-sm font-bold",children:[r.jsx("span",{children:x.score}),r.jsx("span",{className:x.you?"opacity-90":"opacity-80",children:ls})]}),r.jsx("div",{className:`text-xs px-1.5 py-0.5 rounded-full font-bold ${x.trend.startsWith("+")?"bg-green-500/20 text-green-400":x.trend.startsWith("-")?"bg-red-500/20 text-red-400":"bg-gray-500/20 text-gray-400"}`,children:x.trend})]})]},`${i}-${x.rank}`))})]}),c&&c.rank>1&&r.jsxs("div",{className:"mb-4 p-3 rounded-2xl bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 text-center",children:[r.jsx("div",{className:"text-sm font-semibold mb-2",children:"🚀 Climb Higher!"}),r.jsx("div",{className:"text-xs text-white/70 mb-3",children:i==="friends"&&c.rank===1?"🎉 You're #1 among friends!":`You need ${Math.max(0,(((w=l[c.rank-2])==null?void 0:w.score)||0)-c.score+1)} more coins to reach rank #${c.rank-1}`}),!(i==="friends"&&c.rank===1)&&r.jsx("button",{onClick:()=>e("/play"),className:"px-5 py-2 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl text-sm font-bold hover:scale-105 transition-transform",children:"Play Now 🎮"})]}),r.jsx("style",{jsx:!0,children:`
      ...
      `})]})}function pa({src:e,fallback:t,size:n=56}){const s=bv(t);return r.jsx("div",{className:"grid place-items-center rounded-full bg-white/10 overflow-hidden border-2 border-white/20",style:{width:n,height:n},children:e?r.jsx("img",{src:e,alt:"",className:"w-full h-full object-cover"}):r.jsx("span",{className:"text-sm font-semibold",children:s})})}function vv(){return r.jsxs("div",{className:"w-7 h-5 bg-gradient-to-t from-yellow-400 to-yellow-300 rounded-b-lg shadow-lg relative",children:[r.jsxs("svg",{viewBox:"0 0 100 40",className:"w-full h-full",children:[r.jsx("path",{d:"M15,35 L15,18 L35,28 L50,10 L65,28 L85,18 L85,35 Z",fill:"url(#crownGradient)"}),r.jsx("defs",{children:r.jsxs("linearGradient",{id:"crownGradient",x1:"0%",y1:"0%",x2:"0%",y2:"100%",children:[r.jsx("stop",{offset:"0%",stopColor:"#FCD34D"}),r.jsx("stop",{offset:"100%",stopColor:"#F59E0B"})]})})]}),r.jsx("div",{className:"absolute top-0.5 left-1/2 -translate-x-1/2 w-1 h-1 bg-red-400 rounded-full animate-pulse"})]})}function yv({n:e,you:t}){return r.jsx("div",{className:`w-7 h-7 grid place-items-center rounded-full text-sm font-bold ${t?"bg-black/10 text-black":"bg-white/10 text-white"}`,children:e})}function xa(e,t=12){return(e==null?void 0:e.length)>t?e.slice(0,t-1)+"…":e}function bv(e=""){var n;const t=e.trim().split(/\s+/);return t.length===1?t[0].slice(0,2).toUpperCase():(t[0][0]+(((n=t[1])==null?void 0:n[0])||"")).toUpperCase()}const wv="qp_recent",jv="qp_review_snapshot",Qd=[{id:Date.now()-864e5,type:"quiz",category:"General Knowledge",difficulty:"easy",score:8,total:10,accuracy:80,time:"02:31",ms:151e3,date:"Yesterday",timestamp:Date.now()-864e5,mode:"Quiz"},{id:Date.now()-1728e5,type:"practice",category:"Science",difficulty:"medium",score:12,total:15,accuracy:80,time:"06:02",ms:362e3,date:"2 days ago",timestamp:Date.now()-1728e5,mode:"Practice"},{id:Date.now()-2592e5,type:"quiz",category:"Fun Facts",difficulty:"easy",score:9,total:10,accuracy:90,time:"02:05",ms:125e3,date:"3 days ago",timestamp:Date.now()-2592e5,mode:"Quiz"}];function Nv(){const[e,t]=d.useState("quizzes"),[n,s]=d.useState(null),[a,i]=d.useState(!1),[o,l]=d.useState("all"),[c,u]=d.useState("all"),[f,p]=d.useState("date"),[m,w]=d.useState([]),[x,k]=d.useState(!0),C=He(),v=S=>{if(!S)return"00:00";const g=Math.floor(S/1e3),y=Math.floor(g/60),N=g%60;return`${String(y).padStart(2,"0")}:${String(N).padStart(2,"0")}`},h=S=>{if(!S)return"Unknown";const g=new Date(S),N=Math.floor((new Date-g)/(1e3*60*60*24));return N===0?"Today":N===1?"Yesterday":N<7?`${N} days ago`:`${["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][g.getMonth()]} ${g.getDate()}`};d.useEffect(()=>{let S=!1;k(!0);const g=R=>{try{return JSON.parse(R)}catch{return null}},y=R=>encodeURIComponent(String(R).trim().toLowerCase().replace(/\s+/g,"-")),N=R=>{var L,D,A,X;const I=Number(R.ts??R.timestamp??R.id)||Date.now(),q=Number(R.ms)||0,Z=Number(R.total)||0,H=Number(R.correct)||0,$=String(R.mode||"").toLowerCase().includes("practice")?"practice":"quiz",P=((L=R.snapshot)==null?void 0:L.category)||((D=R.snapshot)==null?void 0:D.categoryLabel)||R.cat||R.category||"Unknown",_=((A=R.snapshot)==null?void 0:A.categoryParam)||y(P),F=String(((X=R.snapshot)==null?void 0:X.difficulty)||R.difficulty||"medium").toLowerCase();return{id:R.id??I,type:$,category:P,categoryParam:_,difficulty:F,score:H,total:Z,accuracy:Z?Math.round(H/Z*100):0,time:v(q),ms:q,date:h(I),timestamp:I,snapshot:R.snapshot??null,mode:R.mode||($==="practice"?"Practice":"Quiz")}};try{const R=localStorage.getItem(wv),I=R?g(R):null,Z=(Array.isArray(I)&&I.length?I:Qd).map(N).filter(H=>H&&H.timestamp).sort((H,Y)=>Y.timestamp-H.timestamp);S||w(Z)}catch(R){console.error("Error loading history:",R),S||w(Qd)}finally{S||k(!1)}return()=>{S=!0}},[]);const b=d.useMemo(()=>{const S=new Set(m.map(g=>g.category));return Array.from(S)},[m]),E=d.useMemo(()=>{let S=m.filter(g=>e==="quizzes"?g.type==="quiz":g.type==="practice");return o!=="all"&&(S=S.filter(g=>g.category===o)),c!=="all"&&(S=S.filter(g=>g.difficulty===c)),S.sort((g,y)=>f==="date"?y.timestamp-g.timestamp:f==="score"?y.accuracy-g.accuracy:f==="time"?g.ms-y.ms:0),S},[m,e,o,c,f]),j=d.useMemo(()=>{if(E.length===0)return null;const S=E.reduce((R,I)=>R+I.score,0),g=E.reduce((R,I)=>R+I.total,0),y=g?Math.round(S/g*100):0,N=E.reduce((R,I)=>R+I.ms,0);return{count:E.length,avgAccuracy:y,totalTime:v(N),bestScore:Math.max(...E.map(R=>R.accuracy))}},[E]),T=S=>S>=80?"text-green-400":S>=60?"text-blue-400":S>=40?"text-yellow-400":"text-red-400";return x?r.jsx("div",{className:"min-h-full bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 flex items-center justify-center",children:r.jsx("div",{className:"text-white",children:"Loading history..."})}):r.jsxs("div",{className:"min-h-full bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 pt-12",children:[r.jsx("div",{className:"",children:r.jsxs("div",{className:"px-4 pt-4 pb-4",children:[r.jsxs("div",{className:"flex items-center justify-between mb-3",children:[r.jsx("button",{onClick:()=>C("/profile",{replace:!0}),className:"px-3 py-1.5 rounded-xl border border-white/20 bg-white/10 text-white text-sm flex items-center gap-1",children:"← Back"}),r.jsx("button",{onClick:()=>i(!a),className:"p-2 rounded-xl border border-white/20 bg-white/10 text-white",children:r.jsx(Cv,{})})]}),r.jsx("h1",{className:"text-2xl font-bold text-white mb-1",children:"History"}),r.jsx("p",{className:"text-white/70 text-sm",children:"Track your progress"})]})}),r.jsxs("div",{className:"px-4 pb-20",children:[r.jsx("div",{className:`
      ...
      `,children:[r.jsxs("div",{className:"flex items-start justify-between mb-3",children:[r.jsxs("div",{className:"flex-1",children:[r.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[r.jsx("span",{className:"text-lg",children:e.type==="quiz"?"🎯":"📝"}),r.jsx("h3",{className:"font-semibold text-white",children:e.category})]}),r.jsxs("div",{className:"flex items-center gap-2",children:[r.jsx("span",{className:`px-2 py-0.5 rounded-full text-xs ${i.bg} ${i.text} ${i.border} border`,children:e.difficulty}),r.jsx("span",{className:"text-xs text-white/50",children:e.date})]})]}),r.jsxs("div",{className:"text-right",children:[r.jsxs("div",{className:`text-2xl font-bold ${e.accuracy>=80?"text-green-400":e.accuracy>=60?"text-blue-400":e.accuracy>=40?"text-yellow-400":"text-red-400"}`,children:[e.accuracy,"%"]}),r.jsxs("div",{className:"text-xs text-white/60",children:[e.score,"/",e.total]})]})]}),r.jsxs("div",{className:"flex items-center justify-between text-xs",children:[r.jsxs("div",{className:"flex items-center gap-3 text-white/60",children:[r.jsxs("span",{children:["⏱ ",e.time]}),r.jsx("span",{children:e.mode})]}),r.jsx("span",{className:"text-white/40",children:"Tap to review →"})]})]})}function Sv({item:e,onClose:t}){const n=He();return d.useEffect(()=>{const s=a=>{a.key==="Escape"&&t()};return document.addEventListener("keydown",s),()=>document.removeEventListener("keydown",s)},[t]),r.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80",onClick:t,children:r.jsxs("div",{className:"w-full max-w-md bg-gray-900 rounded-3xl p-6 border border-white/20",onClick:s=>s.stopPropagation(),children:[r.jsxs("div",{className:"flex items-center justify-between mb-4",children:[r.jsx("h2",{className:"text-xl font-bold text-white",children:"Quiz Details"}),r.jsx("button",{onClick:t,className:"p-2 rounded-xl bg-white/10 hover:bg-white/20 transition-colors text-white",children:"✕"})]}),r.jsxs("div",{className:"space-y-4",children:[r.jsxs("div",{className:"p-4 rounded-2xl bg-white/5 border border-white/10",children:[r.jsxs("div",{className:"flex items-center justify-between mb-2",children:[r.jsx("span",{className:"text-white/60",children:"Category"}),r.jsx("span",{className:"text-white font-medium",children:e.category})]}),r.jsxs("div",{className:"flex items-center justify-between mb-2",children:[r.jsx("span",{className:"text-white/60",children:"Difficulty"}),r.jsx("span",{className:`${e.difficulty==="easy"?"text-green-400":e.difficulty==="medium"?"text-yellow-400":"text-red-400"} font-medium`,children:e.difficulty})]}),r.jsxs("div",{className:"flex items-center justify-between mb-2",children:[r.jsx("span",{className:"text-white/60",children:"Score"}),r.jsxs("span",{className:"text-white font-medium",children:[e.score,"/",e.total]})]}),r.jsxs("div",{className:"flex items-center justify-between mb-2",children:[r.jsx("span",{className:"text-white/60",children:"Accuracy"}),r.jsxs("span",{className:`${e.accuracy>=80?"text-green-400":e.accuracy>=60?"text-blue-400":"text-yellow-400"} font-medium`,children:[e.accuracy,"%"]})]}),r.jsxs("div",{className:"flex items-center justify-between",children:[r.jsx("span",{className:"text-white/60",children:"Time"}),r.jsx("span",{className:"text-white font-medium",children:e.time})]})]}),e.snapshot&&r.jsx("button",{onClick:()=>{t(),localStorage.setItem(jv,JSON.stringify(e.snapshot)),n(`/quiz/${e.categoryParam}/start?review=1&attempt=${e.id}`,{state:{reviewFrom:"history",historyPath:"/profile/history"}})},className:"w-full py-3 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-500 text-white font-medium hover:opacity-90 transition-opacity",children:"Review Answers"}),r.jsx("button",{onClick:()=>{var s;t(),n(`/quiz/${e.categoryParam}/start`,{state:{mode:"quiz",retake:!0,difficulty:e.difficulty,count:e.total,timer:((s=e.snapshot)==null?void 0:s.timer)||{type:"per_q",seconds:45},fromHistory:!0}})},className:"w-full py-3 rounded-2xl border border-white/20 text-white font-medium hover:bg-white/10 transition-colors",children:"Retake Quiz"})]})]})})}function Cv(){return r.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M3 6h18M7 12h10M10 18h4",strokeLinecap:"round",strokeLinejoin:"round"})})}const Ev=d.createContext({});function Im(e){const t=d.useRef(null);return t.current===null&&(t.current=e()),t.current}const Pv=typeof window<"u",Rv=Pv?d.useLayoutEffect:d.useEffect,Dm=d.createContext(null);function Tv(e){return typeof e=="object"&&e!==null}function _v(e){return Tv(e)&&"offsetHeight"in e}const Lv=d.createContext({transformPagePoint:e=>e,isStatic:!1,reducedMotion:"never"});class Av extends d.Component{getSnapshotBeforeUpdate(t){const n=this.props.childRef.current;if(n&&t.isPresent&&!this.props.isPresent){const s=n.offsetParent,a=_v(s)&&s.offsetWidth||0,i=this.props.sizeRef.current;i.height=n.offsetHeight||0,i.width=n.offsetWidth||0,i.top=n.offsetTop,i.left=n.offsetLeft,i.right=a-i.width-i.left}return null}componentDidUpdate(){}render(){return this.props.children}}function Iv({children:e,isPresent:t,anchorX:n,root:s}){const a=d.useId(),i=d.useRef(null),o=d.useRef({width:0,height:0,top:0,left:0,right:0}),{nonce:l}=d.useContext(Lv);return d.useInsertionEffect(()=>{const{width:c,height:u,top:f,left:p,right:m}=o.current;if(t||!i.current||!c||!u)return;const w=n==="left"?`left: ${p}`:`right: ${m}`;i.current.dataset.motionPopId=a;const x=document.createElement("style");l&&(x.nonce=l);const k=s??document.head;return k.appendChild(x),x.sheet&&x.sheet.insertRule(`
        ...
        `),()=>{k.contains(x)&&k.removeChild(x)}},[t]),r.jsx(Av,{isPresent:t,childRef:i,sizeRef:o,children:d.cloneElement(e,{ref:i})})}const Dv=({children:e,initial:t,isPresent:n,onExitComplete:s,custom:a,presenceAffectsLayout:i,mode:o,anchorX:l,root:c})=>{const u=Im(Mv),f=d.useId();let p=!0,m=d.useMemo(()=>(p=!1,{id:f,initial:t,isPresent:n,custom:a,onExitComplete:w=>{u.set(w,!0);for(const x of u.values())if(!x)return;s&&s()},register:w=>(u.set(w,!1),()=>u.delete(w))}),[n,u,s]);return i&&p&&(m={...m}),d.useMemo(()=>{u.forEach((w,x)=>u.set(x,!1))},[n]),d.useEffect(()=>{!n&&!u.size&&s&&s()},[n]),o==="popLayout"&&(e=r.jsx(Iv,{isPresent:n,anchorX:l,root:c,children:e})),r.jsx(Dm.Provider,{value:m,children:e})};function Mv(){return new Map}function zv(e=!0){const t=d.useContext(Dm);if(t===null)return[!0,null];const{isPresent:n,onExitComplete:s,register:a}=t,i=d.useId();d.useEffect(()=>{if(e)return a(i)},[e]);const o=d.useCallback(()=>e&&s&&s(i),[i,s,e]);return!n&&s?[!1,o]:[!0]}const va=e=>e.key||"";function Yd(e){const t=[];return d.Children.forEach(e,n=>{d.isValidElement(n)&&t.push(n)}),t}const so=({children:e,custom:t,initial:n=!0,onExitComplete:s,presenceAffectsLayout:a=!0,mode:i="sync",propagate:o=!1,anchorX:l="left",root:c})=>{const[u,f]=zv(o),p=d.useMemo(()=>Yd(e),[e]),m=o&&!u?[]:p.map(va),w=d.useRef(!0),x=d.useRef(p),k=Im(()=>new Map),[C,v]=d.useState(p),[h,b]=d.useState(p);Rv(()=>{w.current=!1,x.current=p;for(let T=0;T<h.length;T++){const S=va(h[T]);m.includes(S)?k.delete(S):k.get(S)!==!0&&k.set(S,!1)}},[h,m.length,m.join("-")]);const E=[];if(p!==C){let T=[...p];for(let S=0;S<h.length;S++){const g=h[S],y=va(g);m.includes(y)||(T.splice(S,0,g),E.push(g))}return i==="wait"&&E.length&&(T=E),b(Yd(T)),v(p),null}const{forceRender:j}=d.useContext(Ev);return r.jsx(r.Fragment,{children:h.map(T=>{const S=va(T),g=o&&!u?!1:p===h||m.includes(S),y=()=>{if(k.has(S))k.set(S,!0);else return;let N=!0;k.forEach(R=>{R||(N=!1)}),N&&(j==null||j(),b(x.current),o&&(f==null||f()),s&&s())};return r.jsx(Dv,{isPresent:g,initial:!w.current||n?void 0:!1,custom:t,presenceAffectsLayout:a,mode:i,root:c,onExitComplete:g?void 0:y,anchorX:l,children:T},S)})})},Fv=()=>{const e=He(),[t,n]=d.useState(null);d.useEffect(()=>{if(typeof window<"u"){const W=sessionStorage.getItem("navigationSource");W&&n(W)}},[]);const s=W=>{typeof window<"u"&&(sessionStorage.setItem("navigationSource","/rewards"),window.location.href=W)},a=()=>{e(-1)},i=[{id:1,type:"coins",value:100,icon:"🪙",label:"100 Coins",cost:0},{id:2,type:"life",value:1,icon:"❤️",label:"1 Life",cost:50},{id:3,type:"coins",value:200,icon:"🪙",label:"200 Coins",cost:0},{id:4,type:"wildcard",value:1,icon:"🃏",label:"Wild Card",cost:100},{id:5,type:"coins",value:500,icon:"💰",label:"500 Coins",cost:0,milestone:!0},{id:6,type:"fifty-fifty",value:1,icon:"➗",label:"50:50",cost:150},{id:7,type:"life",value:2,icon:"❤️",label:"2 Lives",cost:100},{id:8,type:"vehicle",value:"bike",icon:"🏍️",label:"Motorcycle",cost:300},{id:9,type:"mystery",value:1,icon:"🎁",label:"Mystery Box",cost:200},{id:10,type:"coins",value:750,icon:"💰",label:"750 Coins",cost:0,milestone:!0},{id:11,type:"life",value:3,icon:"❤️",label:"3 Lives",cost:150},{id:12,type:"wildcard",value:2,icon:"🃏",label:"2x Wild Card",cost:250},{id:13,type:"vehicle",value:"car",icon:"🚗",label:"Car",cost:500},{id:14,type:"fifty-fifty",value:2,icon:"➗",label:"2x 50:50",cost:300},{id:15,type:"coins",value:1e3,icon:"💎",label:"1000 Coins",cost:0,milestone:!0}],o={cycle:{icon:"🚴",name:"Bicycle"},bike:{icon:"🏍️",name:"Motorcycle"},car:{icon:"🚗",name:"Car"}},{player:l,addCoins:c}=jn(),[u,f]=d.useState(4),[p,m]=d.useState((l==null?void 0:l.coins)||0),[w,x]=d.useState(4),[k,C]=d.useState(!1),[v,h]=d.useState(!1),[b,E]=d.useState(0),[j,T]=d.useState(0),[S,g]=d.useState("cycle"),[y,N]=d.useState([{type:"vehicle",icon:"🚴",name:"Bicycle",count:1},{type:"wildcard",icon:"🃏",name:"Wild Card",count:2},{type:"fifty-fifty",icon:"➗",name:"50:50 Helper",count:1}]),[R,I]=d.useState([0,1,2,3]),[q,Z]=d.useState(!1),[H,Y]=d.useState(!1),[$,P]=d.useState(null),[_,F]=d.useState(null),[L,D]=d.useState(!1),[A,X]=d.useState(null),[ne,re]=d.useState(!1),Q=d.useRef(null),M=d.useRef(null),K=d.useRef(null);d.useEffect(()=>{Q.current=new Audio("/sounds/reward.mp3"),M.current=new Audio("/sounds/reward_progress.mp3"),[Q,M].forEach(W=>{var O;(O=W.current)==null||O.addEventListener("error",()=>{console.log("Sound file not found")})})},[]);const z=W=>{try{W.current&&(W.current.currentTime=0,W.current.play().catch(O=>console.log("Audio play failed:",O)))}catch(O){console.log("Sound play error:",O)}},B=(W,O)=>{if(W>u){F(O),Y(!0);return}W===u&&ae(W,O)},ee=W=>{var te;const O=(te=K.current)==null?void 0:te.querySelector(`[data-index="${W}"]`);if(O){const de=O.getBoundingClientRect(),je=window.pageYOffset||document.documentElement.scrollTop,Le=de.top+je-window.innerHeight/2+50;window.scrollTo({top:Le,behavior:"smooth"})}},ae=(W,O)=>{if(!R.includes(W)){if(O.cost>0&&p<O.cost){F(O),Y(!0);return}O.cost>0&&(m(te=>te-O.cost),c(-O.cost)),z(Q),Z(!0),F(O),I(te=>[...te,W]),setTimeout(()=>{Z(!1),O.type==="coins"?(E(O.value),C(!0),setTimeout(()=>{m(te=>te+O.value),c(O.value),setTimeout(()=>{C(!1),E(0)},500)},300)):O.type==="life"?(T(O.value),h(!0),setTimeout(()=>{x(te=>te+O.value),setTimeout(()=>{h(!1),T(0)},500)},300)):(X({icon:O.icon,startX:window.innerWidth/2,startY:window.innerHeight/2}),setTimeout(()=>{X(null),re(!0),ce(O),O.type==="vehicle"&&g(O.value),setTimeout(()=>{re(!1)},500)},800)),setTimeout(()=>{if(u<i.length-1){const te=u+1;ee(te),setTimeout(()=>{D(!0),z(M),f(te),setTimeout(()=>{D(!1)},500)},300)}},1200)},1500)}},ce=W=>{N(O=>O.find(de=>de.icon===W.icon)?O.map(de=>de.icon===W.icon?{...de,count:de.count+1}:de):[...O,{type:W.type,icon:W.icon,name:W.label,count:1}])},U=W=>30+W*100,G=()=>30+u*100;return r.jsxs("div",{className:"rewards-page",children:[r.jsx("style",{jsx:!0,children:`
        .rewards-page {
          min-height: 100vh;
      ...
      `}),r.jsx("div",{className:"non-sticky-header",children:r.jsx("button",{className:"back-button",onClick:a,children:"← Back"})}),r.jsxs("div",{className:"sticky-section",children:[r.jsxs("div",{className:"header-wrapper",children:[r.jsxs("div",{className:"title-row",children:[r.jsxs("div",{children:[r.jsx("h1",{className:"title",children:"Rewards"}),r.jsx("p",{className:"subtitle",children:"Claim amazing prizes"})]}),r.jsx("button",{className:"play-quiz-btn",onClick:()=>s("/play"),children:"Play Quiz"})]}),r.jsx("div",{className:"balance-row",children:r.jsx("div",{className:"balance-item",children:r.jsxs("div",{children:[r.jsx("div",{className:"balance-label",children:"Balance"}),r.jsxs("div",{className:`balance-value ${k?"animating":""}`,children:[p.toLocaleString()," 🪙",k&&r.jsxs("span",{className:"value-change",children:["+",b]})]})]})})})]}),r.jsx("div",{className:"stats-cards-container",children:r.jsxs("div",{className:"info-grid",children:[r.jsxs("div",{className:"info-card",children:[r.jsx("div",{className:"info-icon",children:"❤️"}),r.jsxs("div",{className:`info-value ${v?"animating":""}`,children:[w,v&&r.jsxs("span",{className:"value-change",children:["+",j]})]}),r.jsx("div",{className:"info-label",children:"Lives"})]}),r.jsxs("div",{className:"info-card",children:[r.jsx("div",{className:"info-icon",children:"⭐"}),r.jsx("div",{className:"info-value",children:"5"}),r.jsx("div",{className:"info-label",children:"Level"})]}),r.jsxs("div",{className:"info-card",children:[r.jsx("div",{className:"info-icon",children:o[S].icon}),r.jsx("div",{className:"info-value",children:o[S].name}),r.jsx("div",{className:"info-label",children:"Vehicle"})]}),r.jsxs("div",{className:`cards-section ${ne?"animating":""}`,children:[r.jsx("div",{className:"cards-label",children:"Your Cards"}),r.jsx("div",{className:"card-grid",children:y.map((W,O)=>r.jsxs("div",{className:"card-item",onClick:()=>P(W),children:[r.jsxs("div",{className:"large-card",children:[r.jsx("div",{className:"large-card-icon",children:W.icon}),r.jsx("div",{className:"large-card-name",children:W.name})]}),W.count>1&&r.jsx("div",{className:"card-count-badge",children:W.count})]},O))})]})]})})]}),r.jsx("div",{className:"scrollable-journey",children:r.jsx("div",{className:"journey-container",ref:K,children:r.jsxs("div",{className:"journey-track",children:[r.jsx("div",{className:"curvy-road",children:r.jsxs("svg",{className:"road-svg",viewBox:"0 0 60 1500",preserveAspectRatio:"none",children:[r.jsx("defs",{children:r.jsxs("linearGradient",{id:"roadGradient",x1:"0%",y1:"0%",x2:"0%",y2:"100%",children:[r.jsx("stop",{offset:"0%",stopColor:"#5E5CE6"}),r.jsx("stop",{offset:"100%",stopColor:"#5E5CE6"})]})}),r.jsx("path",{className:"road-path",d:"M 30 0 Q 45 50, 30 100 T 30 200 Q 15 250, 30 300 T 30 400 Q 45 450, 30 500 T 30 600 Q 15 650, 30 700 T 30 800 Q 45 850, 30 900 T 30 1000 Q 15 1050, 30 1100 T 30 1200 Q 45 1250, 30 1300 T 30 1400 L 30 1500"}),r.jsx("path",{className:"road-progress",d:"M 30 0 Q 45 50, 30 100 T 30 200 Q 15 250, 30 300 T 30 400 Q 45 450, 30 500 T 30 600 Q 15 650, 30 700 T 30 800 Q 45 850, 30 900 T 30 1000 Q 15 1050, 30 1100 T 30 1200 Q 45 1250, 30 1300 T 30 1400 L 30 1500",strokeDasharray:"1500",strokeDashoffset:1500-u/(i.length-1)*1500})]})}),r.jsxs("div",{className:"avatar-tracker",style:{top:`${G()}px`},children:[r.jsx("img",{className:"avatar-img",src:"/profile/avatar.png",alt:"You",onError:W=>{W.target.style.display="none"}}),r.jsx("div",{className:"tracker-vehicle",children:o[S].icon})]}),r.jsx("div",{className:"rewards-list",children:i.map((W,O)=>{const te=O%2===0,de=O>u,je=R.includes(O),Le=O===u;return r.jsx("div",{className:"reward-row","data-index":O,style:{top:`${U(O)}px`},children:r.jsxs("div",{className:`reward-item ${te?"left":"right"}`,children:[r.jsxs("div",{className:`checkpoint ${Le?"current":je?"claimed":de?"locked":""}`,onClick:()=>B(O,W),children:[r.jsx("div",{className:"checkpoint-icon",children:W.icon}),r.jsx("div",{className:"checkpoint-value",children:W.label.split(" ")[0]}),W.milestone&&r.jsx("div",{className:"milestone-badge",children:"BONUS"}),de&&r.jsx("div",{className:"lock-icon",children:"🔒"})]}),r.jsxs("div",{className:"reward-info",children:[r.jsx("div",{className:"reward-name",children:W.label}),r.jsxs("div",{className:"step-label",children:["Step ",O+1]})]})]})},W.id)})})]})})}),A&&r.jsx("div",{className:"flying-card",style:{left:`${A.startX}px`,top:`${A.startY}px`,"--startX":`${A.startX}px`},children:A.icon}),r.jsx(so,{children:$&&r.jsx("div",{className:"claim-overlay",onClick:()=>P(null),children:r.jsxs("div",{className:"modal",onClick:W=>W.stopPropagation(),children:[r.jsx("div",{className:"modal-icon",children:$.icon}),r.jsx("div",{className:"card-detail-name",children:$.name}),r.jsxs("div",{className:"card-detail-desc",children:["You have ",$.count," of these cards"]}),r.jsx("div",{className:"modal-buttons",children:r.jsx("button",{className:"modal-btn modal-btn-secondary",onClick:()=>P(null),children:"Close"})})]})})}),r.jsx(so,{children:q&&_&&r.jsx("div",{className:"claim-overlay",children:r.jsxs("div",{className:"modal",children:[r.jsx("div",{className:"modal-title",children:"WELL DONE!"}),r.jsx("div",{className:"modal-subtitle",children:"Here's a reward for you."}),r.jsx("div",{className:"modal-icon",children:_.icon}),r.jsxs("div",{className:"modal-value",children:["+",_.value," ",_.type==="coins"?"Coins":_.type==="life"?"Lives":_.label]})]})})}),r.jsx(so,{children:H&&_&&r.jsx("div",{className:"claim-overlay",onClick:()=>Y(!1),children:r.jsxs("div",{className:"modal",onClick:W=>W.stopPropagation(),children:[r.jsx("div",{className:"modal-icon",children:"🪙"}),r.jsx("div",{className:"modal-title",children:"Need More Coins"}),r.jsx("div",{className:"modal-subtitle",children:_.cost>0?`You need ${_.cost-p} more coins`:"Complete previous rewards first"}),r.jsxs("div",{className:"modal-buttons",children:[r.jsx("button",{className:"modal-btn modal-btn-primary",onClick:()=>s("/play"),children:"Play Quiz"}),r.jsx("button",{className:"modal-btn modal-btn-secondary",onClick:()=>Y(!1),children:"Cancel"})]})]})})})]})},ya=[{id:1,name:"First Win",emoji:"🏆",unlocked:!0,hint:"Win your first quiz",progress:100,color:"#FFD700"},{id:2,name:"On Fire",emoji:"🔥",unlocked:!0,hint:"3-day winning streak",progress:100,color:"#FF6B35"},{id:3,name:"Perfectionist",emoji:"⭐",unlocked:!1,hint:"Score 10/10 in any quiz",progress:75,color:"#9333EA"},{id:4,name:"Early Bird",emoji:"🌅",unlocked:!0,hint:"Play before 9 AM",progress:100,color:"#F59E0B"},{id:5,name:"Scholar",emoji:"🎓",unlocked:!1,hint:"Master 5 categories",progress:40,color:"#3B82F6"},{id:6,name:"Lightning",emoji:"⚡",unlocked:!1,hint:"Complete in under 2 minutes",progress:20,color:"#10B981"},{id:7,name:"Champion",emoji:"👑",unlocked:!1,hint:"Win 50 quizzes",progress:30,color:"#EC4899"},{id:8,name:"Explorer",emoji:"🗺️",unlocked:!1,hint:"Try all categories",progress:60,color:"#06B6D4"},{id:9,name:"Strategist",emoji:"🧠",unlocked:!0,hint:"Use 3 power-ups wisely",progress:100,color:"#8B5CF6"}];function Ov(){const[e,t]=d.useState(null),n=ya.filter(a=>a.unlocked).length,s=Math.round(n/ya.length*100);return r.jsxs("div",{className:"badges-screen",children:[r.jsx("style",{jsx:!0,children:`
        .badges-screen {
          min-height: 100vh;
      ...
      `}),r.jsxs("div",{className:"floating-shapes",children:[r.jsx("div",{className:"shape shape-1"}),r.jsx("div",{className:"shape shape-2"})]}),r.jsxs("div",{className:"header",children:[r.jsx("button",{className:"back-button",onClick:()=>window.history.back(),children:"← Back"}),r.jsxs("div",{className:"coins-display",children:["🪙 ",o.toLocaleString()]}),r.jsxs("div",{className:"title-section",children:[r.jsx("h1",{className:"main-title",children:"ACHIEVEMENTS"}),r.jsx("p",{className:"subtitle",children:"Complete challenges and earn awesome rewards!"})]})]}),r.jsxs("div",{className:"progress-overview",children:[r.jsx("div",{className:"card-glow",style:{"--card-color":"#FFD93D"}}),r.jsxs("div",{className:"overview-header",children:[r.jsx("span",{className:"overview-label",children:"🎮 Progress Tracker"}),r.jsxs("div",{className:"overview-stats",children:[r.jsx("span",{className:"trophy-icon",children:"🏆"}),r.jsxs("span",{className:"overview-value",children:[w,"/",m]})]})]}),r.jsx("div",{className:"progress-bar-main",children:r.jsx("div",{className:"progress-fill-main",style:{width:`${x}%`}})})]}),r.jsx("div",{className:"achievements-list",children:n.map(C=>{const v=Math.min(100,Math.round(C.current/C.target*100)),h=v===100,b=C.color+"CC";return r.jsxs("div",{className:`achievement-card ${h?"completed":""}`,style:{"--card-color":C.color,"--card-color-dark":b},children:[r.jsx("div",{className:"card-glow"}),h&&C.claimed&&r.jsx("div",{className:"completed-badge",children:"✓"}),r.jsxs("div",{className:"card-content",children:[r.jsx("div",{className:"achievement-icon",children:C.icon}),r.jsxs("div",{className:"achievement-details",children:[r.jsx("div",{className:"achievement-title",children:C.title}),r.jsx("div",{className:"achievement-subtitle",children:C.subtitle}),r.jsxs("div",{className:"progress-container",children:[r.jsx("div",{className:"progress-bar",children:r.jsx("div",{className:"progress-fill",style:{width:`${v}%`}})}),r.jsxs("div",{className:"progress-text",children:[r.jsxs("span",{children:[C.current,"/",C.target]}),r.jsxs("span",{className:"reward-badge",children:["🪙 ",C.reward]})]})]})]}),r.jsx("button",{onClick:()=>k(C.id,C.reward),disabled:!h||C.claimed,className:`claim-button ${C.claimed?"claimed":h?"can-claim":"in-progress"} ${a===C.id?"claiming":""}`,children:C.claimed?"✓":h?"CLAIM!":`${v}%`})]})]},C.id)})}),c&&r.jsx("div",{className:"celebration",children:"🎉"})]})}function Uv(){const{player:e,addCoins:t,updateDailyStreak:n}=jn(),s=(e==null?void 0:e.currentStreak)||0,a=(e==null?void 0:e.bestStreak)||0,i=(e==null?void 0:e.totalDays)||0,o=(e==null?void 0:e.coins)||0,l=He(),c=new Date,u=c.getDay(),f=()=>{const L=new Date(c);return L.setDate(c.getDate()-c.getDay()),L.toISOString().split("T")[0]},[p,m]=d.useState(null),[w,x]=d.useState(!1),[k,C]=d.useState(null),[v,h]=d.useState(null),[b,E]=d.useState(!1),j=d.useRef(null),T=d.useRef(null),[S]=zt("/sounds/coin.mp3",{volume:.75}),[g]=zt("/sounds/correct.mp3",{volume:.6}),[y,N]=d.useState(()=>{const L=localStorage.getItem("streaks_claimed")||"[]",D=JSON.parse(L),A=f(),X=D.filter(ne=>ne!==`week_${A}_day_0`);return localStorage.setItem("streaks_claimed",JSON.stringify(X)),X});d.useEffect(()=>{const L=()=>{window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0;const A=document.querySelector("main");A&&(A.scrollTop=0)};L(),requestAnimationFrame(L);const D=setTimeout(L,100);return()=>clearTimeout(D)},[]),d.useEffect(()=>{E(!0),setTimeout(()=>E(!1),3e3)},[]);const R=[{label:"Mon",short:"M",dayIndex:1},{label:"Tue",short:"T",dayIndex:2},{label:"Wed",short:"W",dayIndex:3},{label:"Thu",short:"T",dayIndex:4},{label:"Fri",short:"F",dayIndex:5},{label:"Sat",short:"S",dayIndex:6},{label:"Sun",short:"S",dayIndex:0}],I=[{day:0,reward:"10",type:"coins",icon:"🎯",label:"Welcome Bonus"},{day:1,reward:"50",type:"coins",icon:"🪙",label:"50 Coins"},{day:2,reward:"100",type:"coins",icon:"🪙",label:"100 Coins"},{day:3,reward:"2x",type:"xp",icon:"⭐",label:"2x XP Boost"},{day:4,reward:"150",type:"coins",icon:"🪙",label:"150 Coins"},{day:5,reward:"Full",type:"energy",icon:"⚡",label:"Energy Refill"},{day:6,reward:"200",type:"coins",icon:"🪙",label:"200 Coins"},{day:7,reward:"Mystery",type:"mystery",icon:"🎁",label:"Mystery Box"}],q=L=>{const D=y.includes(`week_${f()}_day_${L}`);if(L===0)return{isCompleted:!0,isClaimed:D,canClaim:!D,isLocked:!1};const A=s>=L,X=A&&!D,ne=s<L;return{isCompleted:A,isClaimed:D,canClaim:X,isLocked:ne}},Z=(L,D,A)=>{const X=q(D);if(X.isLocked){h({day:D,currentStreak:s}),setTimeout(()=>h(null),2e3);return}X.isClaimed||X.canClaim&&(m({...L,day:D}),x(!1),setTimeout(()=>{x(!0),g(),setTimeout(()=>{if(L.type==="coins"){const Q=parseInt(L.reward);if(T.current&&j.current){const M=T.current.getBoundingClientRect();S(),C({startRect:M,count:10,amount:Q})}}const ne=`week_${f()}_day_${D}`,re=[...y,ne];N(re),localStorage.setItem("streaks_claimed",JSON.stringify(re))},500),setTimeout(()=>{m(null),x(!1)},2500)},500))},H=(L,D)=>{const A=D+1,X=R[D].dayIndex===u;return s>=A?X?"today-completed":"completed":X?"today-pending":A<=s+1?"pending":"future"},Y=[{days:3,emoji:"⚡",label:"Starter",achieved:s>=3},{days:7,emoji:"🔥",label:"Week Warrior",achieved:s>=7},{days:30,emoji:"💎",label:"Champion",achieved:s>=30},{days:100,emoji:"👑",label:"Legend",achieved:s>=100}],$=Y.find(L=>L.days>s)||Y[Y.length-1],P=Math.min(100,s/$.days*100),_=()=>{window.location.href="/play"},F=()=>{l(-1)};return r.jsxs("div",{className:"streaks-screen",children:[r.jsx("style",{jsx:!0,children:`
        * {
          margin: 0;
          padding: 0;
          box-sizing: border-box;
