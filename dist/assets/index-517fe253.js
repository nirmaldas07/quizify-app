 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(_,D){var q=_.length;_.push(D);e:for(;0<q;){var z=q-1>>>1,L=_[z];if(0<a(L,D))_[z]=D,_[q]=L,q=z;else break e}}function r(_){return _.length===0?null:_[0]}function s(_){if(_.length===0)return null;var D=_[0],q=_.pop();if(q!==D){_[0]=q;e:for(var z=0,L=_.length,I=L>>>1;z<I;){var W=2*(z+1)-1,re=_[W],J=W+1,O=_[J];if(0>a(re,q))J<L&&0>a(O,re)?(_[z]=O,_[J]=q,z=J):(_[z]=re,_[W]=q,z=W);else if(J<L&&0>a(O,q))_[z]=O,_[J]=q,z=J;else break e}}return D}function a(_,D){var q=_.sortIndex-D.sortIndex;return q!==0?q:_.id-D.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();e.unstable_now=function(){return o.now()-l}}var c=[],u=[],f=1,x=null,m=3,w=!1,v=!1,N=!1,E=typeof setTimeout=="function"?setTimeout:null,y=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(_){for(var D=r(u);D!==null;){if(D.callback===null)s(u);else if(D.startTime<=_)s(u),D.sortIndex=D.expirationTime,t(c,D);else break;D=r(u)}}function C(_){if(N=!1,p(_),!v)if(r(c)!==null)v=!0,U(j);else{var D=r(u);D!==null&&B(C,D.startTime-_)}}function j(_,D){v=!1,N&&(N=!1,y(g),g=-1),w=!0;var q=m;try{for(p(D),x=r(c);x!==null&&(!(x.expirationTime>D)||_&&!P());){var z=x.callback;if(typeof z=="function"){x.callback=null,m=x.priorityLevel;var L=z(x.expirationTime<=D);D=e.unstable_now(),typeof L=="function"?x.callback=L:x===r(c)&&s(c),p(D)}else s(c);x=r(c)}if(x!==null)var I=!0;else{var W=r(u);W!==null&&B(C,W.startTime-D),I=!1}return I}finally{x=null,m=q,w=!1}}var R=!1,S=null,g=-1,b=5,k=-1;function P(){return!(e.unstable_now()-k<b)}function F(){if(S!==null){var _=e.unstable_now();k=_;var D=!0;try{D=S(!0,_)}finally{D?Y():(R=!1,S=null)}}else R=!1}var Y;if(typeof h=="function")Y=function(){h(F)};else if(typeof MessageChannel<"u"){var ee=new MessageChannel,Q=ee.port2;ee.port1.onmessage=F,Y=function(){Q.postMessage(null)}}else Y=function(){E(F,0)};function U(_){S=_,R||(R=!0,Y())}function B(_,D){g=E(function(){_(e.unstable_now())},D)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){v||w||(v=!0,U(j))},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return r(c)},e.unstable_next=function(_){switch(m){case 1:case 2:case 3:var D=3;break;default:D=m}var q=m;m=D;try{return _()}finally{m=q}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,D){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var q=m;m=_;try{return D()}finally{m=q}},e.unstable_scheduleCallback=function(_,D,q){var z=e.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?z+q:z):q=z,_){case 1:var L=-1;break;case 2:L=250;break;case 5:L=1073741823;break;case 4:L=1e4;break;default:L=5e3}return L=q+L,_={id:f++,callback:D,priorityLevel:_,startTime:q,expirationTime:L,sortIndex:-1},q>z?(_.sortIndex=q,t(u,_),r(c)===null&&_===r(u)&&(N?(y(g),g=-1):N=!0,B(C,q-z))):(_.sortIndex=L,t(c,_),v||w||(v=!0,U(j))),_},e.unstable_shouldYield=P,e.unstable_wrapCallback=function(_){var D=m;return function(){var q=m;m=D;try{return _.apply(this,arguments)}finally{m=q}}}})(du);cu.exports=du;var o0=cu.exports;/**
 * @license React
