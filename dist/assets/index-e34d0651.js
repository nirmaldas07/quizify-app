 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(R,z){var Y=R.length;R.push(z);e:for(;0<Y;){var D=Y-1>>>1,I=R[D];if(0<a(I,z))R[D]=z,R[Y]=I,Y=D;else break e}}function r(R){return R.length===0?null:R[0]}function s(R){if(R.length===0)return null;var z=R[0],Y=R.pop();if(Y!==z){R[0]=Y;e:for(var D=0,I=R.length,A=I>>>1;D<A;){var G=2*(D+1)-1,re=R[G],Z=G+1,F=R[Z];if(0>a(re,Y))Z<I&&0>a(F,re)?(R[D]=F,R[Z]=Y,D=Z):(R[D]=re,R[G]=Y,D=G);else if(Z<I&&0>a(F,Y))R[D]=F,R[Z]=Y,D=Z;else break e}}return z}function a(R,z){var Y=R.sortIndex-z.sortIndex;return Y!==0?Y:R.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var i=Date,l=i.now();e.unstable_now=function(){return i.now()-l}}var c=[],u=[],m=1,h=null,f=3,b=!1,y=!1,j=!1,C=typeof setTimeout=="function"?setTimeout:null,v=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(R){for(var z=r(u);z!==null;){if(z.callback===null)s(u);else if(z.startTime<=R)s(u),z.sortIndex=z.expirationTime,t(c,z);else break;z=r(u)}}function E(R){if(j=!1,g(R),!y)if(r(c)!==null)y=!0,q(N);else{var z=r(u);z!==null&&B(E,z.startTime-R)}}function N(R,z){y=!1,j&&(j=!1,v(x),x=-1),b=!0;var Y=f;try{for(g(z),h=r(c);h!==null&&(!(h.expirationTime>z)||R&&!T());){var D=h.callback;if(typeof D=="function"){h.callback=null,f=h.priorityLevel;var I=D(h.expirationTime<=z);z=e.unstable_now(),typeof I=="function"?h.callback=I:h===r(c)&&s(c),g(z)}else s(c);h=r(c)}if(h!==null)var A=!0;else{var G=r(u);G!==null&&B(E,G.startTime-z),A=!1}return A}finally{h=null,f=Y,b=!1}}var P=!1,S=null,x=-1,w=5,k=-1;function T(){return!(e.unstable_now()-k<w)}function O(){if(S!==null){var R=e.unstable_now();k=R;var z=!0;try{z=S(!0,R)}finally{z?U():(P=!1,S=null)}}else P=!1}var U;if(typeof p=="function")U=function(){p(O)};else if(typeof MessageChannel<"u"){var H=new MessageChannel,Q=H.port2;H.port1.onmessage=O,U=function(){Q.postMessage(null)}}else U=function(){C(O,0)};function q(R){S=R,P||(P=!0,U())}function B(R,z){x=C(function(){R(e.unstable_now())},z)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(R){R.callback=null},e.unstable_continueExecution=function(){y||b||(y=!0,q(N))},e.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<R?Math.floor(1e3/R):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return r(c)},e.unstable_next=function(R){switch(f){case 1:case 2:case 3:var z=3;break;default:z=f}var Y=f;f=z;try{return R()}finally{f=Y}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(R,z){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var Y=f;f=R;try{return z()}finally{f=Y}},e.unstable_scheduleCallback=function(R,z,Y){var D=e.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?D+Y:D):Y=D,R){case 1:var I=-1;break;case 2:I=250;break;case 5:I=1073741823;break;case 4:I=1e4;break;default:I=5e3}return I=Y+I,R={id:m++,callback:z,priorityLevel:R,startTime:Y,expirationTime:I,sortIndex:-1},Y>D?(R.sortIndex=Y,t(u,R),r(c)===null&&R===r(u)&&(j?(v(x),x=-1):j=!0,B(E,Y-D))):(R.sortIndex=I,t(c,R),y||b||(y=!0,q(N))),R},e.unstable_shouldYield=T,e.unstable_wrapCallback=function(R){var z=f;return function(){var Y=f;f=z;try{return R.apply(this,arguments)}finally{f=Y}}}})(fu);mu.exports=fu;var d0=mu.exports;/**
 * @license React
