 ...
 * - onStart(): void                  // start fresh with saved settings
 * - onResume?(): void                // resume in-progress (optional)
 * - onChange(): void                 // open settings sheet
 * - onClose(): void
 */
export default function ConfirmStartSheet({
  ...
  return (
    ...
    >
      ...
      {/* Sheet */}
      <div
        className="relative w-full max-w-md rounded-t-3xl sm:rounded-2xl
                   bg-base-card border border-base-border shadow-2xl
                   p-5 pb-[calc(1rem+env(safe-area-inset-bottom))] mx-auto"
