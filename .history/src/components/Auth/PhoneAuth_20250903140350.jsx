...
export default function PhoneAuth() {
  ...
  background: 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)' 
      ...
      <div className="decorative-icons">
        <div className="floating-icon" style={{ top: '5%', animationDelay: '0s' }}>🎮</div>
        <div className="floating-icon" style={{ top: '15%', animationDelay: '5s' }}>🏆</div>
        <div className="floating-icon" style={{ top: '20%', animationDelay: '10s' }}>⭐</div>
        <div className="floating-icon" style={{ top: '75%', animationDelay: '15s' }}>🎯</div>
        <div className="floating-icon" style={{ top: '85%', animationDelay: '20s' }}>🪙</div>
      </div>
