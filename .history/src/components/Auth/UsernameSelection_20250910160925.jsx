...
export default function UsernameSelection() {
  ...
  const handleComplete = () => {
    ...
    // // Also save to Firestore (only works on mobile)
    // try {
    // if (window.Capacitor && window.Capacitor.platform !== 'web') {
    //     import('../../utils/firestore.js').then(module => {
    //     module.saveUserToFirestore(phone, {
    //         username,
    //         gender,
    //         ageGroup,
    //         avatar,
    ...
    // }
    // } catch (error) {
    // console.log('Firestore save skipped:', error);
    // }
