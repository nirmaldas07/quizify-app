...
const handleClick = () => {
  ...
  // Always reset Play to Modes, even if already on /play
  if (path === "/play") {
    navigate(`/play?view=modes&reset=${Date.now()}`); // forces state change every tap
  ...
  return (
    ...
    >
      ...
      <main
        ...
        style={{
          // IMPORTANT: no transform when idle; avoids creating a new containing block
