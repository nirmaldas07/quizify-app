...
{view === "results" && reviewSnapshot && (
  <QuizResults
    results={{
      ...reviewSnapshot,
      categorySlug: category,  // Add current category slug
      difficulty: difficulty    // Add current difficulty
    }}
    onRetake={handleRetake}
    onReview={() => handleReview(reviewSnapshot)}
    isRetake={isRetake}
    isPractice={isPractice}
    player={player}  // Use the player variable you already have
    categories={allCategories}  // Pass categories array
