...
export default function Quiz() {
  ...
  const isRetake    = Boolean(location.state?.retake); // retake via navigation
...
const awardCoins = useCallback((amount) => {
  ...
  useEffect(() => {
    ...
    }, [loading, err, allQuestions, category, difficulty, count, resumeFlag, timerConfig?.seconds, timerConfig?.type, location.search]);
