    ...
    <div className="h-screen bg-gray-900 relative">
      ...
      {coinFly && (
        <CoinFly
          ...
          count={coinFly.count}
          onDone={() => {
            // Add coins only once through GameDataService
            GameDataService.addCoins(coinFly.amount, 'Swipe Quiz Correct Answer');
            // Get the updated total from GameDataService
