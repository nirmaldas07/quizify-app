    ...
    >
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="relative">
          ...
          <div className="absolute -top-8 -left-2 text-sm opacity-70" style={{ animation: 'float 3s ease-in-out infinite' }}>🪙</div>
          <div className="absolute -top-2 -right-1 text-sm opacity-70" style={{ animation: 'float 3s ease-in-out infinite 0.5s' }}>💎</div>
          <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 text-sm opacity-70" style={{ animation: 'float 3s ease-in-out infinite 1s' }}>⭐</div>
