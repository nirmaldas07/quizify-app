...
export default function HeroCard() {
  ...
  useEffect(() => {
    ...
    const handleClick = () => {
    AnalyticsService.trackButtonClick('spin_and_win_play', 'home_screen');
    navigate('/play/classic', { state: { from: 'home' } });
    };

  return (
    <div 
      className="relative overflow-hidden rounded-3xl pt-12 pb-12 px-6 mb-8 transform transition-all hover:scale-[1.01] active:scale-[0.99]"
      style={{
