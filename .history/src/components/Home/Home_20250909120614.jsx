...
<div
  ...
  className="mt-6 relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-yellow-500/20 backdrop-blur border border-white/10 p-14 mb-10 cursor-pointer hover:scale-[1.02] transition-all group"
>
