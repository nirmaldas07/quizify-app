  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center transition-all duration-500
      ...
      <div className="relative z-10 text-center px-6 w-full max-w-sm mx-auto">
        ...
        <div className="relative bg-white rounded-3xl px-6 py-4 mb-6 shadow-xl">
        ...
        >
          ...
          <div className="relative bg-gradient-to-r from-green-400 to-blue-500 text-white py-10 px-8 rounded-full font-bold text-xl shadow-2xl 
