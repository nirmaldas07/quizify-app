...
export default function DailyChallenge({ onCoinsUpdate }) {
  ...
  if (stage === 'idle') {
    return (
      <div 
        onClick={handleStart}
        className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-500/40 to-blue-500/15 backdrop-blur border border-white/10 p-8 mb-4 cursor-pointer hover:scale-[1.02] transition-all"
      >
        <div className="flex items-center justify-between">
          <div>
