        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button
              ...
              className="aspect-square rounded-3xl bg-gradient-to-br from-green-400 to-purple-500 p-4 text-left hover:shadow-xl transition-all active:scale-[0.98] relative overflow-hidden"
            >
