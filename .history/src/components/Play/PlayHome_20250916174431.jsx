...
function ModesGrid({ onModeSelect, onNavigateHome }) {
  return (
    <div className="fixed inset-0 bg-base-bg text-base-text overflow-hidden mt-12">
      <div className="h-full overflow-y-auto mx-auto max-w-md px-4 pt-[calc(env(safe-area-inset-top)+2rem)] pb-[calc(env(safe-area-inset-bottom)+5.25rem)]">
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="absolute bottom-6 right-12 text-3xl opacity-60">🍪</div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <h4 className="text-lg font-black text-white">Coming Soon</h4>
            </button>
