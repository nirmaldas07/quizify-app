    ...
    <div className={`min-h-screen bg-gradient-to-br ${island.theme.background} relative overflow-hidden`}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6">
        ...
        <div className="mb-6 text-center slide-up">
          ...
          <div className="text-7xl bounce-animation">
            {earnedTreasure ? island.rewards.treasurePiece : '🏝️'}
          </div>
        </div>

        {/* Results Card */}
        <div className="glass-card rounded-3xl p-6 max-w-md w-full mb-6 slide-up" style={{ animationDelay: '0.2s' }}>
          {/* Score */}
          ...
          {showStars && (
            <div className="flex justify-center gap-3 mb-6">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className={`text-5xl ${i < session.correctAnswers ? 'star-pop' : ''}`}
          ...
          {showTreasure && earnedTreasure && (
            <div className="text-center mb-6">
              <div className="text-8xl treasure-shine mb-2">
        ...
        <div className="space-y-3 w-full max-w-md slide-up" style={{ animationDelay: '0.4s' }}>
          ...
          <button
            onClick={onContinue}
            className="w-full py-4 bg-gradient-to-r from-white to-gray-100 text-gray-800 rounded-2xl font-black text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
            <div className="flex items-center justify-center gap-3">
