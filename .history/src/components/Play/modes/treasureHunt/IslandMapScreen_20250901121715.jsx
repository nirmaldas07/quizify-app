...
export default function IslandMapScreen({ 
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-sky-400 via-blue-500 to-blue-600 overflow-hidden flex flex-col">
      <style jsx>{`
        @keyframes float {
      ...
      <div className="relative z-20 px-4 pb-[calc(env(safe-area-inset-bottom)+3rem)]">
        <div className="bg-gradient-to-r from-indigo-500/30 to-purple-500/30 backdrop-blur-lg rounded-2xl p-0 shadow-xl border border-white/20">
