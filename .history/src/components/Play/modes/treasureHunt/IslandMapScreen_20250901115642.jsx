  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-400 via-blue-500 to-blue-600 relative overflow-hidden flex flex-col">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-32 cloud-drift" style={{ animationDelay: '7s', animationDuration: '25s' }}>
          <div className="text-5xl opacity-20">☁️</div>
        </div>
        <div className="absolute top-10 right-12">
          <div className="text-6xl pulse-animation opacity-50">☀️</div>
        </div>
        <div className="absolute top-40 left-10 float-animation opacity-60">
          <div className="text-2xl">🦜</div>
        </div>
      </div>

      {/* Header - Adjusted spacing */}
      <div className="relative z-20 px-4 pt-[calc(env(safe-area-inset-top)+2.5rem)]">
      ...
      <div className="relative z-20 px-4 pb-[calc(env(safe-area-inset-bottom)+1.5rem)]">
        <div className="bg-gradient-to-r from-indigo-500/30 to-purple-500/30 backdrop-blur-lg rounded-2xl p-3 shadow-xl border border-white/20">
