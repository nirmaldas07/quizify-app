...
export default function TreasureRewardScreen({
  ...
  return (
    <div className={`h-screen bg-gradient-to-br ${island.theme.background} relative overflow-auto flex flex-col`}>
      <style jsx>{`
        @keyframes slideUp {
      ...
      <div className="relative z-10 flex flex-col items-center justify-between h-full px-4 py-safe">
        {/* Title */}
        ...
        <div className="glass-card rounded-2xl p-3 max-w-md w-full mb-2 slide-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="text-center mb-2">
            ...
            <div className="text-white/80 font-medium text-sm">Questions Correct</div>
          </div>
          ...
          {showTreasure && earnedTreasure && (
            <div className="text-center mb-2">
              ...
              <div className="text-white font-bold text-base">Treasure Piece Earned!</div>
            </div>
          )}
          ...
          <div className="grid grid-cols-2 gap-2 mb-2">
            <div className="glass-card rounded-xl p-2 text-center">
              ...
              <div className="text-xl font-black text-yellow-300">{animateCoins}</div>
              <div className="text-white/70 text-xs">Coins Earned</div>
            </div>
            <div className="glass-card rounded-xl p-2 text-center">
              <div className="text-2xl mb-0.5">💎</div>
              <div className="text-xl font-black text-cyan-300">{session.gemsFound}</div>
          ...
          <div className="text-center p-2 bg-white/10 rounded-xl">
            <p className="text-white font-medium text-sm">{motivationalMessage}</p>
          </div>

          {/* Perfect Score Badge */}
          {perfectScore && (
            <div className="mt-2 text-center">
              <div className="inline-block px-3 py-1 bg-gradient-to-r from-yellow-400 to-amber-500 rounded-full">
                <span className="text-white font-black text-xs">💯 PERFECT SCORE! 💯</span>
              </div>
            </div>
          )}
        </div>
        ...
        {/* Action Buttons */}
        <div className="space-y-2 w-full max-w-md slide-up" style={{ animationDelay: '0.4s' }}>
          {!earnedTreasure && (
            <button
              onClick={onRetry}
              className="w-full py-3 bg-gradient-to-r from-orange-400 to-red-500 text-white rounded-2xl font-black text-base shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
          ...
          <button
            onClick={onContinue}
            className="w-full py-3 bg-gradient-to-r from-white to-gray-100 text-gray-800 rounded-2xl font-black text-base shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
            <div className="flex items-center justify-center gap-2">
