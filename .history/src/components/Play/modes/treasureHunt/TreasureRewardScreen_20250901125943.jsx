    ...
    <div className={`min-h-screen bg-gradient-to-br ${island.theme.background} relative overflow-hidden`}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 pt-16">
        ...
        <div className="space-y-3 w-full max-w-md slide-up" style={{ animationDelay: '0.4s' }}>
          ...
          <button
            onClick={onContinue}
            className="w-full py-2 bg-gradient-to-r from-white to-gray-100 text-gray-800 rounded-2xl font-black text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
            <div className="flex items-center justify-center gap-3">
