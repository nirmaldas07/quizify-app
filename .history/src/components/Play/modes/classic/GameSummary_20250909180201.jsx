    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-purple-900/20 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md mx-auto px-5 pt-16 pb-8">
        ...
        >
          ...
          <button
            onClick={onExit}
            className="w-full py-4 rounded-2xl bg-white/10 backdrop-blur border border-white/20 text-white font-bold text-lg hover:bg-white/20 active:scale-95 transition-all mb-4"
          >
            Back to Games
          </button>
        </div>
