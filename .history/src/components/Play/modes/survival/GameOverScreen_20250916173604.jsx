      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center">
        ...
        <div className="space-y-3 w-full max-w-md">
          ...
          >
            ...
            <button 
            onClick={() => {
              // Navigate directly without triggering the warning
              window.history.go(-2); // Go back 2 steps to skip the survival mode entry
              setTimeout(() => {
                window.location.href = '/play'; // Fallback to ensure navigation
              }, 100);
            }} 
