  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 px-4 pt-[calc(env(safe-area-inset-top)+2rem)]">
        ...
        {/* Stats Dashboard */}
        {/* Stats Dashboard */}
        <div className={`glass-card rounded-3xl p-4 shadow-xl mb-4 mt-8 slide-in bg-gradient-to-r ${diff.accentGradient}`} style={{ animationDelay: '0.1s' }}>
      ...
      {/* Question Card */}
      <div className="px-4 mt-10 slide-in" style={{ animationDelay: '0.3s' }}>
