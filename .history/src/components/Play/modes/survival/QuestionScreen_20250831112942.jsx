...
export default function QuestionScreen({ 
  ...
  const difficultyConfig = {
    EASY: { 
      ...
      accentGradient: 'from-emerald-500/20 to-green-600/20',
      label: 'Sprout',
    ...
    MEDIUM: { 
      ...
      accentGradient: 'from-yellow-500/20 to-amber-600/20',
      label: 'Blooming',
    ...
    EXPERT: { 
      ...
      accentGradient: 'from-purple-500/20 to-indigo-600/20',
      label: 'Lightning',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-20 left-10 text-[100px] opacity-10 float-animation">{diff.emoji}</div>
        <div className="absolute top-40 right-20 text-[80px] opacity-10 float-animation" style={{ animationDelay: '1s' }}>⭐</div>
        <div className="absolute bottom-40 left-20 text-[90px] opacity-10 float-animation" style={{ animationDelay: '2s' }}>🎯</div>
        <div className="absolute bottom-20 right-10 text-[70px] opacity-10 float-animation" style={{ animationDelay: '3s' }}>🏆</div>
      </div>

      {/* Header Section */}
      <div className="relative z-10 px-4 pt-[calc(env(safe-area-inset-top)+2rem)]">
        {/* Top Navigation Bar */}
        ...
        {/* Stats Dashboard */}
        {/* Stats Dashboard */}
        <div className={`glass-card rounded-3xl p-2 shadow-xl mb-4 mt-8 slide-in bg-gradient-to-r ${diff.accentGradient}`} style={{ animationDelay: '0.1s' }}>
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-white/60 font-medium mt-1">Points</div>
              {showFeedback && lastAnswerCorrect && (
                <div className="absolute -top-2 left-1/2 -translate-x-1/2">
                  <span className="text-green-400 font-bold text-sm coin-animation">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-white/60 font-medium mt-1">Questions</div>
            </div>
            
            {/* Streak */}
            <div className="text-center relative">
              <div className={`text-3xl font-black text-orange-400 ${correctStreak > 0 ? 'streak-flame' : ''}`}>
                {correctStreak}
              </div>
              <div className="text-xs text-white/60 font-medium mt-1">Streak 🔥</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center mb-1 slide-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="relative">
            <div className="w-18 h-18 glass-card rounded-full shadow-xl flex items-center justify-center">
      ...
      <div className="px-4 slide-in" style={{ animationDelay: '0.3s' }}>
        <div className="glass-card rounded-3xl shadow-xl p-6 mb-6 border border-white/10">
            ...
            return (
              <button
                ...
                className={`w-full p-4 rounded-2xl shadow-lg transition-all ${cardClass} ${animationClass} 
                  ${!showFeedback ? 'hover:scale-[1.02] active:scale-[0.98] hover:bg-white/10' : ''} slide-in`}
