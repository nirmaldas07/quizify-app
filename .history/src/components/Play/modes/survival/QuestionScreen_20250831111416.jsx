  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 px-4 pt-[calc(env(safe-area-inset-top)+1rem)]">
        {/* Top Navigation Bar */}
        <div className="flex justify-between items-center mb-6 slide-in">
          <button 
        ...
        {/* Stats Dashboard */}
        <div className={`glass-card rounded-3xl p-4 shadow-xl mb-4 slide-in bg-gradient-to-r ${diff.accentGradient}`} style={{ animationDelay: '0.1s' }}>
