...
export default function LivesDisplay({ lives, maxLives = 3 }) {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center gap-3 px-5 py-2 bg-gradient-to-r from-red-500/20 to-pink-500/20 rounded-full backdrop-blur-md border border-white/10 shadow-xl">
        {/* Lives counter badge */}
