...
{(pulling || refreshing) && (
  <div
    ...
    style={{
      ...
      minWidth: "140px", // ✅ keeps both texts same centered width
      textAlign: "center",
    }}
  >
    {/* Icon above text */}
    {!refreshing && <span className="motion-safe:animate-spin mb-1">⭮</span>}
    <span>{refreshing ? "Updated!😍" : "Release to refresh"}</span>
  </div>
)}
