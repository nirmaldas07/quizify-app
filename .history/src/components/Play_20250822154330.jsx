...
const ARC_CX = 180;          // svg center X (matches 320px width)
const ARC_CY = 250;           // move DOWN to sit closer to the wheel (e.g., 84–90)
const ARC_R  = 180;           // bigger = flatter arc; smaller = more curved
const ARC_SPAN_DEG = 176;    // width of the arc (140–165 looks good)
const ARC_SEG = ARC_SPAN_DEG / 3;
const ARC_GAP_DEG = 10;       // gap between segments (deg)
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        <h2 className="text-6xl font-black mb-8">{category.name}</h2>
