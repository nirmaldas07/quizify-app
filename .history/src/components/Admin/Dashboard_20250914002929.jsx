...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white">
      {/* Header */}
      <div className="bg-[#1e293b]/50 backdrop-blur-sm border-b border-white/10 px-4 py-4">
      ...
      {/* Key Metrics Row */}
      <div className="px-4 py-3 bg-[#1e293b]/30 backdrop-blur-sm border-b border-white/10">
