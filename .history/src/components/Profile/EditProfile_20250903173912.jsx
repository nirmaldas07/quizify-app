...
export default function EditProfile() {
  ...
  return (
    <Screen title="Edit Profile" subtitle="Update your information">
      {/* Success Message */}
      {showSuccess && (
        <div className="fixed top-24 left-1/2 transform -translate-x-1/2 bg-green-500/20 border border-green-500/50 rounded-2xl px-6 py-3 backdrop-blur-sm z-50 animate-bounce">
