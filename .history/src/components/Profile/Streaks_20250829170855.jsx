...
export default function Streaks() {
  ...
  // Show celebration on mount if streak > 0
  useEffect(() => {
          ...
          <div className="reward-modal" ref={giftBoxRef}>
            <div className="gift-box">
              ...
              <div className={`gift-content ${giftBoxOpening ? 'show' : ''}`}>
                ...
                <div className="gift-content-title">Day {showRewardModal.day} Reward!</div>
                <div className="gift-content-desc">You earned {showRewardModal.label}!</div>
              </div>
            </div>
          </div>
        </>
