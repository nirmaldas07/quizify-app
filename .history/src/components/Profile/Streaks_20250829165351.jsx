  ...
  return (
    <div className="streaks-screen">
          ...
          {weeklyRewards.map((reward, index) => {
            ...
            return (
              <div 
                ...
                onClick={() => handleClaimReward(reward, reward.day)}
              >
      ...
      {flyingCoins.map((coin) => {
        const modalRect = { left: window.innerWidth / 2, top: window.innerHeight / 2 };
        return (
          <div
            key={coin.id}
            ...
            style={{
              ...
              '--end-x': `${coin.endX - modalRect.left}px`,
              '--end-y': `${coin.endY - modalRect.top}px`
            }}
          >
            🪙
          </div>
