...
const getQuestProgress = () => {
  ...
  if (!isToday(progress.date)) {
    const newProgress = { date: getTodayKey() };
...
export default function Quests() {
  ...
  // Handle back button with proper navigation
    const handleBack = () => {
    // Always go back to home when clicking back from quests
    navigate('/');
    };
