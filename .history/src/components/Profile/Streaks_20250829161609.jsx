...
// Mock useGame hook - replace with your actual implementation
const useGame = () => {
  // This should come from your actual game context
  return {
    player: {
      currentStreak: 7,  // Current streak value
      bestStreak: 12,    // Best streak ever
      totalDays: 47      // Total days played
    }
  };
};
...
export default function Streaks() {
  ...
  // Use player data from context instead of hardcoded values
      ...
      <div className="calendar-card">
        ...
        <div className="week-grid">
          {week.map((day, index) => (
            ...
            >
              {day.isToday && <div className="day-icon">⚡</div>}
              {day.hit && !day.isToday && <div className="day-icon">✓</div>}
              <div>{day.label}</div>
            </div>
          ))}
        </div>
