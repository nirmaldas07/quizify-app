...
const init = [
  { id: 1, title: "Play 3 quizzes today", progress: 2, target: 3, reward: 60, claimed: false, icon: "🎮", color: "#FF6B6B", difficulty: "Easy" },
  { id: 2, title: "Score 8+ twice", progress: 1, target: 2, reward: 80, claimed: false, icon: "🎯", color: "#4ECDC4", difficulty: "Medium" },
  { id: 3, title: "Practice 15 questions", progress: 15, target: 15, reward: 100, claimed: true, icon: "📚", color: "#FFD93D", difficulty: "Easy" },
  { id: 4, title: "Win 5 in a row", progress: 3, target: 5, reward: 150, claimed: false, icon: "🔥", color: "#A8E6CF", difficulty: "Hard" },
  { id: 5, title: "Complete a speed run", progress: 0, target: 1, reward: 120, claimed: false, icon: "⚡", color: "#C7B8FF", difficulty: "Medium" },
];

export default function Quests() {
  const { player, addCoins } = useGame();
          ...
          return (
            ...
            >
              ...
              <div className="quest-content">
                ...
                <button
                  onClick={() => isComplete && !quest.claimed && claim(quest.id, quest.reward)}
