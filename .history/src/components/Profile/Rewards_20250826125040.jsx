...
const RewardsJourney = () => {
  ...
  const claimReward = (index) => {
    ...
    // Check if it's the current reward
    ...
    setTimeout(() => {
      ...
      if (currentProgress < rewards.length - 1) {
        ...
        setTimeout(() => {
          ...
          setIsMoving(false);
          // Auto-scroll to next reward
          const nextElement = journeyRef.current?.querySelector(`[data-index="${currentProgress + 1}"]`);
          if (nextElement) {
  ...
  const getRewardPosition = (index) => {
    ...
    const stepHeight = totalHeight / (rewards.length - 1);
    ...
    <div className="rewards-page">
      <style jsx>{`
        ...
        .journey-track {
          position: relative;
          width: 100%;
          min-height: ${rewards.length * 100}px;
        }
          ...
          <div className="journey-track">
            <div className="curvy-road">
              <svg width="60" height="100%" viewBox="0 0 60 1000" preserveAspectRatio="none">
                ...
                <path
                  className="road-path"
                  d="M 30 0 Q 45 50, 30 100 T 30 200 Q 15 250, 30 300 T 30 400 Q 45 450, 30 500 T 30 600 Q 15 650, 30 700 T 30 800 Q 45 850, 30 900 T 30 1000"
                />
                <path
                  className="road-progress"
                  d="M 30 0 Q 45 50, 30 100 T 30 200 Q 15 250, 30 300 T 30 400 Q 45 450, 30 500 T 30 600 Q 15 650, 30 700 T 30 800 Q 45 850, 30 900 T 30 1000"
                  strokeDasharray="1000"
                  strokeDashoffset={1000 - (currentProgress / (rewards.length - 1)) * 1000}
                />
              </svg>
            </div>
            ...
            <div 
              ...
              style={{ 
                top: `${30 + (getRewardPosition(currentProgress) * 9.5)}px`
              }}
            >
              <img 
              ...
              {rewards.map((reward, index) => {
                ...
                return (
                  <div 
                    ...
                    data-index={index}
                    style={{
                      top: `${getRewardPosition(index) * 9.5}px`
                    }}
                  >
