...
export default function EditProfile() {
  ...
  useEffect(() => {
    ...
    const loadedData = {
      ...
      gender: storedProfileData.gender || userData.gender || '',
      ageGroup: storedProfileData.ageGroup || userData.ageGroup || '',
  ...
  const handleSave = () => {
    ...
    if (users[currentUser.phone]) {
      users[currentUser.phone] = {
        ...users[currentUser.phone],
        username: tempProfileData.name,
        gender: tempProfileData.gender || users[currentUser.phone].gender,
        ageGroup: tempProfileData.ageGroup || users[currentUser.phone].ageGroup
      };
