...
const [userStats] = useState({
  ...
  rank: 23,  // You'll need to implement ranking system
  streak: 5,  // You'll need to implement streak tracking
  todayQuizzes: 3,  // You'll need to track this
  weeklyXp: 450  // You'll need to track this
});
  ...
  return (
    <div className="min-h-full bg-[#0B0C10] text-white pt-12 px-3">
