...
// Define today at the top
  ...
  // Show celebration on mount for testing or special streaks
useEffect(() => {
  // Show celebration for: first time (streak 1), multiples of 5, or milestones
  if (currentStreak === 1 || (currentStreak > 0 && currentStreak % 5 === 0)) {
