      ...
      setTimeout(() => {
        if (currentProgress < rewards.length - 1) {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              const scrollableElement = document.querySelector('.scrollable-journey');
              if (scrollableElement) {
                // Calculate the position of the next checkpoint
                const nextPosition = getRewardPosition(currentProgress + 1);
                // Scroll to center the next checkpoint
                const targetScroll = nextPosition - 200; // Adjust offset as needed
