        ...
        if (currentProgress < rewards.length - 1) {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              // Method 1: Direct position calculation
              const scrollContainer = document.querySelector('.scrollable-journey');
              if (scrollContainer) {
                // Each reward is 100px apart, starting at 30px
                const nextPosition = 30 + (nextIndex * 100);
                const containerHeight = scrollContainer.clientHeight;
                // Scroll to position the next reward in the middle of the container
                const scrollTarget = nextPosition - (containerHeight / 2) + 50;
              ...
              if (nextElement && !scrollContainer) {
