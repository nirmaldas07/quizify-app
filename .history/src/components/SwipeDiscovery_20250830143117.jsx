      ...
      <div className="grid grid-cols-2 gap-4 w-full max-w-md">
        {categories.map(cat => (
          <button
            ...
            className={`aspect-square rounded-3xl bg-gradient-to-br ${cat.color} p-6 flex flex-col items-center justify-center gap-3 transform hover:scale-105 transition-all shadow-xl`}
          >
