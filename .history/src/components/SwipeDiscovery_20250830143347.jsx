...
const SwipeDiscovery = ({ onSelect }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 flex items-center justify-center px-4 overflow-hidden">
      <div className="grid grid-cols-2 gap-4 w-full max-w-md h-[40vh]">
        {categories.map(cat => (
          <button
            key={cat.id}
