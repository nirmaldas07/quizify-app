  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden flex flex-col">
      ...
      <div className={`flex-1 px-4 py-4 flex flex-col min-h-0 ${showExplanation ? 'overflow-y-auto' : 'overflow-hidden'}`}>
        ...
        {/* Options Grid */}
        <div className="flex-1 grid grid-cols-1 gap-3 mb-28">
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm p-3 mt-12 flex-shrink-0">
        {/* Lifelines */}
        {!isPractice && (
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 py-6 rounded-xl font-medium transition-colors"
        >
          Submit
        </button>
      </div>
