...
const QuizSession = ({ 
  ...
  return (
    <div className="h-screen bg-gray-900 text-white relative overflow-hidden flex flex-col">
      ...
      <div className={`flex-1 px-4 flex flex-col ${showExplanation ? 'paddingBottom: '112px' : 'overflow-hidden'}`}>
        {/* Question Card */}
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm p-2 fixed bottom-0 left-0 right-0">
        {/* Lifelines */}
        {!isPractice && (
