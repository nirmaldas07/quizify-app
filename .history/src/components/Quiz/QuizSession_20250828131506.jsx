...
const QuizSession = ({ 
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden flex flex-col">
      ...
      <div className={`flex-1 px-4 py-1 flex flex-col min-h-0 ${showExplanation ? 'overflow-y-auto' : 'overflow-hidden'}`}>
        {/* Question Card */}
        <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-4 mb-2 flex-shrink-0">
          <div className="text-center">
            <h2 className="text-xl font-semibold leading-relaxed text-white mb-2">
        ...
        {/* Options Grid */}
        <div className="flex-1 grid grid-cols-1 gap-2 mb-12">
          {currentQuestion.options.map((option, optIndex) => {
            ...
            let cardClass = "p-1.5 rounded-xl transition-all duration-200 transform border-2 min-h-[36px] flex items-center ";
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 w-full">
                  <div className="text-lg flex-shrink-0">{optionLabels[optIndex]}</div>
                  <div className="flex-1 text-left font-medium text-xs">{option}</div>
        ...
        {isPractice && showExplanation && selected !== null && (
          <div className="bg-gray-800 rounded-2xl p-3 mb-2 border border-gray-700 flex-shrink-0">
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm p-3 flex-shrink-0">
        {/* Lifelines */}
        {!isPractice && (
          <div className="flex justify-center gap-3 mb-3">
            <button
              ...
              className={`${used5050 ? 'bg-gray-700/50 text-gray-500/50' : 'bg-orange-600 hover:bg-orange-700'} disabled:bg-gray-800 px-4 py-2 rounded-xl font-medium transition-colors flex items-center gap-2`}
            >
              <span>⚡</span>
              50:50
            </button>
            <button
              ...
              disabled={selected !== null}
              className={`${usedAudience ? 'bg-gray-700/50 text-gray-500/50' : 'bg-purple-600 hover:bg-purple-700'} disabled:bg-gray-800 px-4 py-2 rounded-xl font-medium transition-colors flex items-center gap-2`}
            >
              <span>👥</span>
              Ask Friends
            </button>
