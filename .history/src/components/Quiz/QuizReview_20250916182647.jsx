...
const QuizReview = ({ 
  ...
  return (
    ...
    {/* Action Buttons */}
      <div className="fixed bottom-0 left-2 right-0 p-4 bg-gradient-to-t from-black to-transparent">
        <div className="flex gap-2 justify-center max-w-md mx-auto">
          <button
            className="flex-1 px-4 py-3 rounded-xl border border-base-border bg-base-card backdrop-blur"
            onClick={handleBack}
          >
            Back to Results
          </button>
          {onRetake && (
            <button 
              className="flex-1 px-4 py-3 rounded-xl bg-gradient-to-r from-brand-blue to-brand-purple text-white font-medium"
              onClick={onRetake}
            >
              Retake Quiz
            </button>
