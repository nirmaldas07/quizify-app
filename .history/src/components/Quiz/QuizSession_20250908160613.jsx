...
useEffect(() => {
  ...
  const coinsEarned = 2; // 2 coins per correct answer in practice
  ...
  return (
    <div className="h-dvh bg-gray-900 text-white relative flex flex-col overflow-hidden">
  ...
  {/* Main container - fixed, no scrolling */}
...
{/* Main Content - Fixed positioning from top */}
<div className="px-4 flex-1 flex flex-col overflow-hidden" style={{paddingBottom: isPractice && showExplanation && selected !== null ? '360px' : '200px'}}>
    
    {/* Content wrapper - start from top */}
    <div className="flex flex-col">
      {/* Question Card */}
      <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 rounded-3xl p-6 mb-4 flex-shrink-0 shadow-2xl shadow-blue-600/20 border border-blue-400/20">
   ...
   {/* Explanation Overlay - Fixed above controls */}
{isPractice && showExplanation && selected !== null && (
  <div className="fixed bottom-[240px] left-4 right-4 z-40 bg-gray-800 rounded-xl p-4 border border-gray-700 max-h-[120px] overflow-y-auto">
    <div className="flex gap-3">
      <div className="text-lg flex-shrink-0">
        {selected === currentQuestion.answerIndex ? '🎊' : '💡'}
      </div>
