...
//   }, []);
  ...
  return (
    <div className="h-dvh bg-gray-900 text-white relative flex flex-col">
      ...
      <div className="flex-1 px-4 flex flex-col overflow-y-auto overscroll-y-contain pb-[calc(96px+env(safe-area-inset-bottom))]">
        {/* Question Card */}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-gray-800/90 backdrop-blur-sm p-2 z-50">
        {/* Lifelines */}
        {!isPractice && (
