...
const QuizReview = ({ 
  ...
  return (
    ...
    {/* Action Buttons */}
      <div className="fixed bottom-0 left-1 right-1 p-4 bg-gradient-to-t from-black to-transparent">
        <div className="flex gap-2 justify-center max-w-md mx-auto">
          <button
            className="flex-1 px-4 py-2 rounded-xl border border-base-border bg-base-card backdrop-blur"
            onClick={handleBack}
          >
            Back to Results
          </button>
