...
const QuizSession = ({ 
  ...
  return (
    <div className="h-screen bg-gray-900 text-white relative overflow-hidden flex flex-col">
      ...
      <div className={`flex-1 px-8 flex flex-col ${showExplanation ? 'overflow-y-auto' : 'overflow-hidden'}`}>
        {/* Question Card */}
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm p-2 flex-shrink-0 mb-32">
        {/* Lifelines */}
        {!isPractice && (
