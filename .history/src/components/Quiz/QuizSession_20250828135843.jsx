...
const QuizSession = ({ 
  ...
  return (
    <div className="h-screen bg-gray-900 text-white relative overflow-hidden flex flex-col">
      ...
      <div className={`flex-1 px-4 flex flex-col ${showExplanation ? 'overflow-y-auto pb-28' : 'overflow-hidden'}`}>
        {/* Question Card */}
        ...
        {isPractice && showExplanation && selected !== null && (
          <div className="bg-gray-800 rounded-xl p-2 mb-2 mt-4 border border-gray-700 flex-shrink-0">
      ...
      <div className={`bg-gray-800/90 backdrop-blur-sm p-2 ${showExplanation ? 'fixed bottom-0 left-0 right-0 z-10' : 'flex-shrink-0 mb-0'}`}>
        {/* Lifelines */}
        {!isPractice && (
